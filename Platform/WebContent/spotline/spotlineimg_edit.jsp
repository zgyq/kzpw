...
<title><ww:if test="spotlineimg
		.id>0">编辑</ww:if><ww:else>新增</ww:else>景区线路图片信息
</title>
...
<form enctype="multipart/form-data"
	action="spotlineimg
		!<ww:if test="spotlineimg
		.id>0">edit.action?id=<ww:property value="spotlineimg
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			...
			test="spotlineimg
		.id>0">编辑</ww:if><ww:else>新增</ww:else>景区线路图片信息 </span></b></td>
	</tr>
	<td align="center">
	<table width="100%" border="0" cellpadding="0" cellspacing="0"
		...
		<tr>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<ww:if test="spotlineimg.id>0">
					<ww:property value="GetSpotlinenameByid(spotlineimg.spotlineid)"/>
					</ww:if><ww:else>
					<ww:property value="GetSpotlinenameByid(s_spotlineid)"/>
					</ww:else>
					
					<input type="hidden" name="s_spotlineid" value='<ww:property value="s_spotlineid"/>' style="width: 300px" /></td>
				...
				<tr>
					...
					<input type="text" name="name
						"
						value='<ww:property value="spotlineimg.name"/>'
				...
				<tr>
					...
					<input type="file" name="files"
						value='<ww:property value="spotlineimg.imgurl"/>'
						style="width: 300px" /></td>
				</tr>
				...
				<tr>
					...
					<textarea rows="5" cols="130" name="beizhu"><ww:property value="spotlineimg.beizhu"/></textarea>
					</td>
				</tr>
				...
				<td width="10%" height="30" align="left" class="table_color_l">
					<input type="text"  name="param1
						" value='<ww:property value="spotlineimg.param1"/>'" style="width: 300px" />
				</td>
				...
				<td width="10%" height="30" class="table_color_l" align="left">
					<input type="text"  name="param2
						" value='<ww:property value="spotlineimg.param2
						"/>'" style="width: 300px" />
				</td>
		</tr>
		 ...
		 <tr>
				...
				<td width="10%" height="30" align="left" class="table_color_l">
					<input type="text"  name="param3
						" value='<ww:property value="spotlineimg.param3"/>'" style="width: 300px" />
				</td>
				...
				<td width="10%" height="30" class="table_color_l" align="left">
					<input type="text"  name="state
						" value='<ww:property value="spotlineimg.state
						"/>'" style="width: 300px" />
				</td>
		</tr>
			...
			-->
				<tr>
					<td colspan="4" height="40" bgcolor="ffffff"><input
						...
						onclick="window.location.href='spotlineimg.action?<ww:property value="url"/>';"
