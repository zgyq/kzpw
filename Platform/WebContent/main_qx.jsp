...
function showMessage2() {
		...
		jQuery.post(url,params, function(data) {
			...
			if (data != '') {
			 ...
			 data=eval(data);
			var tuiticket=data.tuiticket;//申请退票
			
			var feiticket=data.feiticket//申请废票
			var gaiqianticket=data.gaiqianticket;//申请改签
			var daichupiaoticket=data.daichupiaoticket;//待出票
			var daiquerenticket=data.daiquerenticket;//待确认
			var daizhifuticket=data.daizhifuticket;//待支付
			var qbnum=data.qbnum;//QB
			var telnum=data.telnum;//tel
			//member.location.target="member";
			member.location.href="login!toordershow.action?tuiticket="+tuiticket+"&feiticket="+feiticket+"&gaiqianticket="+gaiqianticket+"&daichupiaoticket="+daichupiaoticket+"&daiquerenticket="+daiquerenticket+"&daizhifuticket="+daizhifuticket+"&qbnum="+qbnum+"&telnum="+telnum;
			}
		});
	}
...
<frameset rows="115,*,22" cols="*" frameborder="no" border="0" framespacing="0" onload="onlod();">
  ...
  <frame name="left"  frameborder="0" scrolling="yes" marginwidth="0" marginheight="0" src="main/customeruser!leftmenu.action?rightid=-1&forward=main/left.jsp">
    <frame name="middle" scrolling="no" frameborder="0" noresize="noresize"  src="main/middle.jsp" />
    	<frame name="member" scrolling="yes" frameborder="0"  id="member" noresize="noresize" src="wel_yplm/login!towelcome.action" />
