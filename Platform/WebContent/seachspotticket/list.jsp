...
window.location.href="hotel!tobook.action?HotelId="+hotelid+"&RoomTypeid="+roomid+"&startDate="+startDate+"&endDate="+endDate;
	  }
...
<div>
	...
	<!--top over-->
	<form action="spotticket!SeachSpot.action" method="post" name="form1" id="form1">
      ...
      <div id="left" class="f">
          ...
          <div class="mt7" style="display: none;">
             <div class="tit" style="border:1px solid #e3d3d3; border-bottom:none;">
               ...
               <div class="box recently" style=" border-top:none;"><span class="f ico_recently">&nbsp;</span>您最近没有浏览过任何景区。</div>
               </ww:if><ww:else>
 ...
 <div id="list" class="r">
    ...
    <div>
       <span class="f ico_hotel">&nbsp;</span><font class="f biger000">选择景区（<ww:property value="GetSpotCityNmaeByID(CityID)" />）</font>
       <span class="r spot_status">&nbsp;</span>
       <div class="c"></div>
    </div>
    
   <div id="hotelList"> 
    <div class="mt7" style="height:28px; line-height:26px;">
      <div class="f mr5 list_on " id="hotelTEXT" ><a href="#"  class="fff">景区列表</a></div>
      <div class="f list_out" style="display: none" id="mapTEXT" href="javascript:void(0)" onclick="showMap();" >电子地图</div>
      <div class="r"><ww:property value="getPagination('\"spotticket!SeachSpot.action?pageinfo.pagenum=\"+pageno+\"\"')"/></div>
      <div class="c list_line">&nbsp;</div>
    </div>

    
    <ww:iterator value="ListSpotmes" status="t">
    ...
    <div class="mt7 " id="hotelsTable<ww:property value="id" />">     
       <div>
           ...
           <div class="f list_top list_bg">
               <div class="f"><a href="spotticket!toSpotTicketInfo.action?SpotMesID=<ww:property value="id" />&startDate=<ww:property value="startDate"/>&endDate=<ww:property value="endDate"/>" class="c09f"><ww:property value="name" /></a></div>
               <div class="r"><span class="ico_tell">&nbsp;</span><a href="spotticket!toSpotTicketInfo.action?SpotMesID=<ww:property value="id" />&startDate=<ww:property value="startDate"/>&endDate=<ww:property value="endDate"/>" class="c09f">景区详细介绍</a></div>
               <div class="c"></div>
           </div>
       ...
       <div>
          <div class="list_img f"><img src="http://upload.17u.com/uploadfile/<ww:property value="minipics.split('[|]')[0]"/>" width="90" height="80" /></div>
          <div class="list_main f">
            <ul>
            <li>景区特点：<ww:property value="sid" /></li>
            <li>景区地址：<ww:property value="address" /></li>
            
            <li>景区简介：<ww:property value="SubString(ShowHTML(info,'list'),100)" />....</li>
            </ul> 
          </div>
    ...
    <div class="box_ccc floatall box_botno mt7">
      <ul class="query">
      <li class="f">&nbsp;</li>
      <li class="r mr25"><ww:property value="getPagination('\"spotticket!SeachSpot.action?pageinfo.pagenum=\"+pageno+\"\"')"/></li>
      <div class="c"></div>
      </ul>
    </div> 
...
<script language="javascript">	
	 ...
	 $("span[id*='lowHotelSpan_']").each(function(i){
        ...
        $.ajax({
	         type:"POST",
	         url:"hotel!findHotelRoomPrice.action",
