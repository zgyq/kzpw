...
<div class="right">
     <div class="box">
          ...
          <!-- 隐藏域 -->
			...
			<input type="hidden" id="hidfromtime_<ww:property value="#index.index" />" value="<ww:property value="formatTimestampHHmm(departtime)" />" />
