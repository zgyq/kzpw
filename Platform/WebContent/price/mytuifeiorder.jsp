...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;选择退费还款订单列表</span></b></td>
	</tr>
	<tr>
		<td valign="top">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td>
								<form name="form1" action="biguserprice!totuifei.action" method="post" >
								<table width="100%" border="0" align="center" cellpadding="0"
									cellspacing="0">
									<tr>
										<td width="80" height="20" align="right">乘机人姓名：</td>
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<form action="biguserprice!tuifeihaikuan.action" name="form2"
										...
										<ww:iterator value="listPassenger" status="state">
											<ww:if test="#state.index%2==0">
												<tr id="t<ww:property value="id"/>" align="center"
													...
													<td>
												<input type="checkbox" id="<ww:property value="id"/>" <ww:if test="tuifee==null">disabled</ww:if> 
															name="orderid" value="<ww:property value="id"/>"
															onclick="checkprice('<ww:property value="tuifee" />','<ww:property value="id"/>','<ww:property value="state"/>',this);" />
												</td>
													<td class="table_color"><ww:property
														value="ticketnum" /></td>
													<td class="table_color"><ww:property value="name" /></td>
													<td class="table_color"><ww:property value="tuifee" /></td>
													<td class="table_color"><ww:property value="getpassstate(state)"/>
													</td>
											</ww:if>
											<ww:else>
												<td></td>
												<td class="table_color">
													<input type="checkbox" <ww:if test="tuifee==null">disabled</ww:if>  id="<ww:property 

value="id"/>"
														name="orderid" value="<ww:property 
