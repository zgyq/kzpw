...
<frameset rows="115,*,22" cols="*" frameborder="no" border="0" framespacing="0" onload="onlod();">
  <!-- top  -->
  <frame src="main_tulue/login!topmenu.action" name="topFrame" scrolling="no" noresize="noresize" id="topFrame"  />
  <!-- middle -->
  <frameset rows="*" cols="220,6,*" framespacing="0" frameborder="0" border="false" id="mainFrame" scrolling="yes">
  
  <frame name="left"  frameborder="0" scrolling="yes" marginwidth="0" marginheight="0" src="main_tulue/customeruser!leftmenu.action?rightid=-1&forward=main_tulue/left.jsp">
    <frame name="middle" scrolling="no" frameborder="0" noresize="noresize"  src="main_tulue/middle.jsp" />
    	<frame name="member" scrolling="yes" frameborder="0" noresize="noresize" src="b2bair!toTicket.action" />
    <!--
...
<!-- bottom -->
  <frame src="main_tulue/bottom.jsp" name="bottomFrame" scrolling="no" noresize="noresize" id="bottomFrame"  />
</frameset>
<noframes>
