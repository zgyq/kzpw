...
function countMoney(count){
  var price=$("#pervalue").val();
  var platfu='<ww:property value="platfu" />';
  //alert(platfu);
  if(isNaN(price)){
  $("#qmoney").html(price);
  }else{
  $("#qmoney").html(formatCurrency(count*price+count*price*platfu/1000));
  }
}
								...
								<table width="680" border="1" cellspacing="0" cellpadding="0">
									...
									<tr>
										...
										<td height="28" class="table_color_l"><font id="qmoney"
											...
											value="GetNewPrice(#request.qmonymap.inprice)" /> </font> <font id='danwei'
