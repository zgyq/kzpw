             ...
             <!-- 搜索结果开始-->
                  ...
                  <div class="inter-resu">
                        ...
                        <!--第一条结果中转样式开始 --> 
                             ...
                             <div class="inter-con">
                                ...
                                <div class="inter-con-a">
                                  ...
                                  <div class="inter-con-2">
                                        <div class="start">
                                              <b><ww:property value="formatTimestampHHmm(dateToTimestamp_HHMM(FlightInfos[0].DepartTime))"/></b>
                                        ...
                                        <ww:if test="FlightInfos.size==1">
                                         ...
                                         <div class="arrival">
                                            <b><ww:property value="formatTimestampHHmm(dateToTimestamp_HHMM(FlightInfos[1].ArriveTime))"/></b>
                                              <font><ww:property value="FlightInfos[1].EndAirportName"/>(<ww:property value="FlightInfos[1].StartAirport"/>)<ww:property value="FlightInfos[1].EndAirportHZL"/></font>
                                        </div> 
                                        </ww:else>
                                 ...
                                 <div class="flight-detail" style="display:none;" id="airinfo_<ww:property value="#ind.index"/>">
                                 	<ww:iterator value="FlightInfos" status="index">
                                       <div class="flight-detail-start">
                                           ...
                                           <p><span><ww:property value="DepartTime.substring(0,5)"/></span><span><ww:property value="formatTimestampHHmm(dateToTimestamp_HHMM(DepartTime))"/></span><span><ww:property value="StartAirport"/></span><span class="start-space"><ww:property value="StartAirportName"/><ww:property value="StartAirportHZL"/></span></p>
                                           <p><span><ww:property value="ArriveTime.substring(0,5)"/></span><span><ww:property value="formatTimestampHHmm(dateToTimestamp_HHMM(ArriveTime))"/></span><span><ww:property value="EndAirport"/></span><span class="start-space"><ww:property value="EndAirportName"/><ww:property value="EndAirportHZL"/></span><span class="fly-time">飞行时长 <ww:property value="Duration"/>分</span></p>
                                       </div>
                               ...
                               <!-- 航班详情结束--> 
                                ...
                                <div class="inter-con-b">
                                      ...
                                      <div class="inter-con-8">
                                             <b>￥<font id="price_<ww:property value="#ind.index"/>"><ww:property value="interPrice.xcprice"/></font></b>起
                                      </div>
                         ...
                         <input type="text" id="DepartTime_<ww:property value="#ind.index"/>" name=""  value="<ww:property value="FlightInfos[0].DepartTime"/>" />
                         ...
                         <input type="text" id="DepartTime_<ww:property value="#ind.index"/>" name=""  value="<ww:property value="FlightInfos[1].ArriveTime"/>" />
                         ...
                         <input type="hidden" id="feixingtime_<ww:property value="#ind.index"/>" name=""  value="<ww:property value="formatflotMoneyB2B(FlightInfos[0].Duration)+formatflotMoneyB2B(FlightInfos[1].Duration)"/>" />
                          ...
                          <input type="text" id="AirPrice_<ww:property value="#ind.index"/>" name=""  value="<ww:property value="interPrice.AirPrice"/>" />
                          <input type="text" id="xcprice_<ww:property value="#ind.index"/>" name=""  value="<ww:property value="interPrice.xcprice"/>" /> 
                          <input type="text" id="piaomianjia_<ww:property value="#ind.index"/>" name=""  value="<ww:property value="interPrice.hsprice"/>" />   
                          
                          <input type="text" id="seatType_<ww:property value="#ind.index"/>" name=""  value="<ww:property value="FlightInfos[0].Carbins[0].Cabin"/>" /> 
                          <input type="text" id="aired_<ww:property value="#ind.index"/>" name=""  value="<ww:property value="FlightInfos[0].Pid"/>" /> 
                          <!-- 验仓用 -->
                          <input type="text" id="airfb_<ww:property value="#ind.index"/>" name=""  value="<ww:property value="FlightInfos[0].AirplaneTypeDesc"/>" /> 
...
function valadate_price(seginfo,ind){
     $.ajax({
	         ...
	         data:{s_jasonsegmentinfo:seginfo},
