...
.mu_ese{}
.mu_ese ul{}
.mu_ese ul li{ float:left; margin-right:10px;}
.times{ width:43px; height:25px; line-height:25px; background:url(b2bairticket/img/bj_shijiand.gif) no-repeat; padding-left:8px;}
.timesg{ width:43px; height:25px; line-height:25px; background:url(b2bairticket/img/bj_shijiang.gif) no-repeat; padding-left:8px;}
</style>
     ...
     <div class="box">
          ...
          <form action="interticket!search.action" name="form1" id="form1" method="POST" onSubmit="return CheckData()">
                 <div class="search-form">   
                        ...
                        <div class="sail-con">
                                <div class="Ordinary-search">
                                       <div class="start-city">出发城市 <input type="text" name="fromCity"  value="<ww:property value="fromCity"/>"
								id="fromCity"
							    ...
							    <input type="hidden" id="hideFromCityCode" value="<ww:property value="StartAirportCode"/>" name="StartAirportCode" />
							...
							<input type="hidden" id="hideArrCityCode" name="EndAirportCode" value="<ww:property value="EndAirportCode"/>" />
              ...
              <!--  搜索框结束-->  
                  ...
                  <div class="ticket-type"><ww:property value="fromCity"/>--<ww:property value="toCity"/><font>(<ww:property value="fromDate"/>  <ww:property value="listInterFlightInfo.size"/>个航班)</font>
                  ...
                  <div class="inter-resu">
                  	 <div class="">
                                <table  cellspacing="0" cellpadding="1" align="center" style="width:100%">
                                   <tr>
                   				<ul>
				                 <a href="#"><li class="times pointer" style="float:left;cursor：pointer;"  onclick="sortflightlist_new('timedesc')">时间</li></a>
								<a href="#"><li class="timesg pointer" style="float:left;cursor：pointer;" onclick="sortflightlist_new('timeasc')">时间</li></a>
								<a href="#"><li class="times pointer" style="float:left;cursor：pointer;" onclick="sortflightlist_new('priceasc')">价格</li></a>
								<a href="#"><li class="timesg pointer" style="float:left;cursor：pointer;" onclick="sortflightlist_new('pricedesc')">价格</li></a>
								<li style="float:left;cursor：pointer;">航空公司/航班号<input type="text" id="sea_air" name="sea_air" size="6" onchange="seach_air(this.value);"  /></li>
								<li style="float:left;cursor：pointer;">中转类型<select onchange="seach_type(this.value);">
                         ...
                         <div class="inter-tit">
                                <table  cellspacing="0" cellpadding="1" align="center" style="width:100%">
                                   <tr>
                                       <td class="default" style="cursor:pointer;color:#fff;line-height:45px;" >默认排序</td>
                                       <td class="d-time" style="cursor:pointer;color:#fff;line-height:45px;" >起飞时间</td>
                                       <td class="e-city" style="cursor:pointer;color:#fff;line-height:45px;" >到达时间</td>
                                       <td class="flight-time" style="cursor:pointer;color:#fff;line-height:45px;"  >航程时间</td> 
                                      <td class="price" style="cursor:pointer;color:#fff;line-height:45px;" >价格</td>
                                   </tr>
                               </table> 
                         </div>
                        <!--第一条结果中转样式开始 --> 
                        <div  id="div_flightlist">
                             ...
                             <ww:if test="FlightInfos.size==1">
                                             <div class="inter-con" id="<ww:property value="FlightInfos[0].Airline"/>_air_code"  pid="<ww:property value="FlightInfos.size"/>">
                                             </ww:if>
                                             <ww:else>
		                                        <div class="inter-con" id="<ww:property value="FlightInfos[0].Airline"/>/<ww:property value="FlightInfos[1].Airline"/>_air_code" pid="<ww:property value="FlightInfos.size"/>">
	                                        </ww:else>
                                ...
                                <div class="inter-con-a">
                                    <div class="inter-con-1">
                                        ...
                                        <div class="flight">
                                             ...
                                             <ww:if test="FlightInfos.size==1">
                                             <div id="<ww:property value="FlightInfos[0].Airline"/>"><ww:property value="FlightInfos[0].Airline"/></div>
                                             </ww:if>
                                             <ww:else>
		                                        <ww:if test="FlightInfos[0].AirCompany==FlightInfos[1].AirCompany">
		                                        <div id="<ww:property value="FlightInfos[0].Airline"/>">
		                                         <ww:property value="FlightInfos[0].Airline"/>/<ww:property value="FlightInfos[1].Airline"/>
		                                         </div>
		                                        </ww:if><ww:else>
                                  ...
                                  <div class="inter-con-2">
                                        <div class="start">
                                              <b class="timeOfColnum"><ww:property value="formatTimestampHHmm(dateToTimestamp_HHMM(FlightInfos[0].DepartTime))"/></b>
                                              <font><ww:property value="FlightInfos[0].StartAirportName"/>(<ww:property value="FlightInfos[0].StartAirport"/>)<ww:property value="FlightInfos[0].StartAirportHZL"/></font>
                                        </div>
                                          
                                        <div class="icon1">
                                        <ww:if test="FlightInfos.size==1">
                                        <img src="interticket_new/img2/icon2.png" width="74" height="16" /> </br><font style="color: red">直飞</font>
                                        </ww:if><ww:else>
                                        <img src="interticket_new/img2/icon1.png" width="74" height="16" /> </br><font style="color: red">中转</font>
                                        </ww:else>
                                        ...
                                        <ww:if test="FlightInfos.size==1">
                                         <div class="arrival">
                                             <b><ww:property value="formatTimestampHHmm(dateToTimestamp_HHMM(FlightInfos[0].ArriveTime))"/></b>
                                              <font><ww:property value="FlightInfos[0].EndAirportName"/>(<ww:property value="FlightInfos[0].EndAirport"/>)<ww:property value="FlightInfos[0].EndAirportHZL"/></font>
                                        </div> 
                                        </ww:if><ww:else>
                                         <div class="arrival">
                                            <b><ww:property value="formatTimestampHHmm(dateToTimestamp_HHMM(FlightInfos[FlightInfos.size-1].ArriveTime))"/></b>
                                              <font><ww:property value="FlightInfos[FlightInfos.size-1].EndAirportName"/>(<ww:property value="FlightInfos[FlightInfos.size-1].StartAirport"/>)<ww:property value="FlightInfos[FlightInfos.size-1].EndAirportHZL"/></font>
                                        </div> 
                                        </ww:else>
                                  ...
                                  <ww:if test="FlightInfos.size>1">
                                  <font><ww:property value="formatflotMoneyB2B(FlightInfos[0].Duration)+formatflotMoneyB2B(FlightInfos[FlightInfos.size-1].Duration)"/>分钟</font>
                                  </ww:if><ww:else>
                                  <font><ww:property value="formatflotMoneyB2B(FlightInfos[0].Duration)"/>分钟</font>
                                    ...
                                    <div class="inter-con-4">
                                          <a href="#" onclick="ShowAirInfo('airinfo_<ww:property value="#ind.index"/>');return false;"><b style="color: red">航班详情(展开)</b></a>
                                   </div>
                                </div>
                                 ...
                                 <div class="flight-detail" style="display:none;" id="airinfo_<ww:property value="#ind.index"/>">
                                 	<ww:iterator value="FlightInfos" status="index">
                                       <div class="flight-detail-start">
                                           ...
                                           <p><span><ww:property value="DepartTime.substring(5,10)"/></span><span ><ww:property value="formatTimestampHHmm(dateToTimestamp_HHMM(DepartTime))"/></span><span><ww:property value="StartAirport"/></span><span class="start-space"><ww:property value="StartAirportName"/><ww:property value="StartAirportHZL"/></span></p>
                                           <p><span><ww:property value="ArriveTime.substring(5,10)"/></span><span><ww:property value="formatTimestampHHmm(dateToTimestamp_HHMM(ArriveTime))"/></span><span><ww:property value="EndAirport"/></span><span class="start-space"><ww:property value="EndAirportName"/><ww:property value="EndAirportHZL"/></span><span class="fly-time">飞行时长 <ww:property value="Duration"/>分</span></p>
                                       </div>
                                       	<ww:if test="FlightInfos.size>1&&#index.index!=FlightInfos.size-1">
                                       	 <div class="flight-detail-midd">
                                             <div class="section-stop"><b><ww:property value="FlightInfos[FlightInfos.size-1].StartCityName"/></b>   中转   </div>
                                        </div>
                               ...
                               <!-- 航班详情结束--> 
                                ...
                                <div class="inter-con-b">
                                      ...
                                      <div class="inter-con-8">
                                             <b>￥<font id="price_<ww:property value="#ind.index"/>" class="priceOfColnum"><ww:property value="interPrice.xcprice"/></font></b>起
                                      </div>
                                     
                                        <div class="inter-con-9" id="yud_<ww:property value="#ind.index"/>" style="display: none;">
                               		  ...
                               		  <div class="inter-con-9" id="yaz_<ww:property value="#ind.index"/>">
                                            <a href="#"><img src="interticket_new/img2/yuding-btn.gif" onclick="YanZhengPrice('<ww:property value="#ind.index"/>');return false;" width="68" height="26" /></a><font>&nbsp;</font> <!-- 1张余票 --> 
                                       </div>
                                       
                               		   <div class="inter-con-9" id="lod_<ww:property value="#ind.index"/>" style="display: none;">
                                            <a href="#"><img src="images/loadding.gif" width="28" height="26" /></a><font>正在验证仓位!</font><!-- 1张余票 -->
                                       </div>
                               		 </div>
                                   ...
                                   <div class="inter-con-c">
                                      ...
                                      <div class="inter-con-10">
                                            <font>税费￥<font id="tax_<ww:property value="#ind.index"/>" ><ww:property value="interPrice.AirPrice"/></font>起</font>
                                      </div>
                         ...
                         <!-- 隐藏域开始 -->
                        		 		...
                        		 		<ww:if test="FlightInfos.size>1">
                                       	<input type="hidden" id="iszhongzhuan_<ww:property value="#ind.index"/>" name="iszhongzhuan"  value="<ww:property value="FlightInfos.size"/>" />
                                       	</ww:if>
                                       	<ww:else>
                         ...
                         <input type="hidden" id="feixingtime_<ww:property value="#ind.index"/>" name=""  value="<ww:property value="formatflotMoneyB2B(FlightInfos[0].Duration)+formatflotMoneyB2B(FlightInfos[1].Duration)"/>" />
                          ...
                          <input type="hidden" id="seatType_<ww:property value="#ind.index"/>" name=""  value="<ww:property value="FlightInfos[0].Carbins[0].Cabin"/>" /> 
                          <input type="hidden" id="aired_<ww:property value="#ind.index"/>" name=""  value="<ww:property value="FlightInfos[0].Pid"/>" /> 
                          <!-- 验仓用 -->
                          <input type="hidden" id="airfb_<ww:property value="#ind.index"/>" name=""  value="<ww:property value="FlightInfos[0].AirplaneTypeDesc"/>" /> 
...
$("#hidsegmentinfo").val("");//初始化

var iszhongzhuan=$("#iszhongzhuan_"+ind).val();
if(iszhongzhuan=='1'){
 bindsegmentinfo(ind,'0');
}else{
for(a=0;a<iszhongzhuan;a++){
bindsegmentinfo(ind,a);
}
...
var hidseg=$("#hidsegmentinfo").val();
  $.ajax({
	         type:"POST",
	        // async: false,
	         url:"interticket!Valada_Cabin_Pice.action",
	         data:{s_jasonsegmentinfo:hidseg},
	        // beforeSend:function(){$("#low_fandian_"+i).html("<img src='images/loadding.gif' />")},         
	         success:function(data){
							...
							$("#aired_"+ind).val(ed);
							$("#tax_"+ind).html(tax);
							$("#AirPrice_"+ind).val(tax);
							
							
							$("#price_"+ind).html(pri);
							$("#price_"+ind).val(pri);
							$("#xcprice_"+ind).val(pri);
							$("#piaomianjia_"+ind).val(pri);
							}else{
							alert("不可预订");
							$("#lod_"+ind).hide();
							$("#yud_"+ind).hide();
...
function valadate_price(seginfo,ind){
...
<ww:if test="listInterFlightInfo.size==0">
alert('暂无数据!请从新查询或者更换条件!');
</ww:if>
	 ...
	 function searchProductClassbyName(va) {
	// alert(va);
	 filter_air(va);
	
	
	//alert("CZ321".indexOf(va));
	
	
	 }
	  
$('#sea_air').bind('input propertychange', function() {searchProductClassbyName(this.value);}); 
...
function filter_air(va){
	...
	var tt = jQuery("div[id*='_air_code']");
...
//alert(fliterstr);
	...
	jQuery.each(tt,function(){
		...
		//alert("undefined");
			...
			//alert("jin");
			//alert(fliterstr+"-"+tr.attr("id")+"-"+fliterstr.indexOf(tr.attr("id")));
			var sid=tr.attr("id");
			if((sid.indexOf(fliterstr) > -1 || fliterstr=="")){
...
function seach_type(va){
var tt = jQuery("div[id*='_air_code']");
	jQuery.each(tt,function(){
	
		var tr = jQuery(this);
		
		if(tr.attr("pid")==null||tr.attr("pid")=='undefined'){
		}else{
			var sid=tr.attr("pid");
			if((sid==va || va=="-1")){
				tr.show();
