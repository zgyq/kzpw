	...
	pvalue=<ww:property value="yprice" />;
	  ...
	  var  isok="ok";
	   ...
	   var yprice=0;
            ...
            youxiaoqi=$("#txt_youxiaoqi_"+id).val();
            ...
            jsonstring+='{ ID: "currentindex",Name:"'+name+'",Type:"'+type+'",Idcardtype:"'+idcardtype+'",Idcardnumber:"'+idcardnumber+'",Insurancenum:"'+insurancenum+'",Insurancemoney:"'+insurancetotalprice+'",Ticketprice:"'+ticketprice+'",Airportprice:"'+airportprice+'",Fuelprice:"'+fuelprice+'",Totalprice:"'+totalprice+'",Issave:"'+issave+'",shengri:"'+shengri+'",guoji:"'+guoji+'",sex:"'+sex+'",yprice:"'+yprice+'",youxiaoqi:"'+youxiaoqi+'" },';
						...
						<div class="b2b_OrderL-A01" id="divinformation_\${ID}">
							...
							<ul>
								...
								<li class="b2b_OrderL-A02">
									...
									<div class="b2b_OrderL-A02-2">
										<input type="text" id="txt_youxiaoqi_\${ID}" cname="youxiaoqi" sname="youxiaoqi" onfocus="WdatePicker({skin:'whyGreen',minDate:'%y-%M-%d'})" class="Wdate" class="b2b_OrderL-A02-8" mod_notice_tip="yyyy-mm-dd" placeholder="yyyy-mm-dd" _cqnotice="yyyy-mm-dd" style="">
									</div>
								</li>
								...
								<li class="b2b_OrderL-A02">
									...
									<div class="b2b_OrderL-A02-2">
										...
										<select class="b2b_OrderL-A02-7 " sname="Nationality" id="txt_demoGuoji_\${ID}"  >
											<option value="CN">中国大陆</option>
											<option value="HK">香港</option><option value="JP">日本</option>
...
<form action="interticket!CreateOrder.action" id="form2" name="form2" method="post">
 ...
 <input type="hidden" id="hidallpassengers" name="s_jsonpassengers" value='<ww:property value="hidallpassengers" />'  />
  ...
  <input type="hidden"  name="s_memo" id="c_linkdesc" value="" />
   ...
   <input type="hidden"  name="s_iscreateorder" id="s_iscreateorder" value="1" /><!-- 1创建   0不创建 -->
