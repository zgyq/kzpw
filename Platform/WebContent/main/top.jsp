...
$("#contall").html(tuiticket+feiticket+gaiqianticket+daichupiao+daiqueren+qbnum+telnum+trainnum+trainnum_tui+trainnum_gai);
if(tuiticket>0){
...
<a class="next" href="#"></a> 
 ...
 <td width="432"><table width="100%" height="26" border="0" cellpadding="0" cellspacing="0">
  ...
  <ww:if test="getLoginsessionagent().agenttype==1">
    ...
    <a href="#" onclick="parent.showMessage2();">待处理订单（<span class="dnum" id="contall">0</span>）</a>
    ...
    -->
      ...
      <td width="25%"><b><a href="../login!toagentshow.action" target="member">管理中心</a></b></td>
