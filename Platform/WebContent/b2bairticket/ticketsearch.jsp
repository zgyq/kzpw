...
//页面加载
 ...
 function getDateyyyyMMdd(num) {
    ...
    return str;
        ...
        if(qxordernum>=5){
		alert('你今天有'+qxordernum+'个取消订单.请问你在干什么呢!!!');
		return;
		}
		...
		function valadatequxiao(){
		 
		$.ajax({
	         type:"POST",
	         async:false,
	         url:"cabin!valadateisquxiao.action?rndmath="+Math.floor(Math.random()*100),
	         data:{},
	         success:function(data){
	         	//alert(data);
	         	qxordernum=data;
...
<body id="mainbody">
<form name="form1" method="post" action="b2bairticket!toTicketList.action" id="form1">
...
<div class="f-cb">
<div><input id="rdoRoundWay" type="radio" name="s_traveltype" 
...
返程&nbsp;&nbsp;&nbsp;到达城市: <input name="s_arrcityname" type="text"
	...
	onblur="showSearch('txtEndCity',1)" autocomplete="off" value="北京"
	onkeyup="popup_hide();suggest.display('txtEndCity','hidEndCityCode',event);"
	style="border: 1px solid #ccc;"> <input type="hidden" value="PEK"
...
<div>航空公司: <select name="ddlAirCompany" id="ddlAirCompany"
	...
	<option value="-1">--航空公司--</option>
	<option value="CA">CA 国际航空</option>
...
<!--<div>
<input type="checkbox" name="s_seachtype" value="1"  id="btnSearch"> 柜台版
</div>

--><div>
<input type="checkbox" name="s_seatype" value="1"  id="btnSearch"> 多网比价
</div>
<div class="btn-sch">
...
<!-- end sch -->
<div style="height: 80px;margin-top: 8px;"><ul>

<li style="font-size: 18px;color: red;border: 1px;">
提示：由于航空公司折扣及价格经常变动，最终票价以PAT结果为准！</br>
