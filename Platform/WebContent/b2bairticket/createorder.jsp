...
<!--政策返点 begin-->     
              <div class="policy" >
                 ...
                 <div class="prompt2" style="text-align: left;">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tbody>
		...
		<tr>
			...
			<td width="20%">证件类型</td>
			<td width="20%">证件号</td>
			<ww:if test="#session.dns.agentid!=1">
			...
			<input type="hidden" id="ddlinsurance_<ww:property value="#state.index"/>" value="0"  />
			</ww:else>
...
function subprice(){
 ...
 var  allbaoxianrenshu=0;//保险总份数
 	...
 	var all_totalprice=((parseInt(onejiesuanjia)+parseInt(jijian)+parseInt(ranyou))*renshu)+parseInt(allbaoxianrenshu)*parseInt(baoxianprice)+parseInt(ptfei);
 	 ...
 	 var twozrateid=0;//第一程ID
     var twozratevalue=0;//第一城返点
     var twojiesuanjia=0;//第一城结算价
     var twoyouhui=0;//第一城优惠
     
     if(zratetwoid!=null){
     twozrateid=zratetwoid.split('-')[0];
     twozratevalue=zratetwoid.split('-')[1];
     twojiesuanjia=zratetwoid.split('-')[2];
     twoyouhui=zratetwoid.split('-')[3];
    ...
    $("#hid_twozratevalue").val(twozratevalue);
     ...
     //alert("twozrateid:"+twozrateid+",twozratevalue:"+twozratevalue+",twojiesuanjia:"+twojiesuanjia+",twoyouhui:"+twoyouhui);
 	 all_totalprice+=((parseInt(twojiesuanjia))*renshu);
...
function suborder(){
   ...
   //  alert("onezrateid:"+onezrateid+",onezratevalue:"+onezratevalue+",onejiesuanjia:"+onejiesuanjia+",oneyouhui:"+oneyouhui);
	   ...
	   var issave=1;
            ...
            insurancetotalprice=parseInt(insurancenum)*baoxianprice;
     ...
     for(i=0;i<=8;i++){
       ...
       if(1==1){
			...
			document.form2.action="b2bairticket!createorder.action";
