...
var nobsae=atob(ba);
//alert(nobsae);
 parent.member.location.href=nobsae;
}
...
<div class="box frame" lang="th" >
  <div class="telo"><ww:if test="rightid==null">    
    <ww:property value="#session.listRoot.name"/>
	</ww:if>
	<img src="imagess/ico_platforms.gif" width="28" height="30" /><input name="wqqw" id="rightid" type="hidden" value="<ww:property value="rightid"/>" />
