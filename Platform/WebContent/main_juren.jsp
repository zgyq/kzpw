			...
			if (data != '') {
			  ...
			  //  alert(messagess);
			   if(message!=''){
				...
				//message="<h5>申请退票订单<strong><span>5</span></strong>张</h5>";
				//messagess="<h5>申请退票订单<strong><span>5</span></strong>张</h5>";
				$.messager.anim('fade', 2000);
				
				$.messager.show('<font color="red">系统提示</font>','<font color="red">'+message+'</font>', 10000);
...
<frameset rows="110,*,22" cols="*" frameborder="no" border="0" framespacing="0" onload="onlod();">
  <!-- top  -->
  <frame src="main_jr/login!topmenu.action" name="topFrame" scrolling="no" noresize="noresize" id="topFrame"  />
  <!-- middle -->
...
<!-- bottom -->
  <frame src="main_jr/bottom.jsp" name="bottomFrame" scrolling="no" noresize="noresize" id="bottomFrame"  />
</frameset>
<noframes>
