...
<title><ww:if test="carbrand
		.id>0">编辑</ww:if><ww:else>新增</ww:else>汽车品牌
		</title>
...
<body>
<div id="member">
<form action="carbrand
		!<ww:if test="carbrand
		.id>0">edit.action?id=<ww:property value="carbrand
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;<ww:if test="carbrand
		.id>0">编辑</ww:if><ww:else>新增</ww:else>汽车品牌
		</span></b></td>
	</tr>
		<td align="center">
		 ...
		 <tr>
				...
				<td width="10%" height="30" align="left" class="table_color_l">
					<input type="text"  name="code
						" value='<ww:property value="carbrand.code"/>'" style="width: 300px" />
				</td>
				...
				<td width="10%" height="30" class="table_color_l" align="left">
					<input type="text"  name="name
						" value='<ww:property value="carbrand.name
						"/>'" style="width: 300px" />
				</td>
		</tr>
		 ...
		 <tr>
				...
				<td width="10%" height="30" align="left" class="table_color_l">
					<input type="text"  name="comment
						" value='<ww:property value="carbrand.comment"/>'" style="width: 300px" />
				</td>
			...
			<tr>
				...
				<input type="submit"
							...
							onclick="window.location.href='carbrand.action?<ww:property value="url"/>';"
