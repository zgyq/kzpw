...
function method1(tableid) {//整个表格拷贝到EXCEL中 
    ...
    try{
        var fname = oXL.Application.GetSaveAsFilename("旅游线路利润报表.xls", "Excel Spreadsheets (*.xls), *.xls");
    }catch(e){
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;旅游订单利润报表</span></b></td>
	</tr>
	<tr>
		<td valign="top">
		<form name="form1" method="post"
			action="triporder!lirun.action">
								...
								<table id="menutable" width="99%" border="1" align="center"
									...
									<tbody>
										<tr class="tbody_color">
											...
											<th class="table_color">加盟商利润</th>
											<th class="table_color">平台利润</th>
										</tr>
										<ww:iterator value="listTriporder">
											<tr id="<ww:property value="id"/>" align="center">
												...
												<td class="table_color"><ww:property value="fanprice" /></td>
												<td class="table_color"><ww:property value="pnum" />元</td>
											</tr>
										</ww:iterator>
										<tr>
										<td></td>
