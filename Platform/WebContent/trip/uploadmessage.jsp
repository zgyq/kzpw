...
<body>
<div style="width: 100%;text-align: center;">对不起，您上传的图片格式不正确，请上传gif,jpg,png格式的图片！<br />
    <input id="submitreg" onclick="javascript:window.history.go(-1);"  type="button" name="button" id="button" class="button108"  value="返回上一页" />
</div>
</body>
</html>