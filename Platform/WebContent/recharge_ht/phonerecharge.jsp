...
window.location.href="ofcard!vmoneymobileRecharge.action?orderid="+id;
					...
					<ww:iterator value="#request.rechargelist" status="t">
						<tr>
							...
							<td class="table_color"><span
								id='state<ww:property value="id"/>'><ww:property
								value="statestr" /></span> <ww:if test="state==0">
								<a
									onclick="refreshRechstate('<ww:property value="id"/>')"
									href="#" style="size: 3"> 刷新</a>
							</ww:if></td>
