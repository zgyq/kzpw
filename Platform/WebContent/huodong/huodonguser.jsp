        ...
        items: [
		     
		    {
				...
				handler : function(item){
					window.location.href="huodonguser!toadd.action?<ww:property value="url"/>";
			...
			,{  
				...
				handler : function(item){
						document.form1.action="huodonguser!toedit.action?id="+selectId;
            ...
            },
			{
				...
				handler : function(item){
					Ext.MessageBox.show({title:'删除',width:300, msg:'确认删除吗？',buttons: Ext.MessageBox.YESNO,fn:function(btn){
						...
						if(btn=='yes')
						{
						document.form1.action="huodonguser!delete.action?id="+selectId;
						document.form1.submit();
			...
			'-',
			{
				...
				handler :function(item){
						document.form1.action="huodonguser!tocheck.action?id="+selectId;
						document.form1.submit();
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;活动会员列表</span></b></td>
	</tr>
	<tr>
		<td valign="top">
		<form name="form1" method="post" action="huodonguser.action">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
           ...
           <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="80" height="20" align="right">姓名：</td>    <td><span style="HEIGHT: 71px">
                  <input id="startnum2"    style="WIDTH: 181px" name="s_name" value="<ww:property value="s_name" />" />
                </span></td>
                 <td width="80" height="20" align="right">手机：</td>    <td><span style="HEIGHT: 71px">
                  <input id="startnum2"   style="WIDTH: 181px" name="s_mobile" value="<ww:property value="s_mobile" />" />
                </span></td>
                
              
              </tr>
               <tr>
                <td width="80" height="20" align="right">证件号码：</td>    <td><span style="HEIGHT: 71px">
                  <input id="startnum2"   style="WIDTH: 181px" name="s_isnumber" value="<ww:property value="s_isnumber" />" />
                </span></td>
                 <td width="80" height="20" align="right">参加时间：</td>    <td><span style="HEIGHT: 71px">
                  <input id="startnum2"   style="WIDTH: 181px" name="s_time" value="<ww:property value="s_time" />"
							...
							<tr>
								...
								<table id="menutable" width="99%" border="1" align="center"
									...
									<tbody>
										...
										<ww:iterator value="listHuodonguser">
											<tr id="<ww:property value="id"/>" align="center"
												...
												<!--<td class="table_color"><ww:property value="loginpwd" /></td>
												...
												<ww:if test="idtype==9">其他</ww:if>
												</td>
												<td class="table_color"><ww:property value="idnumber" /></td>
												<!--<td class="table_color"><ww:property value="areacode" /></td>
												<td class="table_color"><ww:property value="tel" /></td>
												--><td class="table_color"><ww:property value="mobile" /></td>
												<td class="table_color"><ww:property value="mail" /></td>
												<!--<td class="table_color"><ww:property value="postalcode" /></td>
...
<script language="JavaScript">
	function toadd(){
		window.location="huodonguser!toadd.action?<ww:property value="url"/>";
	}
	function deleteItem(){
			...
			if(length== undefined){
				...
				if(document.form1.selectid.checked ==true)
				{
						...
						if(temp==true){
							...
							document.form1.action="huodonguser!delete.action?id="+document.form1.selectid.value;
							document.form1.submit();
						}
						return;
				}
			  	 ...
			  	 if ( length == null || length==0 ){
					     ...
					     for (var i = 0; i < length; i++)
					      ...
					      if(len==1){
					      	var temp = confirm('确认删除吗？');
							if(temp==true){
								document.form1.action="huodonguser!delete.action?id="+uvalue;
								document.form1.submit();
							}
							return;
					      }else if (len>1){
					      	var temp = confirm('确认删除吗？');
					      	if(temp==true){
					      		document.form1.action="huodonguser!batch.action?opt=1";
								document.form1.submit();
							}
							return;
 ...
 function updateItem(){
			...
			if(length== undefined){
				...
				if(document.form1.selectid.checked ==true)
				{
						...
						document.form1.action="huodonguser!toedit.action?id="+document.form1.selectid.value;
						document.form1.submit();
			  	 ...
			  	 if ( length == null || length==0 ){
					     ...
					     for (var i = 0; i < length; i++)
					      ...
					      if(len==1){
					      		document.form1.action="huodonguser!toedit.action?id="+uvalue;
								document.form1.submit();
								return;
					      }else if (len>1){
 ...
 function checkItem(){
			...
			if(length== undefined){
				...
				if(document.form1.selectid.checked ==true)
				{
						...
						document.form1.action="huodonguser!tocheck.action?id="+document.form1.selectid.value;
						document.form1.submit();
			  	 ...
			  	 if ( length == null || length==0 ){
					     ...
					     for (var i = 0; i < length; i++)
					      ...
					      if(len==1){
					      		document.form1.action="huodonguser!tocheck.action?id="+uvalue;
								document.form1.submit();
								return;
					      }else if (len>1){
					      	var temp = confirm('只能选择一项进行操作？');
