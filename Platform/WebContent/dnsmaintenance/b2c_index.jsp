	...
	<tr>
		...
		<input type='hidden' name='id'
			...
			<table width="85%" border="1" bordercolor="#86B2D1" cellspacing="0"
					...
					<tr>
					<td align="right" height="50" style="background: #daf0fc"><b>1：</b></td>
						<td>
						<input id="file1" type="file" name="index_files1"   />
						
						<font style="color: red">*</font>
						<font id="vfile1">若需更换请重新选择图片(652*149 格式为.jpg)</font>
						</td>
					</tr>	
					<tr>
					<td align="right" height="50" style="background: #daf0fc"><b>2：</b></td>
						<td>
						<input id="file1" type="file" name="index_files2"   />
					...
					<tr>
					<td align="right" height="50" style="background: #daf0fc"><b>3：</b></td>
						<td>
						<input id="file1" type="file" name="index_files3"   />
					...
					<tr>
					<td align="right" height="50" style="background: #daf0fc"><b>4：</b></td>
						<td>
						<input id="file1" type="file" name="index_files4"   />
