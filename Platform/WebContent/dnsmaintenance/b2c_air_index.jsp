	...
	<tr>
		...
		<input type='hidden' name='id'
			...
			<table width="85%" border="1" bordercolor="#86B2D1" cellspacing="0"
					...
					<tr>
					<td align="right" height="50" style="background: #daf0fc"><b>大图：</b></td>
						<td>
						<input id="file1" type="file" name="files7"   />
					...
					<tr>
					<td align="right" height="50" style="background: #daf0fc"><b>小图：</b></td>
						<td>
						<input id="file2" type="file" name="files8"   />
