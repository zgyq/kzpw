...
<div class="huang">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:25px;color:#fff">1.</span><b class="bai_c">订单信息-订单号：
...
<table width="100%" border="1" cellpadding="0 " ccellspacing="0"
	...
	<tr>
		...
		<td style="color:red;font-weight:bold">￥<ww:property
			value="formatMoney(converNull(orderinfo2.totalticketprice,0)+converNull(orderinfo2.totalfuelfee,0)+converNull(orderinfo2.totalairportfee,0))" /></td>
	</tr>
</table>
<table width="100%" border="1" cellpadding="0 " ccellspacing="0"
			bordercolor="#86B2D1"
...
<table width="100%" border="1" cellpadding="0 " ccellspacing="0"
	...
	<tr>
		...
		<!-- <td><ww:property value="converNull(getsuminsurance(orderinfo.insurance))" /></td> -->
		<td style="color:red;font-weight:bold">￥<ww:property
			value="formatMoney(converNull(orderinfo.totalticketprice,0)+converNull(orderinfo.totalfuelfee,0)+converNull(orderinfo.totalairportfee,0))" /></td>
	</tr>
</table>
<table width="100%" border="1" cellpadding="0 " ccellspacing="0"
			bordercolor="#86B2D1"
			...
			<ww:iterator value="listPassenger" status="t">
				<tr>
					...
					<td><ww:property value="formatMoney(converNull(fuelprice,0))" /></td>
					<td><ww:property value="formatMoney(converNull(airportfee,0))" /></td>
					<!-- <td><ww:property value="formatMoney(converNull(getsuminsurance(insurance),0))" /></td> -->
					<td style=" border-top: none; border-bottom:none; background: #fff" width="100">&nbsp;</td>
				</tr>
			</ww:iterator>
		</table>
...
<table width="90%" border="1" cellpadding="0 " ccellspacing="0"
	...
	<tr>
		<td style="font-size: 18px;color:red;font-weight:bold" align="right">应付金额：<ww:if test="orderinfo.id!=idtemp"><ww:property value="formatMoney(converNull(orderinfo.totalticketprice,0)+converNull(orderinfo.totalfuelfee,0)+converNull(orderinfo.totalairportfee,0)+converNull(orderinfo2.totalticketprice,0)+converNull(orderinfo2.totalfuelfee,0)+converNull(orderinfo2.totalairportfee,0))"/></ww:if><ww:else><ww:property value="formatMoney(converNull(orderinfo2.totalticketprice,0)+converNull(orderinfo2.totalfuelfee,0)+converNull(orderinfo2.totalairportfee,0))"/></ww:else>元&nbsp;&nbsp;</td>
	</tr>
	</tbody>
</table>

<div><ww:include page="../pay.jsp"></ww:include></div>
