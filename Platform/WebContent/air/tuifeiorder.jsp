...
<body>
<form name="form1" method="post" action="b2bticketorder!AllTuiFei.action">
<input type="hidden" name="s_tuifeistate" value="<ww:property value="s_tuifeistate"/>" />
<div id="divpassenger"
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;机票退废订单查询</span></b></td>
	</tr>
	<tr>
		<td valign="top">
								...
								<table class="table2" width="100%" border="0">
									<tr>
										<td width="100%" height="29" colspan="22"
											...
											class="font-blue-cu" style="color: #194B66">&nbsp;&nbsp;订单管理-退废订单查询</span>&nbsp;&nbsp;&nbsp;&nbsp;</td>
									</tr>
								<tr>
													...
													<tbody><tr>
														...
														<td align="left">
															<ul class="ul" style="width: 99%; position: relative; left: 1px;">
																...
																<li id="li1"  <ww:if test="s_tuifeistate==1">class="xuanzhong"</ww:if>><a style="cursor: pointer"   href="b2bticketorder!AllTuiFei.action?s_tuifeistate=1" target="member">新申请</a></li>
																<li id="li2"  <ww:if test="s_tuifeistate==3">class="xuanzhong"</ww:if>><a style="cursor: pointer"  href="b2bticketorder!AllTuiFei.action?s_tuifeistate=3" target="member">审核处理中</a></li>
																<li id="li3" <ww:if test="s_tuifeistate==6">class="xuanzhong"</ww:if> ><a style="cursor: pointer"  href="b2bticketorder!AllTuiFei.action?s_tuifeistate=6" target="member">审核通过待退款</a></li>
																<li id="li19" <ww:if test="s_tuifeistate==5">class="xuanzhong"</ww:if> ><a style="cursor: pointer"  href="b2bticketorder!AllTuiFei.action?s_tuifeistate=5" target="member"">已经退款</a></li>
																<li id="li-1" <ww:if test="s_tuifeistate==2">class="xuanzhong"</ww:if> ><a style="cursor: pointer" href="b2bticketorder!AllTuiFei.action?s_tuifeistate=2">暂无法退废</a></li>
																<li id="li-1" <ww:if test="s_tuifeistate==-1">class="xuanzhong"</ww:if> ><a style="cursor: pointer" href="b2bticketorder!AllTuiFei.action">所有退废</a></li>
								...
								<table id="menutable" width="99%" border="1" align="center"
									...
									<tbody>
										<tr class="tbody_color">
											...
											<th class="table_color"><b>申请原因</b></th>
...
<input type="button" class="button108" id='baoxian' value="选择下单" onclick="ToOnyUrl('b2bticketorder!changagent.action?id=<ww:property value="id" />');" /><br/>
							...
							<tr>
								<td height="43" align="center">
								    ...
								    <ww:property value="getPagination('\"b2bticketorder!AllTuiFei.action?pageinfo.pagenum=\"+pageno')"/>
