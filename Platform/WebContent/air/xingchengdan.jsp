	  ...
	  <tr>
		<td height="131">
			<table width="739" align="left">
			  <tr>
			 	<td width="262" height="37" align="left">&nbsp;</td>
            ...
            <input name="FromTime" type="text"   size="4" maxlength="4" class="input2" value="<ww:property value="formatTimestamp3(segmentinfo.departtime)" />" /></td>
			  ...
			  <td width="52" height="37" align="left"></td>
				...
				<td align="center"><input name="fare32" type="text"  size="7" maxlength="7" class="input2" value="QT <ww:property value="passenger.fuelprice" />"></td>
				...
				<input name="fare3" type="text" size="11" maxlength="11" class="input2" value="CNY <ww:property value="formatMoney(passenger.fuelprice+passenger.airportfee+passenger.price+converNull(passenger.insurprice,0))" />" >
				</ww:else>
	  ...
	  <tr>
		<td>
			...
			<table width="739" align="left">
			  ...
			  <tr>
			  <ww:set name="xcdinfos" scope="webwork" value="GetDaDanNameByID(username)" />
			  <td width="36" height="19" align="left"></td>
				<td height="19" align="center"><ww:property value="#xcdinfos[0]" /></td>
				<td colspan="2" rowspan="2" align="center"><input name="hbno2" type="text"  size="30" class="input2" value="<ww:property value="#xcdinfos[1]" />"></td>
...
function insetvalue(pid,username){
	$.ajax({
			      type:"POST",
			      async:false,
			      url:"xcdno!toyuetucreateXCD.action",
			      data:{s_numinfo:username,s_passid:pid},
			      success:function(data){
			   	 	//alert(data);
			      	if(data=='1'){
			        }else{
