        ...
        items: [
		     
		    {
				...
				handler : function(item){
					window.location.href="sysmessage!toSendMsg.action?<ww:property value="url"/>";
			...
			,{
				...
				handler :function(item){
						document.form1.action="sysmessage!toSendMsgDetail.action?id="+selectId;
...
<script language="JavaScript">
	...
	function detailItem() {
		...
		if(length== undefined){
			if(document.form1.selectid.checked ==true) {
				document.form1.action="sysmessage!toSendMsgDetail.action?id="+document.form1.selectid.value;
				document.form1.submit();
				return;
			}
		}
		if ( length == null || length==0 ){
		    ...
		    if(len==1){
				document.form1.action="sysmessage!toSendMsgDetail.action?id="+uvalue;
				document.form1.submit();
				return;
		    }else if (len>1){
		    	var temp = confirm('只能选择一项进行操作？');
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;我接收的消息列表</span></b></td>
	</tr>
	<tr>
		<td>
		<form name="form1" method="post" action="sysmessage!myReceiveMsg.action">
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			align="center">
			<tr>
				<td valign="top">
							...
							<tr>
								...
								<table width="300" border="0" align="center" cellpadding="0"
									...
									<tr class="font-blue-xi">
										<td height="28" align="right"><span class="STYLE2">消息状态：</span></td>
										<td align="left">&nbsp; 
											<select name="state">
												<option>--选择--</option>
												<option value="0"
													<ww:if test="sysmessage.state==0">selected="selected"</ww:if>>未查看</option>
												<option value="1"
													<ww:if test="sysmessage.state==1">selected="selected"</ww:if>>已查看</option>
											</select>
										</td>
									...
									<tbody>
										...
										<ww:iterator value="listSysmessage">
											<tr id="<ww:property value="id"/>" align="center"
												...
												<td class="table_color"><ww:property
													value="formatTimestamp(modifytime)" /></td>
												<td class="table_color"><ww:if test="state==0">未查看</ww:if>
												<ww:elseif test="state==1">已查看</ww:elseif></td>
											</tr>
										</ww:iterator>
