        ...
        items: [
		     
		    {
				...
				handler : function(item){
					window.location.href="teamapply!toadd.action?<ww:property value="url"/>";
			...
			,{  
				...
				handler : function(item){
						document.form1.action="teamapply!toedit.action?id="+selectId;
            ...
            },
			{
				...
				handler : function(item){
					Ext.MessageBox.show({title:'删除',width:300, msg:'确认删除吗？',buttons: Ext.MessageBox.YESNO,fn:function(btn){
						...
						if(btn=='yes')
						{
						document.form1.action="teamapply!delete.action?id="+selectId;
						document.form1.submit();
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;团队申请表列表</span></b></td>
	</tr>
	<tr>
		<td valign="top">
								...
								<table id="menutable" width="99%" border="1" align="center"
									...
									<tbody>
										<tr class="tbody_color">
											...
											<th class="table_color">所属加盟商ID</th>
										...
										<ww:iterator value="listTeamapply" status="te">
											<tr id="<ww:property value="id"/>" align="center"
												...
												<td class="table_color color_b3"><ww:property value="typeid" /></td>
												...
												<td class="table_color color_b3"><input type="button" class="button108 font-bai" name="" value="查看报价" onclick="chakan('<ww:property value="#te.index" />');" />   </td>

					
											</tr>
						<span style="display: none;" id="s<ww:property value="#te.index" />">
						<tr> <td colspan="12" align="center">
						<table width="90%" cellpadding="0"	cellspacing="0" border="1" border-color="#b3b3b3" style="border-collapse: collapse; margin: 5px;">
											<tr bgcolor="#f0f0f0">
											  ...
											  <td   >操作</td>
														...
														<ww:iterator value="getListsup(id)">
														      <tr  id="<ww:property value="id"/>" align="center" 
																...
																<td   ><ww:property value="getAgentname22(supplierid)"/></td>
																<td  ><ww:property value="offer"/></td>
																<td  ><ww:property value="formatTimestamp(createtime)"/></td>
															    <td  ><input type="button" class="button108 font-bai" name="" value="购买" onclick="goumai(<ww:property value="listTeamapply[#te.index].id"/>,<ww:property value="id"/>);" /> </td>
															</tr>
...
{	
	var size = <ww:property value="listTeamapply.size"/> ;
	if(ss!=index){
		for(i=0;i<size;i++){
	...
	function goumai(teid,id){
		//alert("teid=="+teid+"...id=="+id);
		window.location="teamapply!toorderinfo.action?teamapplyid="+teid+"&supteamid="+id;
	}
	function deleteItem(){
 ...
 function updateItem(){
			...
			if(length== undefined){
				...
				if(document.form1.selectid.checked ==true)
				{
						...
						document.form1.action="teamapply!toedit.action?id="+document.form1.selectid.value;
						document.form1.submit();
			  	 ...
			  	 if ( length == null || length==0 ){
					     ...
					     for (var i = 0; i < length; i++)
					      ...
					      if(len==1){
					      		document.form1.action="teamapply!toedit.action?id="+uvalue;
								document.form1.submit();
								return;
					      }else if (len>1){
