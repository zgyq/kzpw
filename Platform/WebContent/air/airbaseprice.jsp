        ...
        items: [
		     
		    {
				...
				handler : function(item){
					window.location.href="airbaseprice!toadd.action?<ww:property value="url"/>";
			...
			,{  
				...
				handler : function(item){
						document.form1.action="airbaseprice!toedit.action?id="+selectId;
				...
				handler : function(item){
					Ext.MessageBox.show({title:'删除',width:300, msg:'确认删除吗？',buttons: Ext.MessageBox.YESNO,fn:function(btn){
						...
						if(btn=='yes')
						{
						document.form1.action="airbaseprice!delete.action?id="+selectId;
						document.form1.submit();
			...
			'-',
			{
				...
				handler :function(item){
						document.form1.action="airbaseprice!docheck.action?id="+selectId;
						document.form1.submit();
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" >
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;机票基础价格表列表</span></b></td>
	</tr>
	<tr>
		<td valign="top">
		<form name="form1" method="post" action="airbaseprice.action">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td align="center"><input type="button"
									class="button_d font-white" onclick="document.form1.submit();"
									value="查询" /></td>
							</tr>
							<tr>
								<td height="40">
						...
						<table width="100%" border="0" align="center" cellpadding="0"
								...
								<table id="menutable" width="99%" border="1" align="center"
									...
									<tbody>
										<tr class="tbody_color">
											...
											<th class="table_color">基础价格序号</th>
											<th class="table_color">出发机场三字码</th>
											<th class="table_color">到达机场三字码</th>
											<th class="table_color">里程数</th>
											<th class="table_color">Y舱价格</th>
											<th class="table_color">航司两字代码</th>
											<th class="table_color">行李重量</th>
											<!--
										...
										<ww:iterator value="listAirbaseprice">
											<tr id="<ww:property value="id"/>" align="center"
												...
												<td class="table_color"><ww:property value="miles" /></td>
												<td class="table_color"><ww:property value="price" /></td>
												<td class="table_color"><ww:property
													value="aircompanycode" /></td>
												<td class="table_color"><ww:property value="yqflag" /></td>
												<!--<td class="table_color"><ww:property
													value="formatTimestamp(startdate)" /></td>
												<td class="table_color"><ww:property
							...
							<tr>
								<td height="43" align="center"><ww:property
									value="pagination" /> <input type="hidden"
									value="pageinfo.pagenum" name="pageinfo.pagenum" /></td>
							</tr>
						</table>
						</td>
					</tr>
...
<script language="JavaScript">
	function toadd(){
		window.location="airbaseprice!toadd.action?<ww:property value="url"/>";
	}
	function deleteItem(){
			...
			if(length== undefined){
				...
				if(document.form1.selectid.checked ==true)
				{
						...
						if(temp==true){
							...
							document.form1.action="airbaseprice!delete.action?id="+document.form1.selectid.value;
							document.form1.submit();
						}
						return;
				}
			  	 ...
			  	 if ( length == null || length==0 ){
					     ...
					     for (var i = 0; i < length; i++)
					      ...
					      if(len==1){
					      	var temp = confirm('确认删除吗？');
							if(temp==true){
								document.form1.action="airbaseprice!delete.action?id="+uvalue;
								document.form1.submit();
							}
							return;
					      }else if (len>1){
					      	var temp = confirm('确认删除吗？');
					      	if(temp==true){
					      		document.form1.action="airbaseprice!batch.action?opt=1";
								document.form1.submit();
							}
							return;
 ...
 function updateItem(){
			...
			if(length== undefined){
				...
				if(document.form1.selectid.checked ==true)
				{
						...
						document.form1.action="airbaseprice!toedit.action?id="+document.form1.selectid.value;
						document.form1.submit();
			  	 ...
			  	 if ( length == null || length==0 ){
					     ...
					     for (var i = 0; i < length; i++)
					      ...
					      if(len==1){
					      		document.form1.action="airbaseprice!toedit.action?id="+uvalue;
								document.form1.submit();
								return;
					      }else if (len>1){
 ...
 function checkItem(){
			...
			if(length== undefined){
				...
				if(document.form1.selectid.checked ==true)
				{
						...
						document.form1.action="airbaseprice!docheck.action?id="+document.form1.selectid.value;
						document.form1.submit();
			  	 ...
			  	 if ( length == null || length==0 ){
					     ...
					     for (var i = 0; i < length; i++)
					      ...
					      if(len==1){
					      		document.form1.action="airbaseprice!docheck.action?id="+uvalue;
								document.form1.submit();
								return;
					      }else if (len>1){
					      	var temp = confirm('只能选择一项进行操作？');
