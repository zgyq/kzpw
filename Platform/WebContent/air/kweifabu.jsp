        ...
        items: [
		   {  
				...
				handler : function(item){
						document.form1.action="kweisq!toadd.action?kid="+selectId;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;K位特价申请表列表</span></b></td>
	</tr>
	<tr>
		<td valign="top">
									...
									<tbody>
										...
										<ww:iterator value="listKweifabu">
											<tr id="<ww:property value="id"/>" align="center"
												...
												<td class="table_color color_b3"><a href="kweisq!toadd.action?kid=<ww:property value="id" />" style="color:#0000ff">申请</a> </td>
