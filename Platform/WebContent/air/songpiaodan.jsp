										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1"
											...
											<tr>
												...
												<td width="40%"><select id="aircompanycode"
													...
													<ww:iterator value="listAircompany">
														<option value="<ww:property value="aircomcode"/>"
															<ww:if test="zrate.aircompanycode==aircomcode">selected="selected"</ww:if>><ww:property
												...
												<td width="40%"><input id="rbtSingle"
													...
													<ww:if test="zrate.traveltype==1||zrate.traveltype==null">checked="checked"</ww:if>
												...
												<table style="font-size: 9pt" cellspacing="0"
													...
													<tr>
														<td style="width: 100%" colspan="3"><input
															...
															value="<ww:property value="zrate.arrivalport"/>" /><span id="arrivalportstr" class="font-red">*</span>
														</td>
													</tr>
													<tr>
														...
														<td><select name="citylist" id="citylist" size="8"
															...
															<ww:iterator value="listCityairport">
																<option value="<ww:property value="airportcode"/>"
																	<ww:if test="zrate.arrivalport==airportcode">selected="selected"</ww:if>><ww:property
																	value="cityname" />(<ww:property value="airportcode" />)</option>
															</ww:iterator>
														</select></td>
													</tr>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1"
											...
											<tr>
												...
												<td><input id="type" type="radio" class="radio_input"
													...
													<ww:if test="zrate.type==0||zrate.type==null">checked="checked"</ww:if> />适用所有航班
												<input id="type" class="radio_input" type="radio" value="1"
													name="type" onclick="flightnumbercheck(false)"
													<ww:if test="zrate.type==1">checked="checked"</ww:if> />仅适用于以下航班
												<input id="type" class="radio_input" type="radio" value="2"
													name="type" onclick="flightnumbercheck(false)"
													<ww:if test="zrate.type==2">checked="checked"</ww:if> />不适用于以下航班<br />
												航班号: <input id=s_flightnumber type="text" size="40"
													<ww:if test="zrate.type==0||zrate.type==null">disabled="disabled"</ww:if> name="s_flightnumber"
											...
											<tr>
												...
												<td><input id="id_cabincode" style="width: 200px" name="cabincode"
													value="<ww:property value="zrate.cabincode"/>" /><span id="cabincodestr" class="font-red">如果不包含哪个舱位请手动删除</span>
											</tr>
											<tr>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1"
											...
											<tr>
												...
												<td><input name="general" id="general" type="radio"
													...
													<ww:if test="zrate.general==0||zrate.general==null">checked="checked"</ww:if> />
												<label>普通</label> <input name="general" id="general"
													type="radio" class="radio_input" value="1"
													<ww:if test="zrate.general==1">checked="checked"</ww:if> /><label>特殊</label>
												</td>
											</tr>
											<tr>
