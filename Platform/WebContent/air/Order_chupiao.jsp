				...
				<table border="0" cellpadding="0" cellspacing="0" class="main_lanpan" width="99%">
                      ...
                      <tr>
                        <td align="left"><table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                         ...
                         验证码:  <input name="yanzma" type="text" id="hidyzm" value="" onchange="valadateaXCD(this.value);" />(此地方为行程单上编号,请勿乱写.谢谢合作)
                           
                        </table>
                         <input name="passid" type="hidden" id="hid" value="0"   />  
                         
                       <input name="" disabled="disabled" id="sub" type="button" value="打印预览"  onclick="popup('passenger!topassenger.action');" />  
...

{
	...
	return;
		$.ajax({
			      ...
			      data:{s_numinfo:document.getElementById("hidyzm").value,s_passid:document.getElementById("hid").value},
			      success:function(data){
			   	 	//alert(data);
			      	if(data=='1'){
			      		url=url+"?pid="+document.getElementById("hid").value+"&username="+document.getElementById("hidyzm").value;
