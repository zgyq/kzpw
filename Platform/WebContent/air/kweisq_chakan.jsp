...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;K位特价申请单详细信息</span></b></td>
	</tr>
	<tr>
		<td valign="top">
		<form
	 ...
	 --> <input type="radio" name="usertype" value="1"
					...
					<tr>
						...
						<td>					<ww:if test="kweisq.status==1">待审核</ww:if>
												<ww:if test="kweisq.status==2">审核通过</ww:if>
												<ww:if test="kweisq.status==3">审核不通过</ww:if>
							</td>
					...
					<tr class="font-blue-xi">
						...
						<td height="46" scrolling="no" colspan="4" align="center">
						 ...
						 <input type="button"
							...
							onclick="window.location.href='kweisq!tocheck.action?id=<ww:property value="kweisq.id"/>&sid=2';"
							name="Submit3" value=" 通过 " />
						 
						  <input type="button"
							class="button_d font-bai"
							onclick="window.location.href='kweisq!tocheck.action?id=<ww:property value="kweisq.id"/>&sid=3';"
							name="Submit3" value=" 不通过 " />
