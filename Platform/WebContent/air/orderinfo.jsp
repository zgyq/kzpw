...
<form name="form1" method="post" action="orderinfo.action">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;订单信息表列表</span></b></td>
	</tr>
	<tr>
		<td valign="top">
							...
							<tr>
								...
								<table class="table2" width="100%">
									...
									<tr>
										...
										<td align="right" style="width: 16%; height: 26px;"><select  <ww:if test="s_orderstatus!=0">disabled="disabled"</ww:if>
											...
											<option value="19"
												<ww:if test="s_orderstatus==19">selected="selected"</ww:if>>问题订单</option>
										</select></td>




										<td align="right" style="width: 9%; height: 26px;" nowrap="nowrap"></td>
										<td align="right">
										<select name="s_ordertype" style="width: 142px;display:none">
								...
								<table id="menutable" width="99%" border="1" align="center" cellpadding="0" cellspacing="0"
									...
									<tbody>
										<tr class="tbody_color" >
											...
											<th class="table_color" style="font-weight:bold" width="54" height="25"><input
												type="checkbox" name="all1" value="1" onclick="selectall1()" />全选</th>

											<th class="table_color" style="font-weight:bold">订单编号</th>
											<th class="table_color" style="font-weight:bold">乘机人</th>
											<th class="table_color" style="font-weight:bold">行程</th>
											<th class="table_color" style="font-weight:bold">航班号</th>
											<th class="table_color" style="font-weight:bold">起飞时间</th>
											<th class="table_color" style="font-weight:bold">预订时间</th><!--
											<th class="table_color">联系人姓名</th>
											--><th class="table_color" style="font-weight:bold">PNR</th>
											
											
										
											<th class="table_color" style="font-weight:bold">总价</th>
											
											<!--<th class="table_color">票号</th>
											<th class="table_color">订单类型</th>
											-->
											<th class="table_color" style="font-weight:bold">支付方式</th>
											<th class="table_color" style="font-weight:bold">订单状态</th>
											<th class="table_color" style="font-weight:bold">支付状态</th>
											<th class="table_color" style="font-weight:bold">处理人</th>
											<th class="table_color" width="100" style="font-weight:bold">操作</th>
										...
										<ww:iterator value="listOrderinfo">
											...
											<tr id="<ww:property value="id"/>" align="center"
												...
												<input type="button" class="button108"  id="btnCancel" value="立即支付"  onclick="goEdit('orderinfo!orderstatusedit.action?id=<ww:property value="id" />&orderstatus=2','<ww:property value="id" />')" />
												...
												<input type="button" class="button108" id="btnRRTicket" value="暂不能出票"  onclick="goEdit('orderinfo!orderstatusedit.action?id=<ww:property value="id" />&orderstatus=19','<ww:property value="id" />')" />
												</ww:elseif>
												-->
												...
												-->
												<input type="button" class="button108" id="btnRRTicket" value="申请废票"   onclick="goEdit('orderinfo!orderstatusedit.action?id=<ww:property value="id" />&orderstatus=5&pr=1','<ww:property value="id" />')" /><br/>
												<input type="button" class="button108" id="btnRRTicket" value="申请退票"  onclick="goEdit('orderinfo!orderstatusedit.action?id=<ww:property value="id" />&orderstatus=4&pr=2','<ww:property value="id" />')" /><br/>
												<input  type="button" class="button108" id="btnRRTicket" value="申请改签"  onclick="goEdit('orderinfo!orderstatusedit.action?id=<ww:property value="id" />&orderstatus=13','<ww:property value="id" />')" /><br/>
												
												
												<input type="button" class="button108" id="btnRRTicket" value="申请升舱"  onclick="goscang('scang!toadd.action?orderinfoid=<ww:property value="id" />')" /><br/>
												<!--<a href="scang!toadd.action?orderinfoid=<ww:property value="id" />">申请升舱</a><br/>
												-->
												</ww:if>
												
												<ww:if test="orderstatus!=6">
												<input type="button" class="button108" id="btnRRTicket" value="取消订单"  onclick="confirm('您确定要执行取消订单操作吗？');goEdit('orderinfo!orderstatusedit.action?id=<ww:property value="id" />&orderstatus=6','<ww:property value="id" />')" /><br/>
												</ww:if>
