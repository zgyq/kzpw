...
<form name="form1" method="post" action="orderinfo!today.action">
<div id="member">
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	align="center" class="box">
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;当日最新订单列表</span></b></td>
	</tr>
	<tr>
		<td valign="top">
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="0"
									...
									<tbody>
										...
										<ww:iterator value="listOrderinfo">
											...
											<ww:property
												...
												<td class="table_color color_b3">
												<ww:property
													value="formatMoney(totalticketprice)" />
												</td>
												<td class="table_color color_b3">
												...
												<input type="button" class="button108" id="btnCancel" value="取消订单"  onclick="goEdit('orderinfo!orderstatusedit.action?id=<ww:property value="id" />&orderstatus=6','<ww:property value="id" />')" /><br/>
							...
							<ww:property value="getPagination('\"orderinfo!today.action?pageinfo.pagenum=\"+pageno')"/>
