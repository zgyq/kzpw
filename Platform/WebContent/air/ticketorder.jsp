	...
	<table id="tbTravel" class="book_pgcontent" width="100%" border="0"
		...
		<tbody>
			<tr>
				...
				<div class="pubFlights_ca"><img
					src="images/airComlogo/<ww:property value="segmentOne.aircomapnycode" />.gif"><ww:property
					value="segmentOne.aircompanyname" /> <ww:property
					value="segmentOne.flightnumber" /></div>
				</td>

				<td style="width: 104px;">所选舱位<br> ( 
				<ww:property value="segmentOne.discount"></ww:property>折)<ww:property
					value="segmentOne.cabincode"></ww:property>舱</td>
				...
				<ww:property value="segmentOne.flightmodelnum" /> </span></td>
				...
				<td><ww:property value="formatTimestamp(segmentOne.departtime)" />
				<img src="images/plane1.gif" /><ww:property
					value="flightOne.StartAirportName" /> 起飞 <br>
				<ww:property value="formatTimestamp(segmentOne.arrivaltime)" /> <img
					src="images/plane2.gif" /><ww:property
					value="flightOne.EndAirportName" /> 到达</td>
				<td class="base_txtgray" style="width: 250px;"><span
					class="base_price01"><b><dfn>&#165;</dfn><ww:property
					value="formatMoney(segmentOne.Price+segmentOne.airportfee+segmentOne.fuelfee)" /></b></span>/成人<br>
				（含税费）<input type='hidden' id='hidPriceSin' value='<ww:property value="segmentOne.Price" />'  />
				        <input type='hidden' id='hidYPriceSin' value='<ww:property value="segmentOne.yprice"/>' /> 
				        <input type='hidden' id='hidairportFeeSin' value='<ww:property value="segmentOne.airportfee"/>' />
				        <input type='hidden' id='hidfuelFeeSin' value='<ww:property value="segmentOne.fuelfee"/>' />
				        <input type='hidden' id='hidtotalSin' value='<ww:property
					value="formatMoney(segmentOne.Price+segmentOne.airportfee+segmentOne.fuelfee)" />' />
				</td>
			</tr>
			<ww:if test="flightTwo!=null">
				<tr height='5px'>
					<td colspan='10'>
					<hr class='hr1' />
					</td>
				...
				<tr>
					...
					<div class="pubFlights_ca"><img
						src="images/airComlogo/<ww:property value="segmentTwo.aircomapnycode" />.gif"><ww:property
						value="segmentTwo.aircompanyname" /> <ww:property
						value="segmentTwo.flightnumber" /></div>
					</td>

					<td style="width: 64px;">所选舱位<br> ( 
					<ww:property value="segmentTwo.discount"></ww:property>折)<ww:property
						value="segmentTwo.cabincode"></ww:property>舱</td>

					<td style="width: 76px; text-align: center;">机型 <span
						cdm="jpi_flighttype" class="base_txtdiv" mod="jmpInfo"
						mod_jmpinfo_page="fltDomestic_planeType.asp?CraftType=738">
					<ww:property value="segmentTwo.flightmodelnum" /> </span></td>
					<td style="width: 66px;"><span cdm="jpi_exchangerefund"
						class="base_txtdiv" mod="jmpInfo"
						mod_jmpinfo_page="flight_policy_tab" mod_jmpinfo_content="">退改签</span></td>
					<td><ww:property
						value="formatTimestamp(segmentTwo.departtime)" /> <img
						src="images/plane1.gif" /><ww:property
						value="flightTwo.StartAirportName" /> 起飞 <br>
					<ww:property value="formatTimestamp(segmentTwo.arrivaltime)" /> <img
						src="images/plane2.gif" /><ww:property
						value="flightTwo.EndAirportName" /> 到达</td>
					<td class="base_txtgray" style="width: 250px;"><span
						class="base_price01"><b><dfn>&#165;</dfn><ww:property
						value="formatMoney(segmentTwo.Price+segmentTwo.airportfee+segmentTwo.fuelfee)" /></b></span>/成人<br>
					（含税费）
					<input type='hidden' id='hidPriceTwo' value='<ww:property value="segmentTwo.Price" />' />
					<input type='hidden' id='hidYPriceTwo' value='<ww:property value="segmentTwo.yprice" />'/> 
					<input type='hidden' id='hidairportFeeTwo' value='<ww:property value="segmentTwo.airportfee" />' />
					<input type='hidden' id='hidfuelFeeTwo' value='<ww:property value="segmentTwo.fuelfee" />' />
					<input type='hidden' id='hidtotalTwo' value='<ww:property
						value="formatMoney(segmentTwo.Price+segmentTwo.airportfee+segmentTwo.fuelfee)" />' />
					</td>
				</tr>
...
<ul id="passengerinfo" cdm="blk_passengerinfo" class="base_mainbox02 layoutfix">
	<li>
	...
	<div id="customer1"
		...
		class="book_pginfo">
	<div class="divdashed" align="left" width="90%"><b>请选择常用旅客:</b>
     <ww:if test="listCustPassenger != null && listCustPassenger.size() > 0">
		<ww:iterator value="listCustPassenger" status="rowstatus">
		<input type="checkbox" onclick="BindFPass(<ww:property value="#rowstatus.index"/>);" id='chbFPass_<ww:property value="#rowstatus.index"/>' name="muser" value="<ww:property value="id" />"/> <ww:property value="username" /> &nbsp;
		
		<input type="hidden" id="HfFPassName_<ww:property value="#rowstatus.index"/>" value="<ww:property value="username" />" />
		<input type="hidden" id="HfFIDType_<ww:property value="#rowstatus.index"/>" value="1" />
		<input type="hidden" id="HfFIDNumber_<ww:property value="#rowstatus.index"/>" value="123456" />
		<input type="hidden" id="HfFlag_<ww:property value="#rowstatus.index"/>" />
		<input type="hidden" id="HfTbAddedId_<ww:property value="#rowstatus.index"/>" />
	...
	<table class="book_pgcontent" border="0" cellpadding="0"
		...
		<tbody>
			<tr>
				<td widht="30px">&nbsp;</td>
				<td><a id='addPass' style="cursor:hand"><img src="images/add.gif" border="0"><b>添加1位乘客</b></a></td>
			</tr>
			<tr>
				<td  widht="30px">&nbsp;</td>
				<td>
				<div><ww:property value="strPassHtml" /></div>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tbody style="font-weight: normal">
			...
			<tr>
				...
				<td><input value="" name="contactemail"
					id="contactemail" style="width: 165px; color: gray;" type="text"></td>
				<td>&nbsp;</td>
			</tr>
			<tr style="">
			...
			<tr>
				...
				<td colspan="3"><input name="addresa" id="addresa"
					style="width: 355px; color: gray;" type="textarea"
					value=""></td>
			</tr>
		</tbody>
	</table>
...
<table width="100%">
	<tr>
		<td align="center"><input value="上一步"
		  id="btnprev"	style="display:none; background: url(images/hout3.gif); cursor: hand; width: 98px; height: 31px; border: none; color: #FFF; font-weight: bold;"
			onclick="showPrev();" type="button">
			<input value="下一步" id="btnnext"
			style="background: url(images/hout3.gif); cursor: hand; width: 98px; height: 31px; border: none; color: #FFF; font-weight: bold;"
			onclick="return dataCheck();" type="button">
			<input
...
<input id="HfPersonCount" value="1" type="hidden" />
<input id="HfPassNameArr" value="" type="hidden" name="h_name" />
<input id="HfPassType" type="hidden" name="h_ptype" />
<input id="HfIdType" type="hidden" name="h_idtype" />
<input id="HfIdNumber" type="hidden" name="h_idnumber" />
<input id="HfPassInfo" type="hidden" />
<input id="HfPassTypeInfo" type="hidden" value="1" />
<input id="HfIdTypeInfo" type="hidden" value="1" />
<input id="HfIdNumberInfo" type="hidden" />
<input id="HfTravelType" type="hidden" value="<ww:property value="segmentOne.traveltype"/>" />
<input id="HfTotalPrice" type="hidden" />
<input id="HfTotalAirportFee" type="hidden" />
<input id="HfTotalFuelFee" type="hidden" />
<input id="HfCustomerName" type="hidden" />
<input id="hfCustomerCardId" type="hidden" />
<input id="hfCustomerID" type="hidden" />
<input id="HfAdultNum" type="hidden" value="0"/>
<input id="HfChildNum" type="hidden" value="0" />
<input id="HfBabyNum" type="hidden" value="0" />
<input id="hfAllPassName" type="hidden" />
<input id="hfcusGuid" type="hidden" />
<input id="hdfAddress" type="hidden" />
<input id="strTotalPriceOne" type="hidden" name="strTotalPriceOne">
<input id="strTotalPriceTwo" type="hidden" name="strTotalPriceTwo">
</form>
</body>
</html>
