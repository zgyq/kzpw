        ...
        items: [
		     
		    {
				...
				handler : function(item){
					window.location.href="kweifabu!toadd.action?<ww:property value="url"/>";
			...
			,{  
				...
				handler : function(item){
						document.form1.action="kweifabu!toedit.action?id="+selectId;
            ...
            },
			{
				...
				handler : function(item){
					Ext.MessageBox.show({title:'删除',width:300, msg:'确认删除吗？',buttons: Ext.MessageBox.YESNO,fn:function(btn){
						...
						if(btn=='yes')
						{
						document.form1.action="kweifabu!delete.action?id="+selectId;
						document.form1.submit();
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;K位特价发布表列表</span></b></td>
	</tr>
	<tr>
		<td valign="top">
		<form name="form1" method="post" action="kweifabu.action">
        ...
        --></td>
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<table id="menutable" width="99%" border="1" align="center"
									...
									<tbody>
										...
										<ww:iterator value="listKweifabu">
											<tr id="<ww:property value="id"/>" align="center"
												...
												<td class="table_color color_b3"><ww:property value="getAircomapnycodeByEZM(ca)" /></td>
												<td class="table_color color_b3"><ww:property
													value="formatTimestamp(starttime)" /></td>
												<td class="table_color color_b3"><ww:property value="getAirnamebySZM(startcity)" /></td>
												<td class="table_color color_b3"><ww:property value="getAirnamebySZM(endcity)" /></td>
												<!--<td class="table_color color_b3"><ww:property
													value="flightnumber" /></td>
												<td class="table_color color_b3"><ww:property value="cabincode" /></td>
												<td class="table_color color_b3"><ww:property
													value="formatTimestamp(createtime)" /></td>
												--><td class="table_color color_b3"><ww:property
													value="nominalprice" /></td>
												<td class="table_color color_b3"><ww:property value="discount" /></td>
												<td class="table_color color_b3"><ww:property value="taxrate" /></td>
												<td class="table_color color_b3"><ww:property value="comment" /></td>
												<td class="table_color color_b3"><ww:property
													value="settlementprice" /></td>
												<!--<td class="table_color color_b3"><ww:property value="policy" /></td>
												<td class="table_color color_b3">
												<ww:if test="usertype==1">内宾</ww:if>
												<ww:if test="usertype==2">外宾</ww:if></td>
							...
							<ww:property value="getPagination('\"kweifabu!tomy.action?pageinfo.pagenum=\"+pageno')"/>
...
<script language="JavaScript">
	function toadd(){
		window.location="kweifabu!toadd.action?<ww:property value="url"/>";
	}
	function deleteItem(){
			...
			if(length== undefined){
				...
				if(document.form1.selectid.checked ==true)
				{
						...
						if(temp==true){
							...
							document.form1.action="kweifabu!delete.action?id="+document.form1.selectid.value;
							document.form1.submit();
						}
						return;
				}
			  	 ...
			  	 if ( length == null || length==0 ){
					     ...
					     for (var i = 0; i < length; i++)
					      ...
					      if(len==1){
					      	var temp = confirm('确认删除吗？');
							if(temp==true){
								document.form1.action="kweifabu!delete.action?id="+uvalue;
								document.form1.submit();
							}
							return;
					      }else if (len>1){
					      	var temp = confirm('确认删除吗？');
					      	if(temp==true){
					      		document.form1.action="kweifabu!batch.action?opt=1";
								document.form1.submit();
							}
							return;
 ...
 function updateItem(){
			...
			if(length== undefined){
				...
				if(document.form1.selectid.checked ==true)
				{
						...
						document.form1.action="kweifabu!toedit.action?id="+document.form1.selectid.value;
						document.form1.submit();
			  	 ...
			  	 if ( length == null || length==0 ){
					     ...
					     for (var i = 0; i < length; i++)
					      ...
					      if(len==1){
					      		document.form1.action="kweifabu!toedit.action?id="+uvalue;
								document.form1.submit();
								return;
					      }else if (len>1){
 ...
 function checkItem(){
			...
			if(length== undefined){
				...
				if(document.form1.selectid.checked ==true)
				{
						...
						document.form1.action="kweifabu!tocheck.action?id="+document.form1.selectid.value;
						document.form1.submit();
			  	 ...
			  	 if ( length == null || length==0 ){
					     ...
					     for (var i = 0; i < length; i++)
					      ...
					      if(len==1){
					      		document.form1.action="kweifabu!tocheck.action?id="+uvalue;
								document.form1.submit();
								return;
					      }else if (len>1){
					      	var temp = confirm('只能选择一项进行操作？');
