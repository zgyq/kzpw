				...
				<table width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
					   ...
					   <option value="0"
						...
						<option value="2"
					     <ww:if test="sysmessage.type==2">selected="selected"</ww:if>>弹屏公告</option>
...
<script language="javascript"><!--
	function form_validate() {
		...
		if(parseInt(content.length)<3) {
			document.getElementById("contentstr").innerHTML="*内容长度不能小于3个字符";
			content.focus();
			validate = false ;
		} else {
		...
		if(parseInt(title.value.length)<3) {
			document.getElementById("titlestr").innerHTML="*标题长度3个以上字符";
			title.focus();
			validate = false ;
		}else {
