...
<title><ww:if test="teamapply.id>0">编辑</ww:if><ww:else>新增</ww:else>K位订单</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;新增K位订单</span></b></td>
	</tr>
	<tr>
		<td valign="top">
		<form
			action="kweisq!addorder.action" id="form1"
...
<ww:bean
	...
	<ww:param name="'last'" value="kweisq.peoplenumber" />
	...
	<td></td>
     ...
     <input type="text" name="lianxiren" id="lianxiren"  value="<ww:property value="kweisq.username"/>" desc="联系人姓名" class="validate[required]"/>
       </td>
       </tr>
      <tr><td style="text-indent: 25px;" colspan="4">联系人手机：
     <input type="text" name="shouji" id="shouji"   value="<ww:property value="kweisq.mobile"/>" desc="手机号码" class="validate[required,custom[mobile]]"
       </td>
       </tr>
      <tr><td style="text-indent: 25px;" colspan="4">联系人邮箱：
     <input type="text" name="youxiang"  id="youxiang"  value="<ww:property value="kweisq.postbox"/>" desc="电子邮箱" class="validate[required,custom[email]]"/>
       </td>
       </tr>
	</table>	
	<input type="hidden" name="kid" value="<ww:property value="kid"/>" />
	<input type="hidden" name="ksid" value="<ww:property value="ksid"/>" />
...
var chengren = '<ww:property value="kweisq.chengren"/>';

var ertong = '<ww:property value="kweisq.ertong"/>';
var yinger = '<ww:property value="kweisq.yinger"/>';
