...
function checkdata1()
{
   if($("#xingchengdanhao").val()=="" || $("#xingchengdanhao").val()=="请填写行程单号")
   {
      alert("行程单号为必填项，请填写行程单号！");
  ...
  <div class="pb"  >
    <div id="page1">
      ...
      <div class="jc" style="left: 475px;top: 74px;width:100%;">
       ...
       <input  type="text" id="xingchengdanhao" value="请填写行程单号" style="border:0;background-color:transparent;font:TEE" onfocus="clearxingchengdan();" onblur="getyanzhengma();"/>
       </div>
      <!-- 印刷序列号 -->
      <div class="jc1" style="left: 72px;	top: 101px;FONT-SIZE:16pt;font:TEE;">
         <ww:property value="orderinfo.pnr" /></div>
      <div class="jc2" style="left: 71px;	top: 138px;">
          <ww:property value="segmentinfo.startairport" /></div>
      <div class="jc2" style="left: 71px;	top: 170px;">
         <ww:property value="segmentinfo.endairport" /></div>
      <div class="jc3" style="left: 105px;top: 139px;FONT-SIZE:16pt;width:70px; font:TEE"> 
          <ww:property value="getname(segmentinfo.startairport)" /></div>
      <div class="jc3" style="left: 105px;top: 171px;FONT-SIZE:16pt;width:70px;font:TEE">
         <ww:property value="getname(segmentinfo.endairport)" /></div>
      <div class="jc3" style="left: 191px;top: 139px;FONT-SIZE:16pt;font:TEE">
          <ww:property value="segmentinfo.aircomapnycode" /></div>
      ...
      <div class="jc3" style="left: 191px;top: 261px;width:135px;FONT-SIZE:16pt;font:TEE;word-spacing:1px; letter-spacing: 1px;"><!-- <ww:property value="passenger.price" /> -->
          CNY<input type="text" onblur="accountprice();" id="txtpiaomianjia" value='<ww:property value="passenger.price" />' ReadOnly='readonly' style="border:0;background-color:transparent;width:60px;font:TEE;" /><!-- 票面价 -->
          <asp:Label ID="Label18" runat="server" ></asp:Label></div>
      <div class="jc3" style="left: 292px;top: 263px;width:125px;FONT-SIZE:16pt;font:TEE">&nbsp;
      <ww:if test="passenger.airportfee==null">
          ...
          <ww:else>
          CN<input type="text" id="airportfee" onblur="accountprice();"  value='<ww:property value="passenger.airportfee" />' ReadOnly='readonly' style="border:0;background-color:transparent;width:40px;font:TEE" /><!--基建费YQ-->
          </ww:else>
	</div>
      <div class="jc3" style="left: 415px;top: 263px;width:125px;FONT-SIZE:16pt;font:TEE">
          ...
          <ww:else>
          YQ<input type="text" id="fuelfee" onblur="accountprice();" value='<ww:property value="(passenger.fuelprice)*100/100" />' ReadOnly='readonly' style="border:0;background-color:transparent;width:40px;font:TEE" /><!-- 燃油费 -->&nbsp;
          </ww:else>
          </div>
      <div class="jc3" style="left: 594px;top: 259px;width:115px;FONT-SIZE:16pt;font:TEE">
          CNY<input type="text" id="totalprice" value='<ww:property value="orderinfo.totalticketprice+orderinfo.totalairportfee+orderinfo.totalfuelfee" />' ReadOnly='readonly' style="border:0;background-color:transparent;width:70px;font:TEE" /><!-- 总价格 --></div>
      ...
      <div id="yanzhengma" class="jc3" style="left: 277px;top: 285px;width:40px;FONT-SIZE:16pt;font:TEE;letter-spacing:0px">
          <ww:property value="(passenger.ticketnum).substring(0,4)" /><!-- 验证码 --></div>
	  <div class="jc3" style="left: 700px;top: 281px;width:40px;FONT-SIZE:16pt;font:TEE;letter-spacing:0px"></div>
      <div class="jc4" style="left: 89px;top: 315px;width:175px;FONT-SIZE:16pt;font:TEE" id="ComCode" ><input type="text" value="SIA296" ReadOnly="readonly" style="border:0;background-color:transparent;font:TEE" /><asp:Label ID="agent_symble" runat="server" ></asp:Label></div>
      <div class="jc4" style="left: 90px;top: 329px;width:175px;FONT-SIZE:16pt;font:TEE" id="AgentCode"><input type="text" value="08052693" ReadOnly="readonly" style="border:0;background-color:transparent;font:TEE" /><asp:Label ID="agent_code" runat="server" ></asp:Label></div>
      ...
      <div class="jc" style="left: 289px;top: 320px;width:235px">陕西龙泰基航空旅游有限公司</div>
    </div>
  </div>
</div>
