			...
			<tr>
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						<td valign="top" style="color: red">
						操作提示：<br />
						1.儿童票规定的年龄为：2-12岁。以生日为准；<br />
						2.成人票面价经济舱以下为Y舱票价的50%，头等或公务为成人票价的50%,不收机建费,燃油税收取50%；<br />
						3.成人与儿童为两个订单，在不同订座记录中，如果成人提交了退改签，儿童票也需要提交一次。<br />
						4.操作步骤：录入儿童资料==>支付票款==>等待出票==>出票完成<br />
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<table id="menutable" width="99%" border="1" align="center"
									...
									<tbody>
											<tr align="center">
												<td class="table_color">儿童姓名:<input type="text" id="h_name" name="h_name" />  </td>
												<td class="table_color">身份证号:<input type="text" id="h_birthday" name="h_birthday" />  </td>
							...
							<input type="button" value="添加儿童票" id="addrt" onclick="createRTorder();"  />
							</td>
							</tr>
...
var h_insurance=$("#h_insurance").val();
...
$("#addrt").hide();
       ...
       $.ajax({
            type:"POST",
            url:"b2bticketorder!CreateRtOrder.action",
            data:{s_orderid:$("#s_orderid").val(),h_name:h_name,h_birthday:h_birthday,h_insurance:h_insurance},
