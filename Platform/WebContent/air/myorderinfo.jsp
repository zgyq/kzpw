...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			...
			<ww:if test="type==4">我的团队订单</ww:if><ww:if test="type==5">我的K位订单</ww:if>
			列表</span></b></td>
	</tr>
	<tr>
		<td valign="top">
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="0"
									...
									<tbody>
										...
										<ww:iterator value="listOrderinfo">
											...
											<a href="javascript: goEdit('orderinfo!toshowgys.action?id=<ww:property value="id"/>','<ww:property value="id"/>');">
												...
												<td class="table_color color_b3" style="line-height:16px;">
												<ww:property
													value="getPassengersizi(id)" />
												...
												--><td class="table_color color_b3">
												<ww:property value="formatTimestamp2(#segmentinfoss.departtime)"/></td>
												...
												<input type="button" class="button108" id="btnCancel" value="立即出票"  onclick="goEdit('orderinfo!editorderstatus.action?id=<ww:property value="id" />&orderstatus=3','<ww:property value="id" />')" /><br/>
							...
							<tr>
								...
								<ww:if test="type==4">
								<ww:property value="getPagination('\"orderinfo!tomytuandui.action?pageinfo.pagenum=\"+pageno')"/>
								</ww:if>
							<ww:if test="type==5">
								<ww:property value="getPagination('\"orderinfo!tomykwei.action?pageinfo.pagenum=\"+pageno')"/>
								</ww:if>
