								...
								<table id="menutable" width="99%" border="1" align="center"
									...
									<tbody>
										<tr class="tbody_color">
											...
											<!--
											<th class="table_color"><b>总销售价</b></th>
											-->
											</ww:if>
											<ww:else>
											<th class="table_color"><b>总销售价</b></th>
										...
										<ww:iterator value="listOrderinfo">
											...
											<tr id="<ww:property value="id"/>" align="center"
												...
												￥<ww:property
													...
													<td class="table_color color_b3">
													￥<ww:property
														value="formatMoneyShort(converNull(postmoney,0)+converNull(totalticketprice,0)+converNull(rebatemoney,0)+converNull(totalairportfee,0)+converNull(totalfuelfee,0)+converNull(getIssurByOrderid(id),0))" />
														</br>
														<ww:if test="getIssurByOrderid(id)>0"><span style="color: red">(含保险)</span></ww:if>
														<ww:if test="converNull(postmoney,0)>0"></br><span style="color: red">(含行程单)</span></ww:if>
														<ww:if test="getXCDByOrderid(id)>0"></br><span style="color: red">(含配送)</span></ww:if>
												...
												<td class="table_color color_b3" style="color:red"><ww:property
													value="getPayMethodStr(paymethod)" /></td>
												</ww:if>
												<td class="table_color color_b3">
												...
												<td class="table_color color_b3"  >
												 ...
												 <br/>
												  ...
												  <input type="hidden" id="orderid_<ww:property value="id" />" value="<ww:property value="addresa" />" />
													...
													<font style="color: red">供应状态:<ww:property value="getExtStateToString(extorderstatus)" /></font>
													 </ww:if>
											...
											<!-- 
												...
												<!-- 测试用 -->
												<input type="button" class="button108" id="btnCancel" value="生成差价单"  onclick="ToOnyUrl('scang!toadd.action?orderinfoid=<ww:property value='id' />');" /> <br />
