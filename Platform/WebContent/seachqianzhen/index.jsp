...
<link rel="stylesheet" type="text/css"
	href="seachqianzhen/css/cube_min.css" />
...
-->
<link rel="stylesheet" type="text/css"
	href="seachqianzhen/css/visa_index.css" />
...
<div id="world_map" class="world_map"><img usemap="#planetmap"
	alt="世界地图" src="seachqianzhen/image/bottom_bg.png" /> <map
...
<div class="hot_country"><span class="country_title"> <span>热门国家</span>
</span>&nbsp;&nbsp;<span><a href="#" onclick="showall();return false;">[全部]</a></span>

<div class="hot_country_box fix"><span class="country"><a
	href="qzseach!toqzbycont.action?c_id=32" title="美国签证"><img
	src="seachqianzhen/image/United-States.png" alt="美国" />&nbsp;美国</a></span> <span
	class="country"><a href="qzseach!toqzbycont.action?c_id=31"
	title="加拿大签证"><img src="seachqianzhen/image/Canada.png" alt="加拿大" />&nbsp;加拿大</a></span>

<span class="country"><a href="qzseach!toqzbycont.action?c_id=34"
	title="澳大利亚签证"><img src="seachqianzhen/image/Australia.png"
	alt="澳大利亚" />&nbsp;澳大利亚</a></span> <span class="country"><a
	href="qzseach!toqzbycont.action?c_id=36" title="新西兰签证"><img
	src="seachqianzhen/image/New-Zealand.png" alt="新西兰" />&nbsp;新西兰</a></span> <span
	class="country"><a href="qzseach!toqzbycont.action?c_id=13"
	title="法国签证"><img src="seachqianzhen/image/France.png" alt="法国" />&nbsp;法国</a></span>
<span class="country"><a href="qzseach!toqzbycont.action?c_id=19"
	title="意大利签证"><img src="seachqianzhen/image/Italy.png" alt="意大利" />&nbsp;意大利</a></span>
<span class="country"><a href="qzseach!toqzbycont.action?c_id=25"
	title="西班牙签证"><img src="seachqianzhen/image/Spain.png" alt="西班牙" />&nbsp;西班牙</a></span>
<span class="country"><a href="qzseach!toqzbycont.action?c_id=27"
	title="瑞士签证"><img src="seachqianzhen/image/Switzerland.png"
	alt="瑞士" />&nbsp;瑞士</a></span> <span class="country"><a
	href="qzseach!toqzbycont.action?c_id=14" title="德国签证"><img
	src="seachqianzhen/image/Germany.png" alt="德国" />&nbsp;德国</a></span> <span
	class="country"><a href="qzseach!toqzbycont.action?c_id=15"
	title="希腊签证"><img src="seachqianzhen/image/Greece.png" alt="希腊" />&nbsp;希腊</a></span>
<span class="country"><a href="qzseach!toqzbycont.action?c_id=29"
	title="英国签证"><img src="seachqianzhen/image/United-Kingdom.png"
	alt="英国" />&nbsp;英国</a></span> <span class="country"><a
	href="qzseach!toqzbycont.action?c_id=70" title="韩国签证"><img
	src="seachqianzhen/image/South-Korea.png" alt="韩国" />&nbsp;韩国</a></span> <span
	class="country"><a href="qzseach!toqzbycont.action?c_id=82"
	title="日本签证"><img src="seachqianzhen/image/Japan.png" alt="日本" />&nbsp;日本</a></span>
<span class="country"><a href="qzseach!toqzbycont.action?c_id=24"
	title="俄罗斯签证"><img src="seachqianzhen/image/Russia.png" alt="俄罗斯" />&nbsp;俄罗斯</a></span>
<span class="country"><a href="qzseach!toqzbycont.action?c_id=64"
	title="阿联酋签证"><img
	src="seachqianzhen/image/United-Arab-Emirates.png" alt="阿联酋" />&nbsp;阿联酋</a></span>
<span class="country"><a href="qzseach!toqzbycont.action?c_id=89"
	title="土耳其签证"><img src="seachqianzhen/image/Turkey.png" alt="土耳其" />&nbsp;土耳其</a></span>
<span class="country"><a href="qzseach!toqzbycont.action?c_id=44"
	title="埃及签证"><img src="seachqianzhen/image/Egypt.png" alt="埃及" />&nbsp;埃及</a></span>
<span class="country"><a href="qzseach!toqzbycont.action?c_id=94"
	title="印度签证"><img src="seachqianzhen/image/India.png" alt="印度" />&nbsp;印度</a></span>
<span class="country"><a href="qzseach!toqzbycont.action?c_id=86"
	title="泰国签证"><img src="seachqianzhen/image/Thailand.png" alt="泰国" />&nbsp;泰国</a></span>
<span class="country"><a href="qzseach!toqzbycont.action?c_id=77"
	title="马来西亚签证"><img src="seachqianzhen/image/Malaysia.png"
	alt="马来西亚" />&nbsp;马来西亚</a></span> <span class="country"><a
	href="qzseach!toqzbycont.action?c_id=92" title="新加坡签证"><img
	src="seachqianzhen/image/Singapore.png" alt="新加坡" />&nbsp;新加坡</a></span> <span
	class="country"><a href="qzseach!toqzbycont.action?c_id=93"
	title="越南签证"><img src="seachqianzhen/image/Vietnam.png" alt="越南" />&nbsp;越南</a></span>
<span class="country"><a href="qzseach!toqzbycont.action?c_id=83"
	title="柬埔寨签证"><img src="seachqianzhen/image/Cambodia.png" alt="柬埔寨" />&nbsp;柬埔寨</a></span>
<span class="country"><a href="qzseach!toqzbycont.action?c_id=85"
	title="斯里兰卡签证"><img src="seachqianzhen/image/Sri-Lanka.png"
	alt="斯里兰卡" />&nbsp;斯里兰卡</a></span> <span class="country"><a
	href="qzseach!toqzbycont.action?c_id=81" title="尼泊尔签证"><img
	src="seachqianzhen/image/Nepal.png" alt="尼泊尔" />&nbsp;尼泊尔</a></span></div>
...
<span class="country" ><a 
	...
	src="seachqianzhen/image/<ww:property value="param1" />.png" alt="<ww:property value="name" />" />&nbsp;<ww:property value="name" /></a></span> 
</ww:iterator>
	</div>
...
<div class="visa_ask"><span class="ask_title"> <span>签证问答</span>
</span>&nbsp;&nbsp;<span><a href="#">[全部]</a></span>
...
<ul>
	...
	<li class="show_ask_title"><a
		ellipsis" title="在校大学生需要提供存款证明吗？需要的话多少钱为佳？谢谢" target="_blank" href="#">问：在校大学生需要提供存款证明吗？需要的话多少钱为佳？谢谢</a></li>
	<li class="show_ask_rp">
	<p class="ellipsis">答：请问您是不是想问除了其他资产证明外，存款证明是不是必选材料？

	加拿大签证资产证明材料主要是半年的活期流水账单，根据您停留的天数不同余额要求也不一样，${dns.address}建议余额至少5万以上，流水账单是一项必选材料，固定资产（房，车...</p>
	</li>
</ul>
<ul>
...
<ul class="info_one">
	...
	<li><span>为什么找${dns.address}？</span></li>
...
<ul class="info_four">
	...
	<p>${dns.address}提供全国范围内的上门取件服务，您只需网上下单或拨打客服电话即有客服人员安排上门取件服务。</p>
...
<ul class="qq_group">
	...
	<li><a target="_blank" href="#" title="点击加入${dns.address}QQ客服群">${dns.address}QQ客服群</a></li>
...
<script charset="utf-8" type="text/javascript"
	src="seachqianzhen/js/jquery/jquery-1.7.1.min.js"></script>

<script charset="utf-8" type="text/javascript"
	src="seachqianzhen/js/jquery.tagsinput.min.js"></script>

<script charset="utf-8" type="text/javascript"
	src="seachqianzhen/js/jquery.textareaCounter.plugin.js"></script>

<script charset="utf-8" type="text/javascript"
	src="seachqianzhen/js/artDialog/4.1.7/jquery.artDialog.js?skin=pure"></script>

<script charset="utf-8" type="text/javascript"
	src="seachqianzhen/js/ailvxing.min.js"></script>

<script charset="utf-8" type="text/javascript"
	src="seachqianzhen/js/visa.js"></script>
