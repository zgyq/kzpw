...
<link rel="stylesheet" type="text/css" href="seachqianzhen/css/cube_min.css" />


<link rel="stylesheet" type="text/css"
	href="seachqianzhen/css/visa_content.css" />

<link rel="stylesheet" type="text/css" href="seachqianzhen/css/fancybox.css"
	media="screen" />
...
<ul class="one">
	...
	<li><img alt="<ww:property value="qzguojia.name"/>国旗" width="85px" height="85px"
		src="seachqianzhen/image/<ww:property value="qzguojia.param1"/>.png" /></li>
...
<dl class="two">
	...
	<dd><ww:property value="qzchanpininfo.smalltext.replace('爱旅行网', '${dns.address}')"/></dd>
...
<ul id="one">
	...
	<li><ww:property value="qzchanpininfo.feeinfo.replace('爱旅行网', '${dns.address}')"/></li>
...
<dl>
	...
	<dd>
	<div class="info fix" id="sub1"><img src="seachqianzhen/image/huzhao.jpg">
	<dl>
	...
	<div class="info fix" id="sub20"><img src="seachqianzhen/image/zhaopian.jpg">
	<dl>
	...
	<div class="info fix" id="sub3"><img src="seachqianzhen/image/shenfenzheng.jpg">
	<dl>
		<dt><span class="info_title">身份证复印件</span><span class="info_note"></span></dt>
		<dd>申请人有效身份证正反面复印件一份，尽可能的复印清晰些。</dd>
	</dl>
	</div>
	<div class="info fix" id="sub5"><img src="seachqianzhen/image/hukouben.jpg">
	<dl>
	...
	<div class="info fix" id="sub7"><img src="seachqianzhen/image/jiehunzheng.jpg">
	<dl>
	...
	<div class="info fix" id="sub166"><img src="seachqianzhen/image/huzhao.jpg">
	<dl>
		<dt><span class="info_title">个人资料表原件</span><span
			class="info_note"></span></dt>
		<dd>请在${dns.address}下载个人资料表并完整填写，此表格不会递交给使馆，将用于填写递交使馆的英文签证申请表，请申请人认真填写。</dd>
...
<dl>
	...
	<dd>
	<div class="info fix" id="sub28"><img src="seachqianzhen/image/huzhao.jpg">
	<dl>
	...
	<div class="info fix" id="sub42"><img src="seachqianzhen/image/huzhao.jpg">
	<dl>
	...
	<div class="info fix" id="sub40"><img src="seachqianzhen/image/huzhao.jpg">
	<dl>
	...
	<div class="info fix" id="sub41"><img src="seachqianzhen/image/huzhao.jpg">
	<dl>
	...
	<div class="info fix" id="sub37"><img
		src="seachqianzhen/image/xingshizheng.jpg">
	<dl>
	...
	<div class="info fix" id="sub33"><img src="seachqianzhen/image/huzhao.jpg">
	<dl>
...
<dl>
	...
	<dd>
	<div class="info fix" id="sub140"><img src="seachqianzhen/image/wenjian.jpg">
	<dl>
		<dt><span class="info_title">在职证明原件</span><span class="info_note"></span></dt>
		<dd>请在${dns.address}下载在职证明模板按照个人情况修改，需用公司正规的抬头纸打印，信中需要写明申请人的姓名、护照号码、任职时间、职位、每月收入总额、放假日期及逗留时间、公司地址、联系电话、传真号码。单位负责人证明信上签名并加盖公司公章。</dd>
		<dd class="downfile"><span>下载：</span>&nbsp;&nbsp;<a
	...
	<div class="info fix" id="sub61"><img
		src="seachqianzhen/image/shenfenzheng.jpg">
	<dl>
...
<dl>
	...
	<dl>
		<dt><span class="info_title">计划行程安排复印件</span><span
			class="info_note"></span></dt>
		<dd>请附中英文对照的计划行程安排，用以向签证官证明申请人的行程计划。${dns.address}可提供递交签证材料用的计划行程单。</dd>
	</dl>
	</div>
	<div class="info fix" id="sub57"><img src="seachqianzhen/image/huzhao.jpg">
	<dl>
		<dt><span class="info_title">机票预定单复印件复印件</span><span
			class="info_note"></span></dt>
		<dd>由机票代理或航空公司出具的往返机票预订单。${dns.address}可提供递交签证材料用的机票预订单。</dd>
	</dl>
	</div>
	<div class="info fix" id="sub53"><img src="seachqianzhen/image/zhaopian.jpg">
	<dl>
	...
	<div class="info fix" id="sub48"><img src="seachqianzhen/image/zhaopian.jpg">
	<dl>
...
<dl>
	<dt class="sub_title"><span class="dib">资产证明资料</span></dt>
	<dd>
	<div class="info fix" id="sub35"><img src="seachqianzhen/image/huzhao.jpg">
	<dl>
...
<dl>
	...
	<div class="info fix" id="sub79"><img src="seachqianzhen/image/huzhao.jpg">
	<dl>
...
<dl>
	<dt class="sub_title"><span class="dib">资产证明资料</span></dt>
	<dd>
	<div class="info fix" id="sub215"><img src="seachqianzhen/image/huzhao.jpg">
	<dl>
...
<dl>
	...
	<dl>
		<dt><span class="info_title">学生在校证明原件</span><span
			class="info_note"></span></dt>
		<dd>在${dns.address}下载在校证明模板修改，需注明班级、专业、假期，用学校抬头纸打印，请学校负责人亲笔签名并盖学校公章或教务章，此证明中文即可。</dd>
		<dd class="downfile"><span>下载：</span>&nbsp;&nbsp;<a
...
<dl>
	...
	<p>5.请您待拿到签证及护照后再出机票或与酒店确认付款，避免不必要的损失，${dns.address}不承担签证外其它费用。</p>
...
<div class="visa_seo">
<p>${dns.address}为您提供 ,加拿大旅游签证 ,加拿大探亲访友 ,加拿大商务签证 的签证办理服务！</p>
...
<script charset="utf-8" type="text/javascript"
	src="seachqianzhen/js/fancybox/jquery.fancybox.min.js"></script>

<script charset="utf-8" type="text/javascript" src="seachqianzhen/js/ailvxing.min.js"></script>

<script charset="utf-8" type="text/javascript" src="seachqianzhen/js/visa.js"></script>
