...
<link rel="stylesheet" type="text/css" href="seachqianzhen/css/visa_list.css" />

<link rel="stylesheet" type="text/css" href="seachqianzhen/css/ask_index.css" />

<link rel="stylesheet" type="text/css" href="seachqianzhen/css/index.css" />
...
<ul class="top_right">
	...
	<p><ww:property value="ListQzchanpininfo.get(0).smalltext.replace('爱旅行网', '${dns.address}')"/></p>
...
<ul id="one">
	...
	<li>
	<ww:property value="feeinfo.replace('爱旅行网', '${dns.address}')"/>
	</li>
</ul>
<ul id="two">
...
<ul id="three">
	<li><a href="qzseach!toqzinfo.action?c_qzinfoid=<ww:property value="id"/>"></a></li>
</ul>
</div>
</div>
</div>
...
<ul class="qq_group">
	...
	<li><a target="_blank" onfocus="this.blur()"
		href="#"
		title="点击加入${dns.address}QQ客服群">${dns.address}QQ客服群</a></li>
