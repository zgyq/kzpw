		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<table width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td height="28" align="right" valign="top"><span>乘机人：</span></td>
						<td>
						<table>
							...
							<tr>
							<td>
							<input type="checkbox" name="passid" require="true" dataType="Require" value="<ww:property value="id"/>"    />
							
							乘机人:<ww:property value="name"/>
							票号:<ww:property value="ticketnum"/>
							</td>
							</tr>
					...
					<!--<tr>
						<td height="28" align="right"><span>关联乘机人表ID：</span></td>
						<td><input type="text" require="true" dataType="Require"
							msg="关联乘机人表ID不能为空" name="passengerid"
							value='<ww:property value="scang.passengerid"/>'
					...
					<tr>
						...
						<td><input type="text" require="true" dataType="Require"
							...
							value='<ww:property value="getcangwei(orderinfo.id)"/>'
							" style="width: 350px" /></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" require="true" dataType="Require"
							...
							value='<ww:property value="gethangban(orderinfo.id)"/>'
							" style="width: 350px" /></td>
					</tr>
