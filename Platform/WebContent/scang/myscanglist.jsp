...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;我的升舱订单列表</span></b></td>
	</tr>
	<tr>
		<td valign="top">
        ...
        --></td>
									...
									<tbody>
										...
										<ww:iterator value="listScang">
											<tr id="<ww:property value="id"/>" align="center"
												...
												<td class="table_color">
												<ww:if test="status==7">
												<a href="orderinfo.action">去支付</a>
												</ww:if><ww:else>
												<a href="#">支付差价</a>
												</ww:else>
										 |
											<a href="orderinfo!toshow.action?id=<ww:property value="orderid" />">查看订单</a>		
			...
			<ww:property value="getPagination('\"orderinfo!tomyshengcang.action?s_orderstatus=23&pageinfo.pagenum=\"+pageno')"/>						
								</td>
							</tr>
						</table>
						</td>
