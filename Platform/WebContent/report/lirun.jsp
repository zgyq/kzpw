...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse">&nbsp;&nbsp;&nbsp;利润报表</b></td>
	</tr>
	<tr>
		<td valign="top">
		<form name="form1" id='form1' method="post"
			action="airreport!lirun.action"><input type="hidden"
			name="is_first" />
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
		...
		// 9=改签成功 10=改签失败 11已取消 12,13,14 -->
									...
									<tr class="font-blue-xi">
										<td height="58" colspan="10" align="center"><input
											...
											value="查&nbsp;&nbsp;询"
											onclick="document.form1.action='airreport!lirun.action';dispose('系统正在为您查询');document.form1.submit();" />
										<input type="button" class="button_d font-white"
											value="导出excel"
											onclick="document.form1.action='airreport!expLiRunExcel.action';expexcel();document.form1.submit();" /></td>
									</tr>
								</table>
								</td>
							</tr>
		...
		<ww:property
			value='getPagetwo(pageinfo,"pageinfo","airreport!lirun.action","form1")' />
		</div>
		</form>
