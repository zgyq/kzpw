...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
								...
								<table width="95%" border="0" align="center" cellpadding="0"
									...
									<tr class="font-blue-xi">
										<td height="58" colspan="10" align="center"><input
											...
											value="查&nbsp;&nbsp;询"
											onclick="document.form1.action='airreport!airticketrebatreport.action';dispose('系统正在为您查询');document.form1.submit();" />
								...
								<table id="menutable" width="99%" border="1" align="center"
									...
									<tbody>
										<tr class="tbody_color">
											...
											<!--  <th class="table_color" style="width: 80px">航空公司</th>-->
										...
										<ww:iterator value="listrebaterecord">
											<tr id="<ww:property value="id"/>" align="center"
												...
												<ww:property value="getAgentTypeName(AGENGJIBIE)"/>
												</td>
												<td class="table_color"><ww:property
												...
												<!--  <td class="table_color"><ww:property value="C_TICKETNUM" /></td>-->
												<td class="table_color"><ww:property
												...
												<td class="table_color"><ww:property
													value="cabincode" /></td>-->
												<td class="table_color"><ww:property value="C_TOTALTICKETPRICE" /></td>
												<!-- 单张票价 -->
												<td class="table_color"><ww:property
													value="DUTY" /></td>
											<ww:if test="#agentlevel==4">
											...
											<ww:if test="#agentlevel==4||#agentlevel==0||#agentlevel==1||#agentlevel==2||#agentlevel==3">
												<td class="table_color"><ww:property
													value="formatMoney(EREBAT)" /></td>
												<td class="table_color"><ww:property
													value="formatMoney(FREBAT)" /></td>
											</ww:if>
												<!-- <td class="table_color"><ww:property
													value="getPayMethodStr(C_PAYMETHOD)" /></td>
												<td class="table_color"><ww:property
													value="getFkmethodstr(C_FKMETHOD)" /></td>  -->
										...
										<ww:if test="listPassenger.size>0">
											<tr>
												<td class="table_color" colspan="3" style="text-align: left;">
		...
		<div style="text-align: center; width: 100%; padding-top: 10px;">
			  <ww:property value='getPagetwo(pageinfo,"pageinfo","airreport!airticketrebatreport.action","form1")' />
		   </div>
		</form>
