...
//	
	...
	var varThisObjAdd=(varThisObj.getAttributeNode("mod_address_suggest2")?varThisObj.getAttributeNode("mod_address_suggest2").value:"");
...
function WriteCity2(fctI){
	...
	$("#city_hotel_hide2").val(varMenuValue[0]);
	$("#txthotelcity2").val(varMenuValue[1]);
}
//隐藏城市列表
function _Hidden(e){
	e=e?e:event;
