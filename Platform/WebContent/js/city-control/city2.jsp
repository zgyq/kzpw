...
<body>
						<div id="city">
									...
									<div class="city-box"> 
									<ul id="mt5" class="">
								    <li class="f city-navon" id="sub21"><a href="#" onclick="sub2('1');">热门</a></li>
								    <li class="f city-nav" id="sub22"><a href="#" onclick="sub2('2');">A-F</a></li>
								   	<li class="f city-nav" id="sub23"><a href="#" onclick="sub2('3');">G-J</a></li>
								   	<li class="f city-nav" id="sub24"><a href="#" onclick="sub2('4');">K-N</a></li>
								    <li class="f city-nav" id="sub25"><a href="#" onclick="sub2('5');">P-W</a></li>
								    <li class="f city-nav" id="sub26"><a href="#" onclick="sub2('6');">X-Z</a></li>
								    ...
								    <!-- A-F -->
								    <div class="mt5 c" id="city22" style="display: none" >
								    <ul class="mt5">
								    ...
								    <!-- g-j -->
								    <div class="mt5 c" id="city23" style="display: none" >
								    <ul class="mt5">
								  	 <li class="f cityon" rel="1"><a href="#" onclick="lodvalue('广州','CAN');">广州</a></li>
								    ...
								    <!-- K-N -->
								    <div class="mt5 c" id="city24" style="display: none" >
								    <ul class="mt5">
								    ...
								    <li class="c nohave">&nbsp;</li>
								     ...
								     <!-- P-W -->
								    <div class="mt5 c" id="city25" style="display: none" >
								    <ul class="mt5">
								    ...
								    <li class="c nohave">&nbsp;</li>
								     ...
								     <!-- X-Z -->
								    <div class="mt5 c" id="city26" style="display: none" >
								    <ul class="mt5">
								  	<li class="f cityon" rel="1"><a href="#" onclick="lodvalue('郑州','CGO');">郑州</a></li>
...
$("#city2"+i).hide();
document.getElementById("sub2"+i).className="f city-nav";
}
$("#city2"+ty).show();
document.getElementById("sub2"+ty).className="f city-navon";    
}
