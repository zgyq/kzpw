...
function importExcel(tableid) {//整个表格拷贝到EXCEL中 
    ...
    //设置excel可见属性 
	try{
		var fname = oXL.Application.GetSaveAsFilename("航信TSL报表数据比对.xls", "Excel Spreadsheets (*.xls), *.xls");
		if(fname){
			oWB.SaveAs(fname);
		}
	}catch(e){
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;航信TSL数据比对</span></b></td>
	</tr>
	<tr>
		<td valign="top">
		<form name="form1" method="post" action="travelskyreport.action">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" 
			...
			<tr>
						...
						<table width="760" border="0" align="center" cellpadding="0"
									...
									<tr>
									  ...
									  <input
									    ...
									    <td width="64" height="40" align="right">打印机号：</td>
									    <td width="237"><span style="HEIGHT: 71px">
								      <input
											id="piaohao" style="WIDTH: 100px" name="s_printnumber"
											value="<ww:property value="s_printnumber"/>" /></span></td>
  </tr>
									...
									<tr>
										...
										<td width="262"><span style="HEIGHT: 71px"> 
			    <input
											id="startnum2" style="WIDTH: 100px" name="s_begintime"
											value="<ww:property value="s_begintime"/>"
											onfocus="WdatePicker({skin:'whyGreen'})" class="Wdate" />-<input
											id="startnum2" style="WIDTH: 100px" name="s_endtime"
								      ...
								      <td><span style="HEIGHT: 71px">
								          ...
								          <option value="1">显示所有票情况</option>
								          <option value="2">只显示出票情况</option>
								          <option value="3">只显示废票情况</option>
								          <option value="4">只显示退票情况</option>
								          </select>
								      </span></td>
									</tr>
									<tr><td width="197" height="30" align="right"></td><td colspan="3" style="color:red">提示：1.如果多个打票机请用英文逗号分隔,如（1,3,6）<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.按票号范围查询，请输入票号后10位数字</td></tr>
						...
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr>
								...
								<table id="tbtsl" width="94%" border="1" align="center"
									class="table_color">
									<tbody>
									    <tr class="tbody_color"><th colspan="7" class="table_color"><span style="font-size:15px;font-weight:bold;">航信(TravelSky)TSL数据</span></tr>
										<tr class="tbody_color">
											<th class="table_color">票号</th>
											<th class="table_color">城市对</th>
											<th class="table_color">票价</th>
											<th class="table_color">税费</th>
											<th class="table_color">扣率</th>
											<th class="table_color">订座记录编号</th>
											<th class="table_color">营业员工作号</th>
										</tr>

										<ww:iterator value="listTravelskyreport">
											<tr id="<ww:property value="id"/>" align="center"
												onmouseover="currentcolor=this.style.backgroundColor;this.className='colortrin',this.style.fontWeight='';"
												onmouseout="this.className='colortrout',this.style.fontWeight='';">

												<td class="table_color"><ww:property value="tktnumber" /></td>
												<td class="table_color"><ww:property value="origsest" /></td>
												<td class="table_color"><ww:property
													value="ticketprice" /></td>
												<td class="table_color"><ww:property value="taxs" /></td>
												<td class="table_color"><ww:property value="comm" /></td>
												<td class="table_color"><ww:property value="pnr" /></td>
												<td class="table_color"><ww:property value="agent" /></td>
											</tr>
										</ww:iterator>
									...
									<tbody>
										...
										<ww:iterator value="listPassenger">
											<tr id="<ww:property value="id"/>" align="center"
												...
												<td class="table_color"><ww:if test="ticketnum!=null && ticketnum.lenght>0"></ww:if><ww:property value="ticketnum" /><ww:else>未录入</ww:else></td>
				...
				<table class="book_pgcontent" id="tbresult" style="display:none" width="96%" border="0" cellpadding="0"
					cellspacing="0">
					<tr class="tbody_color">
						<td class="table_color_l" width="10%"><b>比对结果统计信息
						</td>
					</tr>
					<tr><td class="table_color_l" style="font-weight:bold;color:red">
						航信总票号数量：<span id="span_tb1"></span>个
						系统报表票号数量：<span id="span_tb2"></span>个
						相同票号数量：<span id="span_same"></span>个
						</b></td></tr>
