        ...
        items: [
		     
		    {
				...
				handler : function(item){
					window.location.href="infocontent!toadd.action?<ww:property value="url"/>";
			...
			,{  
				...
				handler : function(item){
						document.form1.action="infocontent!toedit.action?id="+selectId;
            ...
            },
			{
				...
				handler : function(item){
					Ext.MessageBox.show({title:'删除',width:300, msg:'确认删除吗？',buttons: Ext.MessageBox.YESNO,fn:function(btn){
						...
						if(btn=='yes')
						{
						document.form1.action="infocontent!delete.action?id="+selectId;
						document.form1.submit();
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="box">
  ...
  <tr>
    <td  valign="top">
<form name="form1" method="post" action="infocontent.action">
  ...
  <tr>
    <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<ww:iterator value="listInfocontent">
...
<td  class="table_color">
<ww:if test="typeid==9">导航</ww:if>
<ww:else>
<ww:property value="SubString(content,20)"/>...
</ww:else>
</td>
<td  class="table_color">
<ww:if test="typeid==1">酒店优惠信息</ww:if>
<ww:if test="typeid==2">机票优惠信息</ww:if>
<ww:if test="typeid==3">酒店攻略</ww:if>
<ww:if test="typeid==4">机票攻略</ww:if>
<ww:if test="typeid==5">酒店优惠服务</ww:if>
<ww:if test="typeid==6">机票优惠服务</ww:if>
<ww:if test="typeid==7">国际机票优惠服务</ww:if>
<ww:if test="typeid==8">国际机票攻略</ww:if>
<ww:if test="typeid==9">导航</ww:if>
...
<script language="JavaScript">
	function toadd(){
		window.location="infocontent!toadd.action?<ww:property value="url"/>";
	}
	function deleteItem(){
			...
			if(length== undefined){
				...
				if(document.form1.selectid.checked ==true)
				{
						...
						if(temp==true){
							...
							document.form1.action="infocontent!delete.action?id="+document.form1.selectid.value;
							document.form1.submit();
						}
						return;
				}
			  	 ...
			  	 if ( length == null || length==0 ){
					     ...
					     for (var i = 0; i < length; i++)
					      ...
					      if(len==1){
					      	var temp = confirm('确认删除吗？');
							if(temp==true){
								document.form1.action="infocontent!delete.action?id="+uvalue;
								document.form1.submit();
							}
							return;
					      }else if (len>1){
					      	var temp = confirm('确认删除吗？');
					      	if(temp==true){
					      		document.form1.action="infocontent!batch.action?opt=1";
								document.form1.submit();
							}
							return;
 ...
 function updateItem(){
			...
			if(length== undefined){
				...
				if(document.form1.selectid.checked ==true)
				{
						...
						document.form1.action="infocontent!toedit.action?id="+document.form1.selectid.value;
						document.form1.submit();
			  	 ...
			  	 if ( length == null || length==0 ){
					     ...
					     for (var i = 0; i < length; i++)
					      ...
					      if(len==1){
					      		document.form1.action="infocontent!toedit.action?id="+uvalue;
								document.form1.submit();
								return;
					      }else if (len>1){
