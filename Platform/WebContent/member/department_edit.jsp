...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			...
			test="department.id>0">编辑</ww:if><ww:else>新增</ww:else>部门</span></b></td>
	</tr>
	<tr>
		<td valign="top">
		<form
			action="department!<ww:if test="department.id>0">edit.action?id=<ww:property value="id"/>&<ww:property value="url"/></ww:if><ww:else>add.action?<ww:property value="url"/></ww:else>"
...
<input type="hidden" id="parentid" name="parentid" value='<ww:property value="department.parentid"/>'
					...
					<tr class="font-blue-xi">
						...
						<td height="46" scrolling="no"><input type="submit"
							...
							onclick="window.location.href='department.action?<ww:property value="url"/>';"
