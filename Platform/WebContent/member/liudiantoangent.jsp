...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td valign="top">
		<form
			action="liudianinfo!edittypeid.action"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<table width="60%" border="0" cellspacing="0" cellpadding="0">
									...
									<select id="agentid" name="s_agentid" style="width: 150px" onchange="lodagent();">
										<option value="-1">请选择加盟商</option>
										...
										<td align="left" width="30%" class="table_color_l">
										<select id="typeid" name="s_typeid" style="width: 150px" onchange="lod(2);">
											<option value="-1" id="-1" >请选择留点类型</option>
										<ww:iterator value="listsettle">
											
											<option value="<ww:property value="id" />" id="<ww:property value="id" />"  ><ww:property value="typename" /></option>
										</ww:iterator>
										</select></td>
									</tr>
								</table>
...
//alert("agentid=="+agentid);
	...
	if(agentid!='-1'){
      ...
      $.ajax({
	    type:"POST",
	    url:"liudianinfo!AjaxLodAgentSetType.action",
	    data:{ajax_agentid:agentid},
	    async:false,         
	    success:function(data){
	    ...
	    alert("该加盟商暂无匹配留点类型!");
	     ...
	     document.getElementById(data).selected="selected";
	     lod(2);
	     // document.getElementById("submit").disabled="";
	    }            
	    });
