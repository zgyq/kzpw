...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="box">
  <tr>
    <td width="100%" height="29" class="box-bottom bg"><b class="anse">&nbsp;&nbsp;&nbsp;添加供应商</b></td>
  </tr>
  <tr>
    <td  valign="top" ><!--
          ...
          <table border="0" width="100%" cellpadding="0" cellspacing="0">
           <tr>
                <td width="100%" height="29" background="../images/jb.gif" style="border-bottom: 1px solid #99CBED">
                    <span class="font-blue-cu" style="color: #194B66">&nbsp;&nbsp;&nbsp;添加供应商</span></td>
            </tr>
          </table>
        </div>
    </div>
    --><div >
        <div class="mnue">&nbsp;&nbsp;账号信息</div>
        <div class="mnue_nr" >
...
&nbsp;<select name="CityArrive$dropCity" id="CityArrive_dropCity" onchange="JavaScript:document.all.CityArrive_txtCity.value=this.value" style="width:119px;">
                        ...
                        <table  width="100%">
                            <tr>
                                <td>
									...
									<tr>
										<td class="ytd2" width="390">
                                                <textarea name="txtDictate" rows="2" cols="20" id="txtDictate" style="height:70px;width:360px;">/fzht/</textarea>
                                               
                                          </td>
                                          <td valign="middle" width="110">  <input type="button" class="button_d font-white"    value="选择业务员" onclick="searchOne()" /></td>
										
										<td>
										<table id="tab_ShareSalesOp" cellspacing="1" cellpadding="0" width="100%" style=" display:block;">
										<tr>
											<td class="ytd2">
										  ...
										  <td>
										   	...
										   	<td><input name="btnSaveAccredit" type="button" id="btnSaveAccredit" class="button font-red"  value="返回" onclick="ButtonSaveAccredit();" />
									         </td>
										</tr>
									</table>
										</td>
	...
	<option value="地级市">地级市</option>
           ...
           <div style="height:42px; padding-top:10px;" align="center">
    ...
    <div>
        ...
        <br />
        <ul>
            <li style="padding-left:20px;">· 默认为全部选择 即该帐户拥有所有权限</li>
            <li style="padding-left:20px;">· 点击模块选择框 该下属选择框 默认为相同状态</li>
            <li style="padding-left:20px;">· 没有选择的功能 将被视为该帐户禁止使用的功能 </li>
        </ul>
    </div>
</body>
</html>
