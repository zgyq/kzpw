...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;B2C政策返点设置</span></b></td>
	</tr>
	<tr>
		<td valign="top">
		<form
			action="settlementtype!add.action?id=<ww:property value="settlementtype.id"/>&<ww:property value="url"/>"
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<input type="hidden" name="typename"  value='B2C留点' />
					<input type="hidden" name="liudiantype"  value="1"   />
