...
<title><ww:if test="sysconfig.id>0">编辑</ww:if><ww:else>新增</ww:else>包机业务信息</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="box">
  <tr>
    <td width="100%" height="29" class="box-bottom bg"><b class="anse"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;编辑包机业务信息</span></b></td>
  </tr>
  <tr>
    <td  valign="top">
<form action="sysconfig!editaddress.action?id=<ww:property value="sysconfig.id"/>&<ww:property value="url"/>" name="form1" 
method="POST">
