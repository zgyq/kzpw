...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="box">
  <tr>
    <td width="100%" height="29" class="box-bottom bg"><b class="anse">&nbsp;&nbsp;&nbsp;会员来源列表</b></td>
  </tr>
  <tr>
    <td  valign="top">
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" style="font-size:12px;">
  ...
  <tr>
    <td width="184" height="30" align="right">会员来源：</td>
    <td width="198"><select name="caid2" style="WIDTH: 166px" ><option value="-1" selected="selected" >请选择！</option><option value="1"  >运营商</option><option value="0"  >分销商</option><option value="0"  >供应商</option></select></td>
            ...
            <table id="menutable" width="99%" border="1" align="center" class="table_color">
              <tbody>
                <tr class="tbody_color" >
                  ...
                  <th width="54" height="25" class="table_color"><input type="checkbox" name="all1" value="1" onclick="selectall1()" />全选</th>
...
<td class="table_color">分销商</td>
	</tr>
    <tr id="2" align="center"
                      onmouseover="currentcolor=this.style.backgroundColor;this.style.backgroundColor='#e2f4fe',this.style.fontWeight='';" 
                      onmouseout="this.style.backgroundColor=currentcolor,this.style.fontWeight='';">
	
<td><input type="checkbox" name="selectid" value="362" /></td>
<td>26</td>		
<td>供应商</td>
	</tr>
        <tr id="2" align="center"
