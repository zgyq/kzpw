        ...
        items: [
		    {
				...
				handler : function(item){
					window.location.href="customeragent!toaddbiuser.action?<ww:property value="url"/>";
            ...
            },
            {
				...
				handler : function(item){
					window.location.href="customeruser!toeditbiuser.action?id="+selectId;
  ...
  function updateItem(){
			...
			if(length== undefined){
				...
				if(document.form1.selectid.checked ==true)
				{
						...
						document.form1.action="customeruser!toeditbiuser.action?id="+document.form1.selectid.value;
						document.form1.submit();
			  	 ...
			  	 if ( length == null || length==0 ){
					     ...
					     for (var i = 0; i < length; i++)
					      ...
					      if(len==1){
					      		document.form1.action="customeruser!toeditbiuser.action?id="+uvalue;
								document.form1.submit();
								return;
					      }else if (len>1){
					      	var temp = confirm('只能选择一项进行操作？');
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			class="anse">&nbsp;&nbsp;&nbsp;大客户员工管理</b></td>
	</tr>
	<tr>
		<td valign="top">
		<form action="customeruser!tobiguser.action" name="form1" method="post">
		<table width="99%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<table border="0" cellpadding="0" cellspacing="0" width="98%"
					...
					<tr>
						<td align="right">
							<input type="button" class="button_z font-red" value="添加新员工" onclick="window.location.href='customeragent!toaddbiuser.action'" />
							...
							<!--<input type="button" class="button_h font-red" value="清除条件" onclick="searchOne()" />
			...
			<tr>
				<td height="43" align="center"><ww:property value="getPagination('\"customeruser!tobiguser.action?pageinfo.pagenum=\"+pageno')"/>	
					</td>
			</tr>
		</table>
		</form>
