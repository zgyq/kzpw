...
Ext.onReady(function(){ 
  var comboxWithTree = new Ext.form.ComboBox({  
	...
	var root = new Ext.tree.TreeNode({text:"<ww:property value="getangentname(customeruser.agentid)"/>",id:'-1'}) ;
	...
	membername = document.getElementById('membername');
		if(membername.value=="") {
			...
			if(membername.value.length >10){
				document.getElementById("membername2").innerHTML="*姓名长度不能超过10个字符";
				membername.focus();
			validate = false ;
			}else{
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="box">
  <tr>
    <td width="100%" height="29" class="box-bottom bg"><b class="anse">&nbsp;&nbsp;&nbsp;<ww:if test="customeruser.id>0">编辑</ww:if><ww:else>添加</ww:else>员工</b></td>
  </tr>
  <tr>
    <td  valign="top">
  <form name="form1" id="form1" method="post" action="customeruser!<ww:if test="customeruser.id>0">editusers.action?id=<ww:property value="id"/>&<ww:property value="url"/></ww:if><ww:else>adusers.action?<ww:property value="url"/></ww:else>">
			...
			<tr>
				...
				<table width="100%" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<input type="password" require="true" dataType="Require"
							msg="登陆密码不能为空" name="logpassword" id="logpassword" desc="密码" class="validate[length[6,15]"
	 ...
	 --></td>
					...
					<tr>
		                ...
		                <input type="hidden" id="parentid" name="deptid" value='<ww:property value="customeruser.deptid"/>'
						" style="width: 350px" />
						</td>
					</tr>
