						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<table width="95%" cellspacing="0" cellpadding="0" border="1" style="border-right: 1px solid #fff;border-left: 1px solid #fff;border-top: 1px solid #fff; border-collapse:collapse " >
									<tr>
										<!--<td width="3%">&nbsp;</td>-->
										<td colspan="2" align="left"><span style="color:red">(交易利润-平台交易费用=可分配的金额)</span></td>
									</tr>
									<tr>
										<td  width="10%" align="center">&nbsp;</td>
										<td  width="10%" align="center"><b>国际机票业务</b></td>
									...
									<tr id="tr_agenttypeid_4">
										<td  align="center"><b>平台返佣</b></td>
										<td  align="center"><input type="text" style="width:40px" id="txtrebate_4_1" value='<ww:property value="getrebatevalue(4,1,listRebaterule)" />' /></td>
										<!-- <td  align="center"><input type="text" style="width:40px" id="txtrebate_4_2" value='<ww:property value="getrebatevalue(4,2,listRebaterule)" />' /></td>-->
										<!-- <td  align="center"><input type="text" style="width:40px" id="txtrebate_4_3" value='<ww:property value="getrebatevalue(4,3,listRebaterule)" />' /></td>-->
										<!-- <td  align="center"><input type="text" style="width:40px" id="txtrebate_4_4" value='<ww:property value="getrebatevalue(4,4,listRebaterule)" />' /></td>-->
										<!-- <td  align="center"><input type="text" style="width:40px" id="txtrebate_4_6" value='<ww:property value="getrebatevalue(4,6,listRebaterule)" />' /></td>-->
										<!--  <td  align="center"><input type="text" style="width:40px" id="txtrebate_4_5" value='<ww:property value="getrebatevalue(4,5,listRebaterule)" />' /></td>-->
									</tr>
									...
									<!--<tr id="tr_agenttypeid_3">
										...
										<td  align="left">订单返佣：<input type="text" style="width:40px" id="txtrebate_3_2" value='<ww:property value="getrebatevalue(3,2,listRebaterule)" />' /><br />酒店返佣：<input type="text" style="width:40px" value="<ww:property value="s_jjrenrebate" />" id="txtjjrenrebate" name="s_jjrenrebate" /></td>
										<td  align="center"><input type="text" style="width:40px" id="txtrebate_3_3" value='<ww:property value="getrebatevalue(3,3,listRebaterule)" />' /></td>
										<td  align="center"><input type="text" style="width:40px" id="txtrebate_3_4" value='<ww:property value="getrebatevalue(3,4,listRebaterule)" />' /></td>
										<td  align="center"><input type="text" style="width:40px" id="txtrebate_3_5" value='<ww:property value="getrebatevalue(3,5,listRebaterule)" />' /></td>
									</tr>
									-->
									<tr id="tr_agenttypeid_5">
										<td  align="center"><b>会员返佣</b></td>
										<td  align="center"><input type="text" style="width:40px" id="txtrebate_5_1" value='<ww:property value="getrebatevalue(5,1,listRebaterule)" />' /></td>
										<!--<td  align="center"><input type="text" style="width:40px" id="txtrebate_5_2" value='<ww:property value="getrebatevalue(5,2,listRebaterule)" />' /></td>-->
										<!--<td  align="center"><input type="text" style="width:40px" id="txtrebate_5_3" value='<ww:property value="getrebatevalue(5,3,listRebaterule)" />' /></td>-->
										<!--<td  align="center"><input type="text" style="width:40px" id="txtrebate_5_4" value='<ww:property value="getrebatevalue(5,4,listRebaterule)" />' /></td>-->
										<!--<td  align="center"><input type="text" style="width:40px" id="txtrebate_5_5" value='<ww:property value="getrebatevalue(5,5,listRebaterule)" />' /></td>-->
										<!--<td  align="center"><input type="text" style="width:40px" id="txtrebate_5_6" value='<ww:property value="getrebatevalue(5,6,listRebaterule)" />' /></td>-->
									</tr>
