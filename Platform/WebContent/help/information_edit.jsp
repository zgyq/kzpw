...
<title><ww:if test="information
		.id>0">编辑</ww:if><ww:else>新增</ww:else>资讯中心
</title>
...
Ext.onReady(function(){
  ...
  var comboxWithTree = new Ext.form.ComboBox({  
	...
	var tree = new Ext.tree.TreePanel({  
		...
		comboxWithTree.setValue("<ww:property value="getInformationName(information.parentid)"/>");
...
<form
	action="information
		!<ww:if test="information
		.id>0">edit.action?id=<ww:property value="information
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			...
			test="information
		.id>0">编辑</ww:if><ww:else>新增</ww:else>资讯中心 </span></b></td>
	</tr>
	<td align="center">
	<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<input type="text" name="name
						" id="name"
						value='<ww:property value="information.name"/>'
						" style="width: 300px" /></td>
					<td width="5%" height="30" style="text-align: right;"
						class="table_color colortrin">状态 :<span style="color: red;">*</span>
					</td>
					<td width="10%" height="30" class="table_color_l" align="left">
					<ww:if test="information.id>0">
						<input type="radio" name="state" value="1"
							<ww:if test="information.state==1">checked</ww:if> />启用
				<input type="radio" name="state" value="0"
							<ww:if test="information.state==0">checked</ww:if> />禁用
				</ww:if><ww:else>
				...
				<td width="10%" height="30" align="left" class="table_color_l">
					<input type="text"  name="memberid
						" value='<ww:property value="information.memberid"/>'" style="width: 300px" />
				</td> 
				</tr> -->
				<tr>
					<td width="5%" height="30" style="text-align: right;"
					...
					<!--<input type="text"  name="parentid
						" value='<ww:property value="information.parentid"/>'" style="width: 300px" />  -->
					<div id='comboxWithTree'></div>

					<input type="hidden" id="parentid" name="parentid"
						value='<ww:property value="information.parentid"/>' /></td>



					<td width="5%" height="30" style="text-align: right;"
						class="table_color colortrin">是否主推： :<span
						style="color: red;">*</span></td>
					<td width="10%" height="30" class="table_color_l" align="left">
					<!--<input type="text"  name="parentstr
						" value='<ww:property value="information.parentstr
						"/>'" style="width: 300px" />  --> <input type="radio"
						name="iswebs" value="1" />是 <input type="radio" name="iswebs"
				...
				<tr>
					<td colspan="4" height="40" bgcolor="ffffff"><input
						...
						onclick="window.location.href='information.action?<ww:property value="url"/>';"
