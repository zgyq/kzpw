...
<script type="text/javascript" language="javascript">
        ...
        function CheckData()
        {
			...
			var DateNow=myDate.getFullYear()+"-"+month+'-'+myDate.getDate();
			var daysnum=365;
            ...
            if($("#arrcity").val()=="" || $("#city2").val()=="" ||$("#tocity").val()=="中文/拼音"|| $("#txtStartDate").val()==""||$("#arrcity").val()=="中文/拼音"||$("#city2").val()=="中文/拼音")//中文/拼音
            {
                alert("其中 * 号信息为必填信息,请检查后重新填写！");
                return false;
            }
            else if(!DateDiff(DateNow,$("#txtStartDate").val(),daysnum))
            { 
...
function DateDiff(sDate1, sDate2,days)    
{ 
    ...
    if(parseInt(iDays)>parseInt(days))
    {
       return false;   
    } 
    return true;
...
<%
   ...
   Calendar  c1=new  GregorianCalendar();//新建日期对象  
   Calendar  c2=new  GregorianCalendar();//新建日期对象  
   ...
   if(month<=3)
   {
	   strMaxDate=year+"-"+c2.get(Calendar.MONTH)+"-"+"30";
   }
   else if(month>=4 && month<=7)
   {
	   strMaxDate=year+"-10-"+"31";
   }
   ...
   {
	   strMaxDate=c1.get(Calendar.YEAR)+"-03-"+"31";
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<table width="760" border="1" align="center" cellpadding="0"
							...
							<tr class="font-blue-xi">
								...
								<td width="198" align="left"><input style="border: 1px solid #999999;height:20px; line-height:20px;" type="text"
									name="StartAirPortName" id="arrcity" value="西安咸阳" onfocus="if(this.value='西安咸阳'){this.value='';}" onblur="if(this.value=='') {this.value='西安咸阳';}"/>&nbsp;<span
									style="color: red">*</span>
								<div id='suggest' class="ac_results"></div>
								<input type="hidden" id="city_from_hide" value="XIY" name="StartAirportCode" />
								</td>
					...
					<tr>
						<td align="center"><input type="submit"
							...
							value="查&nbsp;&nbsp;询" />&nbsp;&nbsp;<input type="button" onclick="javascript:window.location.href='login!getMemberByOrder.action'"
							style="background: url(images/hout3.gif); cursor: hand; width: 98px; height: 31px; border: none; color: #FFF; font-weight: bold;"
							value="PNR导入" /></td>
					</tr>
					<tr>
