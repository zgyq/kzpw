...
<frameset rows="97,*,22" cols="*" frameborder="no" border="0" framespacing="0">
  <!-- top  -->
  <frame src="login!topmenu.action" name="topFrame" scrolling="no" noresize="noresize" id="topFrame"  />
  <!-- middle -->
  <frameset rows="*" cols="202,6,*" framespacing="0" frameborder="0" border="false" id="mainFrame" scrolling="no">
  <frame name="left" scrolling="no" frameborder="0" marginwidth="0" marginheight="0" src="customeruser!leftmenu.action?rightid=-1&forward=left.jsp">
