...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><b
			...
			test="airdelayprove
		.id>0">编辑</ww:if><ww:else>新增</ww:else>航班延误证明 </span></b></td>
	</tr>
		...
		<tr>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr style="display: none;">
					...
					<input type="text" name="airnum
						"
						value='<ww:property value="airdelayprove.airnum"/>'
						" style="width: 300px" /></td>

					<td width="5%" height="30" style="text-align: right;"
						class="table_color colortrin">PNR信息 :<span
						style="color: red;">*</span></td>
					<td width="10%" height="30" align="left" class="table_color_l">
					<input type="text" name="pnr
						"
						value='<ww:property value="airdelayprove.pnr"/>'
						" style="width: 300px" /></td>
				...
				<tr>
					...
					<!--<td width="5%" height="30" style="text-align: right;"
						class="table_color colortrin">起飞时间 :<span style="color: red;">*</span>
					</td>
					<td width="10%" height="30" class="table_color_l " align="left">
					<input type="text" name="stime
						"
						value='<ww:property value="airdelayprove.stime
						"/>'
						" style="width: 300px" class="Wdate two" onclick="WdatePicker()" />
					</td>

					-->
					
					<td width="5%" height="30" style="text-align: right;"
						class="table_color colortrin">上传附件:</td>
					<td width="10%" height="30" class="table_color_l" colspan="3" align="left">
				...
				<tr>
					<td width="5%" height="30" style="text-align: right;"
						class="table_color colortrin">航班延误信息 :<span
						style="color: red;">*</span></td>
					<td width="10%" height="30" align="left" class="table_color_l"
						colspan="3"><textarea rows="10" cols="60" name="descinfo"><ww:property
						value="airdelayprove.descinfo" /></textarea></td>
				...
				<tr>
					...
					<td width="10%" height="30" align="left" class="table_color_l"
						colspan="3"><textarea rows="10" cols="60" name="remark"><ww:property
						value="airdelayprove.remark" /></textarea></td>
			...
			-->
				<tr>
					<td colspan="4" height="40" bgcolor="ffffff"><input
						...
						onclick="window.location.href='airdelayprove.action?<ww:property value="url"/>';"
