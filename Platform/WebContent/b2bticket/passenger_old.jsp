      ...
      <tr>
		...
		<ww:iterator value="listCustPassenger">
	      <tr id="<ww:property value="id"/>" align="center"
			...
			<td  class="table_color color_b3" style="width:150px"><a href="javascript:parent.grefresh('<ww:property value="c_index"/>','<ww:property value="username"/>','<ww:property value="type"/>','<ww:property value="getnumtypebyid(id)"/>','<ww:property value="getnumbyid(id)"/>');"><ww:property value="username"/></a></td>
