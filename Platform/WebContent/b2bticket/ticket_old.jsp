						...
						<table width="760" border="1" align="center" cellpadding="0" bordercolor="#b3b3b3"
							...
							<tr class="font-blue-xi">
								...
								<td width="260" align="left"><input type="text"
									name="StartAirPortName" style="border: 1px solid #999999; height: 20px; line-height: 20px;" id="arrcity" value="北京" onfocus="if(this.value='北京'){this.value='';}hideddl();" onblur="if(this.value=='') {this.value='北京';};showddl();"/>&nbsp;<span
