...
<script>
	...
	var gwin;
	function grefresh(index,username,usertype,idtype,idnum,mobile){
...
<div class="quan" style="text-align: left"><span
	class="lan14_cu f">选择机票政策<ww:property value="xcdPlat"/></span> <span class="r"> <b
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"
	...
	<tr style="line-height: 25px; text-align: center;">
		...
		<td style="text-align: left;"><img src="images/plane1.gif"
			...
			value="flightOne.StartAirportName" /></span><span style="color: red">(<ww:property value="segmentOne.borderpointat"/>)</span><br />
		<img src="images/plane2.gif" width="25" height="25" /><span><font
			style="margin: 0 1px 0 2px; line-height: 25px;"><ww:property
			value="formatTimestampHHmm(segmentOne.arrivaltime)" /></font><ww:property
			value="flightOne.EndAirportName" /></span><span style="color: red">(<ww:property value="segmentOne.offpointat"/>)</span></td>
	...
	无返点
		...
		<td><span><b class="huang14_c" style="line-height: 16px;">￥<span
			id="span_segmentinf_priceone"><ww:property
			value="formatMoney(segmentOne.parvalue+segmentOne.fuelfee+segmentOne.airportfee)" /></span></b>(成人)</span><br />

		</td>
		<td><span><b class="huang14_c" style="line-height: 16px;">￥<span
			id="span_segmentinf_totalpriceone"><ww:property
			value="formatMoney(segmentOne.price+segmentOne.fuelfee+segmentOne.airportfee)" /></span></b>(成人)</span><br />
<a
									onmouseover="showDiag('diag_rule_<ww:property value="#state.index"/>_<ww:property value="#cabState.index"/>','block')"
...
<table width="100%" id="zrate1_1" style="display: block;">
	...
	<tr>
		<td align="left"><input type="button" value="普通政策信息" onclick="getthereate(0,1);"
			style="background: url(images/ddda.gif); width: 151px; height: 31px; line-height: 31px; border: none; color: #fff; cursor: pointer;"
			 />&nbsp;
			<input onclick="gettheratesep(0,2,1);"
	type="button" value="特殊政策信息" style=" background: url(images/addd.gif); width:200px;height:31px; line-height:31px; border:none; cursor: pointer;" />
	...
	<tr><td align="left"><font color="red">
			 ...
			 <b>特殊政策</b>不支持婴儿票，在选择特殊政策时请确认乘客没有携带婴儿！<br />
			 <b>特殊政策</b>请您在起飞日期前3～4天预订，否则有可能无法出票！
			</font></td></tr>
</table>
...
<ww:if
	...
	<div
        ...
        <!--
         ...
         -->
         <ww:property value="getCitynameByAirport(segmentTwo.startairport)" /> 
         &nbsp;→&nbsp; 
         <!--  <ww:property value="getCitynameByAirport(flightOne.StartAirport)" /> -->
         <ww:property value="getCitynameByAirport(segmentTwo.endairport)" />
...
--><div style="height: 10px; line-height: 10px;">&nbsp;</div>
	<table border="0" cellpadding="0" width="100%" cellspacing="0"
		...
		<tr style="line-height: 25px; text-align: center;">
			...
			<td style="text-align: left;"><img src="images/plane1.gif"
				...
				value="flightTwo.StartAirportName" /></span><span style="color: red">(<ww:property value="segmentTwo.borderpointat"/>)</span><br />
			<img src="images/plane2.gif" width="25" height="25" /><span><font
				style="margin: 0 1px 0 2px; line-height: 25px;"><ww:property
				value="formatTimestampHHmm(segmentTwo.arrivaltime)" /></font><ww:property
				value="flightTwo.EndAirportName" /></span><span style="color: red">(<ww:property value="segmentTwo.offpointat"/>)</span></td>
			<td style="font-size: 14px; line-height: 40px;"><ww:if
	...
	无返点
			...
			<td><span><b class="huang14_c" style="line-height: 16px;">￥<span
				id="span_segmentinf_pricetwo"><ww:property
				value="formatMoney(segmentTwo.parvalue+segmentTwo.airportfee+segmentTwo.fuelfee)" /></span></b>(成人)</span><br />
			</td>
			<td><span><b class="huang14_c" style="line-height: 16px;">￥<span
				id="span_segmentinf_totalpricetwo"><ww:property
				value="formatMoney(segmentTwo.Price+segmentTwo.airportfee+segmentTwo.fuelfee)" /></span></b>(成人)</span><br />
			<a
									onmouseover="showDiag('diag_rule_<ww:property value="#state.index"/>_<ww:property value="#cabState.index"/>','block')"
									onmouseout="showDiag('diag_rule_<ww:property value="#state.index"/>_<ww:property value="#cabState.index"/>','none')"
									style="border-bottom: 1px dashed #06f; color: #06f;" href="#">退改签规定</a>
	...
	<table width="100%" id="zrate3_1" style="display: block;">
		...
		<tr>
			...
			<input onclick="gettheratesep(0,2,2);"
	type="button" value="特殊政策信息" style=" background: url(images/addd.gif); width:200px;height:31px; line-height:31px; border:none;" />
...
<font color="red">提示：生日项为南航儿童订座必填项,非南航儿童可以不填。(儿童年龄范围2岁～未满12周岁),儿童票不匹配返点!</font>
</div>
<div style="display: none;"><span style="padding-left: 1%;"> 常用登机人：<span
...
<div class="box"
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td align="left" width="140" style=" height: 36px;">&nbsp;姓名：<input title="如有繁体字和生僻字,请全部用拼音代替,格式如:zhang/san"
				name="h_name" style="width: 80px" desc="姓名"
				id="a<ww:property value="#state.index"/>" type="text" />
				
				<a href="javascript:opendg(0);"><font
				color="red">*常用旅客</font></a>
			...
			证件类型： <select name="h_idtype" style="width: 80px"
				...
				<span	id="showtishi<ww:property value="#state.index"/>"> </span> </span> 
		...
		<tr>
			...
			<input type="radio" id="rdobaoxian2" 
				name='bxinsurance<ww:property value="#state.index"/>' value="2"  checked="checked" 
			...
			<td> <span id="span_birthday<ww:property value="#state.index"/>" style="display:none">出生日期：</span>
				<span id="span_birthdaytext<ww:property value="#state.index"/>" style="display:none">
				<input name="h_birthday" class="Wdate" id="birthday<ww:property value="#state.index"/>" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',maxDate:'{%y-2}-%M-%d',minDate:'{%y-120}-%M-%d'})"	desc="出生日期" type="text" /></span></td>
...
<div class="quan"><font class="lan14_cu">选择保险种类</font></div>
<table width="100%" border="1" cellpadding="0" cellspacing="0"
	...
	<table>
		<tr>
		<td style="height: 26px;  background-color: #EDFFED; text-align: center;">保险种类：</td>
		<td>
		<select id='bxtype' name="bxtype"
						style="width: 150px"
						onchange='changebxtype()'>
						
						<option  value="<ww:property value="#session.INSURPRICE2"/>">20元保险--成本价<ww:property value="#session.INSURPRICE2"/>元</option>
						<option value="<ww:property value="#session.INSURPRICE"/>">30元保险--成本价<ww:property value="#session.INSURPRICE"/>元</option>
					</select>
		</td>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0"
	...
	<table>
		<tr>
		<td style="height: 26px;  background-color: #EDFFED; text-align: center;">旅客手机号：</td>
		<td><input type="text" name="s_contactmobile" id="txtcontactmobile" /><font
				color="red">*</font></td>
		<td style="height: 26px;  background-color: #EDFFED; text-align: center;">旅客邮箱：</td>
		<td><input type="text" name="s_txtcontactemail" id="s_txtcontactemail" /></td>
		<td style="height: 26px;  background-color: #EDFFED; text-align: center;">采购商手机号：</td>
		<td><input type="text" name="s_txtcaigoumobile" id="s_txtcaigoumobile" value="<ww:property value="getLoginAgent().agentphone"/>" /></td>
		</tr>
	...
	<tr>
		...
		行程单：</td>
		<td>
			<input type="radio" id="xcdmethod" name="xcdmethod" value="0" onclick="isxcd(0);"
				checked="checked" />不要行程单
					    &nbsp;&nbsp;
					    <input type="radio" id="xcdmethod" name="xcdmethod"  onclick="isxcd(1);"
				value="1">需要行程单</input>
					    &nbsp;&nbsp;<font color="red">温馨提示：代打行程单需要一定费用</font>
		</td>
	</tr>
	<tr id="peisong" style="display: none">
		...
		配送方式：</td>
		<td>
			<input type="radio" id="peisongmethod1" name="peisongmethod" value="0" onclick="ispeisong(0);"
				checked="checked" />不要配送
					    &nbsp;&nbsp;
					    <input type="radio" id="peisongmethod1" name="peisongmethod"  onclick="ispeisong(1);"
				value="1">需要配送</input>
					    &nbsp;&nbsp;<font color="red">温馨提示：快递配送需要一定费用</font>
		</td>
	</tr>
	<tr id="peisongaddress" style="display: none" >
		...
		<td >
			<table>
			<tr>
			<td>&nbsp;收件人:<input type="text" id="lianxiname" desc="收件人" name="lianxiname" style="width: 130px;" /></td>
			</tr>
			<tr>
			<td>联系电话:<input type="text" id="lianxitel" desc="联系电话" name="lianxitel" style="width: 130px;" /></td>
			</tr>
			<tr>
			<td>邮政编码:<input type="text" id="youzhengbianma" desc="邮政编码" name="youzhengbianma" style="width: 130px;" /></td>
			</tr>
			<tr>
			<td>配送地址:<input type="text" id="peisongdizhi" desc="配送地址" name="peisongdizhi" style="width: 400px;" /></td>
			</tr>
			</table>
	...
	<tr>
		...
		计算方式：</td>
		<td style="line-height: 25px;">&nbsp;订单票面价小计 * 人数 + 平台交易费+保险份数x<ww:property value="#session.INSURPRICE"/>
		= 支付总金额<br />
		<!--+ 行程单总费用--> &nbsp;<span style="color: #BF2800"><span
			id="CalLab"></span>元</span></td>
	</tr>
	<tr>
		<td
...
<input type="text" name="allpassnum" id="allpassnum" value="" />
...
<script language="javascript">
	...
	function changezjhm(isd)
	{
		...
		if(zjid==3){//婴儿
		    $("#d"+isd).removeClass("validate[required]");
	        document.getElementById("d"+isd).className="validate[required]";	
			document.getElementById("zjlx"+isd).style.display="none";
			document.getElementById("zjhm"+isd).innerHTML="出生日期";
			$("#d"+isd).addClass("Wdate");
 ...
 function selectadd(username,type,idtype,idnumber,id){
		//var check = document.getElementById("u"+id).checked;
					var allpassnum=document.getElementById("allpassnum").value;
if(parseInt(allpassnum)>=3){
 alert("对不起！最多只能添加3个乘机人！如有多人可分开预订!!");
 document.getElementById("u"+id).checked=false;

			return;
}

			var allpassnum2=document.getElementById("ying").value;
if(parseInt(allpassnum2)>=3){
 alert("对不起！最多只能添加3个乘机人！如有多人可分开预订!!");
 document.getElementById("u"+id).checked=false;
...
<ww:if test="segmentTwo!=null&segmentTwo.flightnumber!=null&&segmentTwo.flightnumber.length()>0">
twoaircompcode='<ww:property value="segmentTwo.aircomapnycode" />';
</ww:if>
<ww:if test="segmentOne!=null&segmentOne.flightnumber!=null&&segmentOne.flightnumber.length()>0">
twoaircompcode='<ww:property value="segmentOne.aircomapnycode" />';
</ww:if>

 //添加
 function add(){
 if(jdnum>0&&(oneaircompcode=='JD'||twoaircompcode=='JD')){
  ...
  var passgerstr=0;
	...
	if(suntotal!=0){
  	...
  	jdnum++; 
  	document.getElementById("allpassnum").value=jdnum;
 }
 //删除
 function del(state){
...
function jisuanjiage(){
	...
	zongjia=zongjia+parseInt(sumbaoxian)*bxpr;
	zongjia=zongjia+ptPrice;
	//加行程单费 xcdmethod
	
	var xcdvalue=GetRadioValue("xcdmethod");
	//alert(xcdvalue);
	if(xcdvalue=='1'){
	zongjia=zongjia+parseInt(cxdprice)*(parseInt(chengren)+parseInt(ertong)+parseInt(yinger));
	}
	var peisvalue=GetRadioValue("peisongmethod");
	//alert(peisvalue);
	//加配送费  peisongmethod
	if(peisvalue=='1'){
	zongjia=zongjia+parseInt(peisprice);
	}
	...
	CalLab.innerHTML=Math.round((parseFloat(danchengren)*parseInt(chengren)+parseFloat(ertongprice1+childFuelSingle1+ertongprice2+childFuelSingle2)*parseInt(ertong)+(Math.round(yingerprice1* 100) / 100)*yinger)*100)/100 +"+ "+ptPrice+" + "+sumbaoxian+" x "+bxpr+"元 = "+Math.round(zongjia*100)/100;
...
//行程单和配送相关信息
 var isxcd= GetRadioValue('xcdmethod');//是否需要行程单
 var ispeisong= GetRadioValue('peisongmethod');//是否配送
 var lianxiname=$("#lianxiname").val();//配送联系人
 var lianxitel=$("#lianxitel").val();//配送联系电话
 var youzhengbianma=$("#youzhengbianma").val();//配送邮政编码
 var peisongadd=$("#peisongdizhi").val();//配送具体地址
 //alert(isxcd+","+ispeisong+","+peisongadd);
 //return;
 var s_txtcontactemail=$("#s_txtcontactemail").val();//旅客邮箱
 var s_txtcaigoumobile=$("#s_txtcaigoumobile").val();//采购商联系电话
 ...
 $.post("b2bticketorder!toaddorder.action",{zrate_one: zrate_one,bxcount:bxcount, zrate_two:zrate_two,h_name:h_name,h_ptype:h_type,h_idtype:h_idtype,h_idnumber:h_idnumber,s_paymethod:s_paymethod,s_zonglirun:varzonglirun,s_zonglirun2:varzonglirun2,s_contactmobile:varmobile,issavepassenger:h_issave,h_birthday:h_birthday,s_adultpnr: varadultpnr,isxcd:isxcd,ispeisong:ispeisong,lianxiname:lianxiname,lianxitel:lianxitel,youzhengbianma:youzhengbianma,peisongadd:peisongadd,s_txtcontactemail:s_txtcontactemail,s_txtcaigoumobile:s_txtcaigoumobile},function(data){
    if(data=="NOPNR")
    {
    	colsedispose();
        ...
        colsedispose();
    	alert("该舱位没有符合的运价,请选择其他舱位进行预订!");
    	document.getElementById("submitbutton").disabled="";
    }else if(data=="NAMEERR"){
        colsedispose();
    	alert("乘机人名字可能包含生僻字或者繁体字!请用拼音代替!或者联系客服协助你输入正确的格式!!!");
    	document.getElementById("submitbutton").disabled="";
    }else{
 ...
 function showInsurance(yn,id){
    if(yn==1){
      $("#bxtable"+id).show();
      $("#span_birthday"+id).show();	 
	  $("#span_birthdaytext"+id).show();	
      
    }else{
    $("#bxtable"+id).hide();
     	 var zjid=document.getElementById("b"+id).value;
     	// alert(zjid);
      	if(zjid==1){
	    $("#span_birthday"+id).hide();	 
		$("#span_birthdaytext"+id).hide();	
		}
    }
...
//<ww:if test="getLoginsessionagent().bigtype==2">
 ...
 if(ind=='0'){//不要配送
   document.getElementById("lianxiname").className="";
    document.getElementById("lianxitel").className="";
    document.getElementById("youzhengbianma").className="";
    document.getElementById("peisongdizhi").className="";
     $.validationEngine.closePrompt(".formError",true); 
 $("#peisongaddress").hide();
 }
 if(ind=='1'){//需要配送
  $("#peisongaddress").show();
   ...
   document.getElementById("lianxiname").className="validate[required]";
    document.getElementById("lianxitel").className="validate[required]";
    
    document.getElementById("youzhengbianma").className="validate[required]";
    document.getElementById("peisongdizhi").className="validate[required]";
...
function changebxtype(){
  ...
  $.ajax({
            type:"POST",
            url:"login!updatebaoxian_seiss.action",
            data:{c_baoxianprice:bxpr},
            success:function(data){
