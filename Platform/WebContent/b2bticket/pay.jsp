...
paytype==3：财付通
 ...
 function submitform(paymethod,paytype){
    if("vmoney"==paymethod){
      ...
      var url='http://122.0.66.157:8080/interface/Alipayfen?';
         ...
         <!--zhifubao网上银行-->
           ...
           <!--块钱-->
              <div class="boxnei" id='bill' >
               ...
               <div class="nohave">&nbsp;</div>
               <div class="paybnt">
               <ww:if test="GetOrderZrateAgentid(#request.ordermap.orderid)==1"><!-- 第三方 -->
               <input type="button" onclick="submitform('directPay',1);" class="bnt_pay" value="" /> 
