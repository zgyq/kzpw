...
<table width="100%" border="1" cellpadding="0 " ccellspacing="0"
	...
	<tr>
		...
		<td><ww:property value="formatMoney(orderinfo.totalticketprice+orderinfo.rebatemoney)" /></td>
...
<table width="90%" border="1" cellpadding="0 " ccellspacing="0"
	...
	<tr>
		<td style="font-size: 18px;color:red;  font-weight:bold" align="right">平台支付费：<ww:property value="orderinfo.currplatfee"/>&nbsp;&nbsp;应付金额：
		<ww:property value="formatMoney(#tatalorderprice+converNull(orderinfo.currplatfee,0))"/>
		元&nbsp;&nbsp;<input type="hidden" id="txttotalprice" value="<ww:property value="#tatalorderprice+converNull(orderinfo.currplatfee,0)"/>" /></td>
	</tr>
	</tbody>
</table>
<!-- 分销商支付 -->
<ww:if test="getLoginsessionagent().agenttype!=1&&orderinfo.orderstatus!=27">

<ww:include page="../newpay2.jsp"/>
</ww:if>
</body>
</html>
<script>
