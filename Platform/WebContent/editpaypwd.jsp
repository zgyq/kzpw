...
var strval=$("#pass"+id).val();
      ...
      $("#vpass"+id).html("");
      if(id==1){
         jQuery.post("customeruser!ajaxIsRrigthPassword_pay.action",{clientpwd:strval},function(data){
            if(data!="true"){
...
vpass(1);vpass(2);vpass(3);
  ...
  var strval=$("#pass2").val();
    jQuery.post("customeruser!ajaxUpdatepassword_pay.action",{newpassword:strval},function(){
             alert("支付密码修改成功！");   
            // $("#divPass").dialog("close");
             parent.closetab();        
         });      
