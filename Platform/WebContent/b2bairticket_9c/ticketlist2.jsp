                         ...
                         <table  cellspacing="0" cellpadding="1" align="center" style="width:100%">
                                    ...
                                    <tr>
                                         ...
                                         <td> 出发站：<input type="text" style="width:50%" name="s_depcityname"  id="txtStartCity" value="<ww:property value="s_depcityname" />"
											...
											<input type="text" name="s_depcitycode" id="hidStarCityCode" value="<ww:property value="s_depcitycode" />">
										...
										<input type="text" value="<ww:property value="s_arrcitycode" />" name="s_arrcitycode" id="hidEndCityCode">
										</td>
