...
<ul>
	...
	<li class="timesg pointer" onclick="sortflightlist(&#39;timeasc&#39;)">时间</li>
	<li class="xianshi pointer"
		onclick="toggle(&#39;lishowZrateSelect&#39;)">显示设置</li>
	<li style="position: relative" id="lishowZrateSelect" class="none">
	<div class="xianshinr" style="left: -103px; top: 24px;">
	<dl>
		<a href="javascript:void(0)" onclick="showzrate1(0)">显示</a>
	</dl>
	<dl>
		<a href="javascript:void(0)" onclick="showzrate1(1)">不显示</a>
	</dl>
	</div>
	</li>
</ul>
		...
		<tbody id="divlowprice_<ww:property value="#state.index" />">
			...
			<tr>
				...
				<a id="a_rules_0" class="font3797f1" href="javascript:void(0)"
					...
					onclick="showrules(&#39;MU&#39;,&#39;F&#39;,&#39;0&#39;,&#39;&#39;,&#39;&#39;,&#39;&#39;);">退改签</a></td>
			</tr>
			<tr>
				<td colspan="10" style="height: 8px; line-height: 8px;">&nbsp;</td>
			</tr>
