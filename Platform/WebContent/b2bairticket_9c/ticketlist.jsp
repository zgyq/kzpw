...
<script type=text/javascript src="b2bairticket_9c/js/ticket/list.js"></script>
...
<form action="b2b9cairticket!toTicketList.action" name="form3" id="form3"
	...
	<!-- 隐藏域 -->
		...
		<input type="hidden"
			...
			<tr>
				...
				<td>
				<!--
				<span id="hid_cabintypename_111"><ww:property value="GetCabinType(LowCarbin.Discount,LowCarbin.Special,LowCarbin.cabin)" /></span>[<span><ww:property value="LowCarbin.cabin" /></span>/<span id="hid_discount_111"><ww:property value="LowCarbin.Discount/10" /></span>折]
				-->
				</td>
				<td rowspan="2">
					<!--<font class="ff0000">¥<span
					class="priceOfColnum" id="hid_lowparvalue_<ww:property value="#state.index" />"><ww:property value="LowCarbin.price" /></span></font>元
					-->
					</td><!-- 总票面价 -->
				<td rowspan="2">
					<!--
					<font class="ff0000">¥<span
					class="priceOfColnum" id="hid_lowparvalue_111"><ww:property value="LowCarbin.price+AirportFee+FuelFee" /></span></font>元
					-->
					</td><!-- 总票结算面价 -->
				...
				<td rowspan="2" class="zratecss none">
				<!--<font class="f48000"><span
					class="zrateOfColnum" id="low_fandian_<ww:property value="#state.index"/>">0</span>%</font>(<font
					class="f48000" id="low_youhui_<ww:property value="#state.index"/>">0</font>元)
					--></td>
				<td rowspan="2" class="zratecss">
				<!--<font class="ff0000">¥<span id="low_zrateprice_<ww:property value="#state.index"/>"><ww:property value="LowCarbin.price+AirportFee+FuelFee" /></span></font>元
					--></td>
				<td rowspan="2" width="120"><img
					...
					id="bookimage_<ww:property value="#state.index" />" style="margin-left: 30px; display: none;"
					class="pointer none">
				<dl style="margin-left: 32px;">
					<a id="linkshowcabin_<ww:property value="#state.index" />"
						onclick="showallcabin_9c(<ww:property value="#state.index" />);return false;"
			...
			<tr>
				...
				<td>
				<!--<font style="width: 68px; display: block; float: left;">余票：<ww:if test="LowCarbin.SeatNum.equals(\"9\")">≥9</ww:if><ww:else>
		...
		<div id="AllCabin_info">
		
		
		</div>
		<tbody id='divallcabininfo_<ww:property value="#state.index" />' style="display: block;">
			...
			<ww:iterator value="Carbins" status="cabState">
				...
				<tr
					...
					<td rowspan="2" class="zratecss"><font class="f48000"><span
						id="ALLCabinfandian_<ww:property value="#state.index" />_<ww:property value="#cabState.index"/>"><ww:property value="ratevalue"/></span>%</font>(<font
						class="f48000"
						id="ALLCabinyouhui_<ww:property value="#state.index" />_<ww:property value="#cabState.index"/>"><ww:property value="Mathfloor(ratevalue*price/100)"/></font>元)</td>
					<td rowspan="2" class="zratecss"><font class="ff0000">¥<span
						id="ALLCabinPrice_<ww:property value="#state.index" />_<ww:property value="#cabState.index"/>"><ww:property value="formatMoneyToInt(price+AirportFee+FuelFee-Mathfloor(ratevalue*price/100))" /></span></font>元</td>
