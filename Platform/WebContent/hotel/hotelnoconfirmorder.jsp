...
<form name="form1" method="post" action="hotelnoconfirmorder.action"  >
      ...
      <tr>
		...
		<ww:iterator value="listHotelorder">
	      <tr align="center"  height="20" >
           ...
           <td><a onclick="hotel_send_fax('<ww:property value="id"/>');return false;" href="#">补发传真</a></td>
...
<script language="JavaScript">
	...
	function hotel_show_info(id) {
		document.forms.form1.action="hotelnoconfirmorder!tocheck.action?id=" + id + "&" + '<ww:property value="url"/>' ;
