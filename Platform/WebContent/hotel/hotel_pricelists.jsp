...
function toPricequeryandview(id,date,hotelid){
	...
	window.location.href="hotel!toPricequeryandview.action?hotel.name="+hotelName+"&hotelprice.roomid="+id+"&hotelprice.hotelid="+hotelid+"&hotelprice.datenumber="+priceDate+"&tabtype=to_shows"+"&hotelId="+hotelid;
}
