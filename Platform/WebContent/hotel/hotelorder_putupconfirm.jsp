...
<body>
<form action="hotelnoputupconfirmorder!<ww:if test="hotelorder.id>0">check.action?id=<ww:property value="id"/>&<ww:property value="url"/></ww:if>" name="form1" method="POST" onSubmit="return Validator.Validate(this,3)">
  ...
  <tr>
    ...
    <tr  class="font-blue-xi">
   	 	<td align="center" colspan="4">
	   	 	<input type="radio" name="state" value="8" checked="checked"/>No Show
	   	 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	onclick="hotel_show_noauditingreason()"/>取消
      ...
      <tr class="font-blue-xi">
        <td height="46" colspan="4" scrolling="no"><input type="submit" class="button_d font-white" value="确定" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <input type="button" class="button_d font-white"  onclick="hotel_cannel_info()"  name="Submit2" value=" 取消返回 " /> </td>
      </tr>
    </table></td>
  </tr>
</table>
...
<script type="text/javascript">
	...
	function hotel_cannel_info() {
		if(document.forms.form1.forwardall.value == 'whole') {
			...
			document.forms.form1.action="hotelnoputupconfirmorder.action?" +  '<ww:property value="url"/>' ;
		}
		document.forms.form1.submit() ;
	}
</script>
