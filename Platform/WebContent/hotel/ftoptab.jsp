...
-->
	<li><a href="javascript:" onclick="a(this,'hotelwholeorder!toyufu.action?h_state=1');" >等待处理</a></li>
	<li><a href="javascript:" onclick="a(this,'hotelwholeorder!toyufu.action?h_state=2');" >已处理</a></li>
	<li><a href="javascript:" onclick="a(this,'hotelwholeorder!toyufu.action?h_state=3');" >已发确认单</a></li>
	<li><a href="javascript:" onclick="a(this,'hotelwholeorder!toyufu.action?h_state=4');" ><span>确认已回传</span></a></li>
	<li><a href="javascript:" onclick="a(this,'hotelwholeorder!toyufu.action?h_state=18');" ><span>预订完成</span></a></li>
	<!--<li><a href="javascript:" onclick="a(this,'hotelwholeorder!toyufu.action?h_state=12');" >已收款</a></li>
	<li><a href="javascript:" onclick="a(this,'hotelwholeorder!toyufu.action?h_state=13');" >已支付给酒店</a></li>
	<li><a href="javascript:" onclick="a(this,'hotelwholeorder!toyufu.action?h_state=14');" >交易完成</a></li>
--></ul>
</div></td>
 </tr>
</table>
