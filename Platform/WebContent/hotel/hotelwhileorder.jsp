           ...
           <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td > <select id="h_ho" name="h_ordertype" >
                  ...
                  <td width="120" height="20" align="right">付费类型：</td>  
                <td > <select id="h_ho" name="h_ordertype" >
                		
                  		<option value="1" <ww:if test="h_ordertype==1">selected</ww:if> >现付订单</option>
                  		<option value="3" <ww:if test="h_ordertype==2">selected</ww:if> >预付订单</option>
      ...
      <tr>
		...
		<ww:iterator value="listHotelorder">
	      <tr align="center"  height="20"
           ...
           <td>
           		<ww:if test="state == 3">
           			<a href="#" onclick="hotel_sendConfirmFax('<ww:property value="id"/>')">发送传真</a>
           		</ww:if>
           </td>
