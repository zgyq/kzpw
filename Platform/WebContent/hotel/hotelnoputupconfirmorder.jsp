...
<form name="form1" method="post" action="hotelnoputupconfirmorder.action"  >
...
<script language="JavaScript">
	...
	function hotel_show_info(id) {
		document.forms.form1.action="hotelnoputupconfirmorder!tocheck.action?id=" + id + "&" + '<ww:property value="url"/>' ;
