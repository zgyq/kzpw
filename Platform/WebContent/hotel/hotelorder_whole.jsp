...
<body>
<form action="hotelwholeorder!<ww:if test="hotelorder.id>0">check.action?id=<ww:property value="id"/>&<ww:property value="url"/></ww:if>" name="form1" method="POST" onSubmit="return Validator.Validate(this,3)">
    ...
    <table width="90%" cellpadding="0" cellspacing="0" border="1" bordercolor="#a0cfee" style="border-collapse:collapse">
	 ...
	 <tr class="font-blue-xi">
      ...
      <tr class="font-blue-xi">
        ...
        <input type="button" class="button_d font-white" onclick="hotel_cannel_info()"  name="Submit2" value=" 取消返回 " /> 
        </td>
      </tr>
    </table></td>
  </tr>
