  ...
  <tr>
    <td height="455" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
           ...
           <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <td width="120" height="20" align="right">订单号：</td>    <td><span style="HEIGHT: 71px">
                  <input id="h_orderId"   style="WIDTH: 181px" name="hotelorder.orderid" value="<ww:property value="hotelorder.orderid"/>"/>
                </span></td>
              </tr>
              <tr>
                <td width="120" height="20" align="right">联系人姓名：</td>    <td><span style="HEIGHT: 71px">
                  <input id="h_linkname"   style="WIDTH: 181px" name="hotelorder.linkname" value="<ww:property value="hotelorder.linkname"/>" />
                </span></td>
                
                <td width="120" height="20" align="right">联系人电话：</td>    <td><span style="HEIGHT: 71px">
                  <input id="h_linkmobile"   style="WIDTH: 181px" name="hotelorder.linkmobile" value="<ww:property value="hotelorder.linkmobile"/>" />
                </span></td>
              </tr>
              <tr>
      ...
      <tr>
		...
		<ww:iterator value="hotelorderList">
	      <tr align="center"  height="20"
           ...
           <td>
           		<a href="hotelordersearch!todetail.action?hotelorder.id=<ww:property value="id"/>">
