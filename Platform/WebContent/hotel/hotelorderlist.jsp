...
<form name="form1" method="post" action="hotelwholeorder.action">
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
                ...
                --></span></td>
								...
								<td><select id="h_ho" name="h_ordertype">
									...
									<option value="2" <ww:if test="h_ordertype==2">selected</ww:if>>手机订单</option>
			...
			<tr>
							...
							<tbody>
								...
								<ww:iterator value="listHotelorder">
									<tr align="center" height="20"
										...
										<td><a
											href="hotelwholeorder!todetails.action?ordid=<ww:property value="id"/>"><ww:property
											value="orderid" /></a> 
           	...
           	--></td>
          								...
          								<!--
          								<td><a href="hotelwholeorder!todetails.action?ordid=<ww:property value="id"/>"><ww:property value="waicode" /></a></td>
										-->
										...
										<ww:if test="longtype==0">
										<td style="color: red;"><ww:property value="profits" /></td>
										</ww:if>
										<td style="color: red; display: none;"><ww:property value="formatMoney_short(gethotelfantoorder(profits,hotelid,memberid))" /></td>
										
										<td><ww:if test="state==1">待确认</ww:if> <ww:if
											test="state==2">已处理</ww:if> <ww:if test="state==3">已发传真</ww:if>
										<ww:if test="state==4">已回传确认</ww:if> <ww:if test="state==5">预订完成</ww:if>
										<ww:if test="state==6">已取消订单</ww:if> <ww:if test="state==7">满房</ww:if>
										<ww:if test="state==8">变更</ww:if> <ww:if test="state==9">入住</ww:if>
										<ww:if test="state==10">NS</ww:if> <ww:if test="state==11"></ww:if>
										<ww:if test="state==12">已付款</ww:if> <ww:if test="state==13">已支付给酒店</ww:if>
										<ww:if test="state==14">交易完成</ww:if> <ww:if test="state==18">预订完成,等待付款</ww:if>
										<ww:if test="state==88">问题订单</ww:if></td>
