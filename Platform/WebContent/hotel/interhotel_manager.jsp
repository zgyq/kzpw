...
<body onload="load()">
<div id="cx">
<form name="form1" method="post" action="hotel!interhotel.action">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td width="100%" height="29" class="box-bottom bg"><span
			class="font-blue-cu">&nbsp;&nbsp;&nbsp;国际酒店列表</span></td>
	</tr>
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<table width="100%" height="120" border="0" align="center">
							...
							<tr>
								...
								<td>
								<div id="show">
								<ww:if test="h_cityId>0">
								<input type="hidden" name="h_cityId" value="<ww:property value="h_cityId"/>" />
								<ww:property value="getintercitynamebyid(h_cityId)"/>
								</ww:if><ww:else>
									<select>
								<option>--请选择城市--</option>
								</select>
			...
			<tr>
				...
				<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tbody>
								...
								<ww:iterator value="listHotel">
									<tr id='<ww:property value="id"/>'
										...
										<!--<td align="center"><ww:property value="getregionname(regionid1)" /><ww:property value="getregionname(regionid2)" /><ww:property value="getregionname(regionid3)" /></td>
											-->
											<td align="center">
										...
										--><td align="center"><ww:property
											value="getguojianameBYid(contryid)" /></td>
										<td align="center"><ww:property
											value="getintercitynamebyid(cityid)" /></td>
					...
					<tr>
						<td height="43" align="center"><ww:property value="getPagination('\"hotel!interhotel.action?pageinfo.pagenum=\"+pageno+\"\"')"/></td>
					</tr>
				</table>
				</td>
			</tr>
...
function findCityByPro(id) {
 indexurl="hotel!getInterCity.action";
	  $.ajax({
      type:"GET",
      url:indexurl,
      data:{couid:id,para:Math.floor(Math.random()*100)},
     // beforeSend:function(){$("#divHotelHtml").html("&nbsp;&nbsp;&nbsp;&nbsp;<img src='himages/loadding.gif' border='0' />正在加载推荐酒店信息...");},             
