   	 ...
   	 <td width="66" height="20" align="left">酒店名称：</td>
                   <td width="314">
                   	<span style="HEIGHT: 71px">
                  		<input id="hotel.name"   style="WIDTH: 150px" name="hotel.name" readonly="readonly" value="<ww:property value="gethotelname(hotelprice.hotelid)"/>"/></span></td>
...
<script language="JavaScript">
	...
	function toback(){
  	...
  	window.location.href="hotel!toCheckBack.action?hotelprice.hotelid="+hotelid+"&hotel.name="+hotelName+"&hotelprice.roomid="+id+"&hotelId="+hotelid;
  }
