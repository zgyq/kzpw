...
<form name="form1" method="post" action="hotelwholeorder!toyufu.action">

<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"  style="border:1px solid #99CBED; margin-bottom:4px;">
  <tr>
    <td width="100%" height="29" class="box-bottom bg"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;预付酒店订单列表</span></td>
  </tr>
  <tr>
    <td height="455" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="306" valign="top"><table  width="100%" id="tbdeptsale" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
		...
		<ww:iterator value="listHotelorder">
	      <tr align="center"  height="20"
           ...
           <td><a href="hotelwholeorder!toyufudetails.action?ordid=<ww:property value="id"/>"><ww:property value="orderid"/></a>
           		<!--<ww:if test="state == 1">
          ...
          <tr>
            <td height="43" align="center"> <ww:property value="getPagination('\"hotelwholeorder!toyufu.action?pageinfo.pagenum=\"+pageno')"/> </td>
          </tr>
        </table></td>
      </tr>
    </table></td>
...
<script language="JavaScript">
    ...
    //设置excel可见属性 
	try{
		var fname = oXL.Application.GetSaveAsFilename("酒店预付订单.xls", "Excel Spreadsheets (*.xls), *.xls");
		if(fname){
			oWB.SaveAs(fname);
		}
	}catch(e){
