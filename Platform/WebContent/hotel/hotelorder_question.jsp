...
<body>
<form action="hotelquestionorder!<ww:if test="hotelorder.id>0">check.action?id=<ww:property value="id"/>&<ww:property value="url"/></ww:if>" name="form1" method="POST" onSubmit="return Validator.Validate(this,3)">
    ...
    <table width="90%" cellpadding="0" cellspacing="0" border="1" bordercolor="#a0cfee" style="border-collapse:collapse">
	 ...
	 <tr class="font-blue-xi">
 	 ...
 	 <tr>
   	 ...
   	 <tr class="font-blue-xi">
	     <td height="28" align="right"><span class="STYLE2"><strong>问题</strong>：</span></td>
	     <td colspan="3" align="left" >
	     		&nbsp;&nbsp;<ww:property value="hotelorder.resultvalue"/>
	     </td>
	 </tr>	
      <tr>
      	<th align="right"  class="font-blue-xi">备注：</th>
      	<td align="left" colspan="3">
      		&nbsp;<textarea  name="checkdesc" cols="80" rows="4" disabled="disabled"><ww:property value="hotelorder.predesc"/></textarea>
      	</td>
      </tr>
      <tr class="font-blue-xi">
        <td height="46" colspan="4" scrolling="no">
        <ww:if test="hotelorder.resultcode == 3">
        	<ww:if test="hotelorder.confirm == 1">
        	 	<input type="button" onclick="hotel_submit_info()" class="button_d font-white" value="发送短信" />
         		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        	</ww:if>
        	<ww:elseif test="hotelorder.confirm == 2">
        	 	<input type="button" onclick="hotel_submit_info()" class="button_d font-white" value="发送Email" />
        		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        	</ww:elseif>
        	<ww:elseif test="hotelorder.confirm == 3">
        		<input type="button" onclick="hotel_submit_info()" class="button_d font-white" value="发送短信" />
         		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        	 	<input type="button" onclick="hotel_submit_info()" class="button_d font-white" value="发送Email" />
        		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <ww:elseif test="hotelorder.resultcode == 1">
        	 <input type="button" class="button_d font-white" onclick="hotel_send_fax('<ww:property value="id"/>')" value="发送传真" />
        		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
        </ww:elseif>
        <ww:elseif test="hotelorder.resultcode == 2">
        	 <input type="button" class="button_d font-white" value="查看收到传真" />
        	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </ww:elseif>

        <input type="button" class="button_d font-white" onclick="hotel_cannel_info('<ww:property value="forwardall"/>')"  name="Submit2" value=" 取消返回 " /> 
        </td>
      </tr>
    </table></td>
  </tr>
...
<script type="text/javascript">
	...
	function hotel_cannel_info(forward) {
		if(forward == 'whole') {
			...
			document.forms.form1.action="hotelquestionorder.action?" +  '<ww:property value="url"/>' ;
		}
		document.forms.form1.submit() ;
	}
	
	function hotel_send_fax(id) {
		document.forms.form1.action="hotelquestionorder!sendFax.action?id=" + id + "&" + '<ww:property value="url"/>' ;
		document.forms.form1.submit() ;
	}
</script>
</html>
