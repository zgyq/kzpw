...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="border:1px solid #99CBED; margin-bottom:4px;">
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
           ...
           <table width="715" height="59" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
   	 <td width="83" height="20" align="right">酒店名称：</td>
                   <td width="150">
                   	<span style="HEIGHT: 71px">
       		    <input id="hotelName"   style="WIDTH: 150px" name="hotelName" readonly="readonly" value="<ww:property value="gethotelname(hotelprice.hotelid)"/>"/></span></td>
                ...
                <td width="107" height="20" align="right">酒店房型:</td>    
              <td width="157"><span style="HEIGHT: 71px">
  ...
  <select name="hotelprice.roomid" id="hotelprice.roomid" onchange="getlist(this.value);">
              ...
              <td width="218" rowspan="4"> <div align="left">
                  <input type="button" onclick="confirmStart();" class="button_d font-white" value="查询"/>
                </div></td>
   <tr>
                <td width="83" height="20" align="right">查询时间：</td>
                
                <TD align=left><!--
                <INPUT id="txtOpen" style="WIDTH: 150px" name="hotelprice.datenumber" require="true" dataType="Require"   msg="洒店查询时间不能为空"  onfocus="new WdatePicker(this,'%Y-%M',true)" value="<ww:property value="hotelprice.datenumber"/>">
                -->
                <select name="hotelprice.datenumber" id="hotelprice.datenumber">
		   ...
		   <p></p></td>
    		...
    		<tr>
    			<td>
 	 			...
 	 			<tr>
 	 				<td align="center" id="showdate" class="font-blue-xi">
                        ...
                        <table width="439" height="47" align="center" border="1" align="center" bordercolor="#a0cfee" style="border-collapse:collapse">
						<tr bgcolor="#d7e9fc">
...
<script>
	function confirmStart(){
	    ...
	    window.location.href="hotelprice!toPricequeryandview.action?hotelName="+hotelName+"&hotelprice.roomid="+roomid+"&hotelprice.hotelid="+hotelid+"&hotelprice.datenumber="+date;
