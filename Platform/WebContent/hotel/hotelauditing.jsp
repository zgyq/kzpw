...
<form name="form1" method="post" action="hotelwholeorder!toauditing.action">
<div id="divpassenger" style="text-align:center;display:none; background-color:#fff;left:0px;">正在加载订单信息...</div>

<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"  style="border:1px solid #99CBED; margin-bottom:4px;">
  <tr>
    <td width="100%" height="29" class="box-bottom bg"><span class="font-blue-cu">&nbsp;&nbsp;&nbsp;夜审订单</span></td>
  </tr>
  <tr>
    <td height="455" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
           ...
           <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <div align="center">
                  <input type="submit" class="button_d font-white" value="查询"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="reset" class="button_d font-white" value="重置"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
									type="button" class="button_d font-white" value="导出excel"
									onclick="importExcel('tbdeptsale')" />
                </div></td>
              </tr>
      ...
      <tr>
        ...
        <table  width="100%" id="tbdeptsale" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
		...
		<ww:iterator value="listHotelorder">
	      <tr align="center"  height="20"
           ...
           <td><a href="hotelwholeorder!toyeshen.action?ordid=<ww:property value="id"/>"><ww:property value="orderid"/></a>
           		</td>
         ...
         <td>
           ...
           <td>
          <a href="hotelwholeorder!toyeshen.action?ordid=<ww:property value="id"/>">夜审</a> 
           <!--
           <input type="button" class="button108" id="btnCancel" value="夜审"  onclick="goEdit(<ww:property value="id" />);" />
           -->
           </td>
          ...
          <tr>
            <td height="43" align="center"> <ww:property value="getPagination('\"hotelwholeorder!toauditing.action?pageinfo.pagenum=\"+pageno')"/></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
...
function goEdit(id)
{
		        ...
		        $("#divpassenger").dialog({
		         ...
		         $.ajax({
		            type:"POST",
		            url:"hotelwholeorder!getguestList.action",
