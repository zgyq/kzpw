...
<body>
<form action="hotelnoconfirmorder!<ww:if test="hotelorder.id>0">check.action?id=<ww:property value="id"/>&<ww:property value="url"/></ww:if>" name="form1" method="POST" onSubmit="return Validator.Validate(this,3)">
  ...
  <tr>
 	 ...
 	 <tr>
   	 ...
   	 <tr  class="font-blue-xi">
   	  ...
   	  <tr>
   	 	...
   	 	<input type="radio" name="state" value="4"  checked="checked"
	
	onclick="hotel_hide_noauditingreason()"/>确认
	   	 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	   	 	<input type="radio" name="state" value="5" 
	
	onclick="hotel_hide_noauditingreason()"/>满房
	   	 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <ww:if test="'whole'.equals(forwardall)">
	   	 	<input type="radio" name="state" value="13" 
	onclick="hotel_hide_noauditingreason()"/>变更
	   	 	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	   	 	<input type="radio" name="state" value="10" 
	...
	onclick="hotel_show_noauditingreason()"/>取消
      ...
      <tr class="font-blue-xi">
        ...
        <input type="button" onclick="hotel_submit_info()" class="button_d font-white" value="确定" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="button" class="button_d font-white" onclick="hotel_cannel_info('<ww:property value="forwardall"/>')"  name="Submit2" value=" 取消返回 " /> 
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
        <input type="button" class="button_d font-white" onclick="hotel_send_fax('<ww:property value="id"/>')" value="补发传真" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
...
<script type="text/javascript">
	...
	function hotel_send_fax(id) {
		document.forms.form1.action="hotelnoconfirmorder!sendFax.action?id=" + id + "&" + '<ww:property value="url"/>' ;
		document.forms.form1.submit() ;
	}
</script>
</html>
