...
<form enctype="multipart/form-data"
	action="hotelstate!edit.action?hotelId=<ww:property value="hotelId"/>&<ww:property value="url"/>"
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="border:1px solid #99CBED; margin-bottom:4px;">
	<tr>
		<td width="100%" height="29"  class="box-bottom bg" ><span
			class="font-blue-cu">&nbsp;&nbsp;&nbsp;<ww:if test="hotelimage.id>0">编辑</ww:if>酒店状态</span></td>
	</tr>
	<tr>
		<td height="100%">
		<table width="100%" cellpadding="0" cellspacing="0">
			...
			<tr class="font-blue-xi">
				...
				<ww:if test="hotelstate==3">
					<td>上网</td>
				</ww:if>
				<ww:if test="hotelstate==4">
					<td>下网</td>
				</ww:if>
				<ww:if test="hotelstate==0">
					<td>待审核</td>
				</ww:if>
			</tr>
			...
			<!-- <input type="text" require="true" dataType="Require"   msg="类型不能为空" name="type" value='<ww:property value="hotelimage.type"/>'" style="width:350px" /> -->
		  	...
		  	<tr class="font-blue-xi">
				<td height="28" align="right"><span class="STYLE2">备注：</span></td>
				<td><textarea name="des" cols="50" rows="5"><ww:property
					value="hotelstate" /></textarea></td>
			</tr>
...
<!-- 
				...
				<td><textarea name="hotel.checkdesc" cols="50" rows="5"><ww:property
					value="checkdesc" /></textarea></td>
				</tr>
