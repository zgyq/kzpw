		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td>
						<form name="form1" method="post" action="hotel!topiliang.action">
						...
						<table width="100%" height="40" border="0" cellspacing="0"
							...
							<tr>
								...
								&nbsp;&nbsp;&nbsp;<a href="#" onclick="updateItem()"><input
									type="button" value="批量修改" class="button_h font-red"></a>
								</td>
							</tr>
						</table>
			...
			<tr>
				...
				<form name="form2" method="post" action="hotel!piliang.action">
				<table width="100%" border="0" align="center" cellpadding="0"
					cellspacing="0">
					<tr>
						<td width="100%">
							...
							<tbody>
								...
								<ww:iterator value="listHotel">
									<tr id='<ww:property value="id"/>'
										...
										<td align="center"><input type="checkbox" name="hotelid"
...
//装修级别
  function fitment(){
	...
	function updateItem(){
			var length=document.form2.hotelid.length;
