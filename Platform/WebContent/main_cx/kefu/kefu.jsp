...
<title>在线客服</title>
<link href="main_cx/kefu/css/WebSite(1).css" rel="stylesheet" type="text/css">
<link href="main_cx/kefu/css/kefu.css" rel="stylesheet" type="text/css">
<style>
.zaixian_01 {
	height: 100px;
}
...
<div class="zaixian" style="height: 100%">
<div class="zaixian_01" id="float">
<ul class="zidx">
<ww:iterator value="listQqtypenew" status="inde">
	<li><a href="#top<ww:property value="#inde.index"/>"><ww:property value="name"/></a></li>
	</ww:iterator>
	
</ul>
</div>
<div class="conter">
<ww:iterator value="listQqtypenew" status="ind">
<div id="top<ww:property value="#ind.index"/>" class="zidc">

<p><b><ww:property value="name"/>：<u><ww:property value="param1"/></u>
 </b></p>
<ul class="zidcv">
	 <ww:iterator value="GetQQinfoNEWListbyQQtypeID(id)">
	<li><a href=" http://wpa.qq.com/msgrd?v=3&amp;uin=<ww:property value="qqno"/>&amp;site=qq&amp;menu=yes" target="_blank">
        <img title="" border="0" alt="点击这里给我发消息" src=" http://wpa.qq.com/pa?p=2:<ww:property value="qqno"/>:41"></a>
          </li>
		</ww:iterator>
...
<div id="top_jj" class="tel-box">
<p class="tel-time"><strong>紧急业务电话：</strong> <span>13585538232</span>
<label>（7*24小时）</label></p>
<p class="tel-notice"><strong>受理范围：</strong><br>
&nbsp;&nbsp;1.当天起飞的航班/非当天外面已无同等舱位航班催单；<br>
&nbsp;&nbsp;2.当天航班客人在机场不能登机；<br>
&nbsp;&nbsp;3.当天航班-航班变动要求保护当天其他航班、签转至当天航班（离起飞时间90分钟以内）。</p>
</div>
...
<div id="top12" class="zidc" style="display: none">
<p><b>贵宾客户</b></p>
<ul class="zidcv">
</ul>
<div class="clear"></div>
...
<div id="basepage_footer" style="display: none;">
<div class="contenter">
<table cellpadding="0" cellspacing="0">
	...
	<tbody>
		<tr>
			<th>出票电话<span>021-60721888</span></th>
			<th>退票电话<span>021-60726666</span></th>
			<th>改签升舱电话<span>021-60727777</span></th>
			<th>联程订票专线<span>021-60727599</span></th>
			<th>保&nbsp;&nbsp;&nbsp;险<span>021-60727508</span></th>
		</tr>
		<tr>
			<th>国际机票<span>021-60729999</span></th>
			<th>酒店订房<span>021-60727511</span></th>
			<th>行程单<span>021-62669910</span></th>
			<th>团 队 票<span>021-60727509</span></th>
			<th>投诉电话<span>021-60726665</span></th>
		</tr>
	</tbody>
</table>
