...
<!-- 车票基本信息修改页面 begin-->
<form id="form1" name="form1" action="train!edit_trainorder.action?id=<ww:property value="train.id"/>" method="post">
             ...
             <h2><span><img src="main_tulue/img/h2-icon.gif"/></span>订单基本信息</h2>
              ...
              <table  cellspacing="0" cellpadding="1" align="center" style="width:100%">
                        ...
                        <tr>
                            ...
                            <td class="title">出票座位</td>
                            <td class="cont"><ww:property value="train.cpxx"/></td>
                        ...
                        <tr>
                             ...
                             <td class="cont orange"><select name="orderstatus">
                            							...
                            							<option value="14" <ww:if test="train.orderstatus==14">selected</ww:if>><ww:property value="GetTrainOrderStausByCode( 14)" /></option>
                            							<option value="24" <ww:if test="train.orderstatus==24">selected</ww:if>><ww:property value="GetTrainOrderStausByCode( 24)" /></option>
                            							<option value="15" <ww:if test="train.orderstatus==15">selected</ww:if>><ww:property value="GetTrainOrderStausByCode( 15)" /></option>
                            							<option value="16" <ww:if test="train.orderstatus==16">selected</ww:if>><ww:property value="GetTrainOrderStausByCode( 16)" /></option>
                            							<option value="17" <ww:if test="train.orderstatus==17">selected</ww:if>><ww:property value="GetTrainOrderStausByCode( 17)" /></option>
                            							<option value="27" <ww:if test="train.orderstatus==27">selected</ww:if>><ww:property value="GetTrainOrderStausByCode( 27)" /></option>
                            							<option value="18" <ww:if test="train.orderstatus==18">selected</ww:if>><ww:property value="GetTrainOrderStausByCode( 18)" /></option>
                            							<option value="19" <ww:if test="train.orderstatus==19">selected</ww:if>><ww:property value="GetTrainOrderStausByCode( 19)" /></option>
                            							<option value="99" <ww:if test="train.orderstatus==99">selected</ww:if>><ww:property value="GetTrainOrderStausByCode( 99)" /></option>
                            						</select>
                        ...
                        <tr>
                            ...
                            <td colspan="5"><textarea style="width:60%;" name="memo"><ww:property value="train.memo" /></textarea></td>
                            </ww:if>
...
<!-- 短信记录 begin--> 
   ...
   <div class="save-btn" style=" margin:30px 0;text-align:center" >
    <a href="#" class="save-btn" style="margin-right:20px;" onclick="save();">保存</a>
	<a href="#" class="can-btn">取消</a> 
</div>
