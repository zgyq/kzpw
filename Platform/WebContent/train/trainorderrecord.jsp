                          ...
                          <tr onmouseover="this.style.background='#f6f6f6'" onmouseout="this.style.background='#ffffff'">
							...
							<div style="display: none; position: absolute; width: 200px; left: -10px; background: #fefefe; padding-left: 20px; border: 2px solid #f48000; z-index: 999999" id="detail<ww:property value="id"/>"></div>
                              ...
                              <a href="#" class="btns" onclick="dianji(<ww:property value='id'/>);return false;" >立即出票</a>
                               ...
                               <ww:if test="orderstatus==3">
                                <a href="#" class="btns" onclick="allpaytui(<ww:property value='id'/>,14);return false;" >申请退票</a>
                                <a href="#" class="btns" onclick="allpaytui(<ww:property value='id'/>,17);return false;" >申请改签</a>
                                </ww:if>
...
function allpaytui(orderid,orderstate){
		 
		$.ajax({
	         type:"POST",
	         async:false,
	         url:"train!allpaytui.action?rndmath="+Math.floor(Math.random()*100),
	         data:{strTuiOrderID:orderid,strTuiOrderState:orderstate},
	         success:function(data){
	         	alert(data);
	         	window.location.href="train!trainorder.action";
