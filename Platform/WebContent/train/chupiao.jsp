                                    ...
                                    <h2>信息核对</h2>
                                     <table  cellspacing="0" cellpadding="1" align="center" style="width:100%">
                                         <tr>
                                            ...
                                            <td colspan="5" style="font-size: 18">流水号</td>
                                         </tr>
                                         <tr>
                                     ...
                                     <!--
                                         ...
                                         <tr>
                                             <td >出票座位信息:</td>
                                             <td class="save-con"><input id="chupiaoxinxi_<ww:property value='train.id'/>" name="chupiaoxinxi_<ww:property value='train.id'/>" value="" /></td>
                                         </tr>
                                          <tr>
                                             <td >订单备注:</td>
