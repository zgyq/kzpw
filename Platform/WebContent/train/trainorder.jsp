     ...
     <div class="box">
       ...
       <!-- 车票信息begin-->
         <div class="ticket-info">
               ...
               <div class="new-chose">
                    <a href="#"><img src="train/img/new-chose.gif" width="79" height="26" /></a>
               </div>
...
type="checkbox" />保存为常用联系人</span></h2>
                     <p>姓名:   <input type="text" id="pname_<ww:property value="#state.index+1" />" name="pname" /><a href="javascript:opendg(<ww:property value="#state.index+1"/>);"><b><font color="red" style="font-size: 18px">*常用旅客</font></b></a></p>
...
width="159" height="45" /></a></div>
                   ...
                   <div class="price-detail">
                       ...
                       <p>手续费：...................<b id="shouxufei">0元</b></p>
                       <p>快递费：...................<b id="peisongfei">20元</b></p>
                       <p style="display: none;">总张数：...................<b id="">5张</b></p>
                       <p style=" font-weight:bold; font-size:14px;">总价：...................<b style="font-size:22px" id="zongjia">0元</b></p> 
                       <p>返佣：...................<b id="fanyong">0元</b></p>
                       <p style=" font-weight:bold; font-size:14px;">结算价：...................<b style="font-size:22px" id="jiesuanjia">0元</b></p> 
                   </div>
...
<input type="hidden" id="baoxianprice" name="baoxianprice" value="15" />
<input type="hidden" id="peisongprice" name="peisongprice" value="0" />
<input type="hidden" id="shouxuprice" name="shouxuprice" value="0" />
<input type="hidden" id="fanyongprice" name="fanyongprice" value="5" />
</form>
...
var fyfprice=$("#fanyongprice").val();//返佣
...
$("#fanyong").html(parseInt(fyfprice)+"元");

$("#zongjia").html((parseInt(psprice)+(parseInt(bxprice)*parseInt(pnums))+parseInt(sxfprice)+parseInt(oneprice)*parseInt(pnums)+parseInt(fyfprice))+"元");
$("#jiesuanjia").html((parseInt(psprice)+(parseInt(bxprice)*parseInt(pnums))+parseInt(sxfprice)+parseInt(oneprice)*parseInt(pnums))+"元");
}
...
function payorder(){
	...
	var oSeat=GetRadioValue("oSeat");
	if(oSeat==null||oSeat=='null'){
	alert("请选择席别!!!");
	return;
	}
...
<script>
	...
	function grefresh(index,username,idtype,idnumber){
	  ...
	  if(gwin){
			...
			document.getElementById("pname_"+index).value=username;
		    document.getElementById("idnumber_"+index).value=idnumber;
