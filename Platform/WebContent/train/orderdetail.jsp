              ...
              <table  cellspacing="0" cellpadding="1" align="center" style="width:100%">
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td colspan="5"><textarea style="width:60%;"><ww:property value="train.memo" /></textarea></td>
...
<!-- 短信记录 begin-->  
        <div class="message-record" >
           <h2><span><img src="main_tulue/img/h2-icon.gif"/></span>短信记录</h2> 
             <table  cellspacing="0" cellpadding="1" align="center" style="width:100%">
                <tr>   
                   <td class="title" width="10%">手机号码</td>
                   <td class="title" width="10%">发送时间</td>
                   <td class="title" width="10%">发送状态</td>
                   <td class="title">短信内容</td>
                </tr>
                
                <ww:iterator value="listsms">
                 <tr>
                   <td class="cont" width="10%"><ww:property value="phone" /></td>
                   <td class="cont" width="10%"><ww:property value="formatTimestamptoMinute(createtime)"/></td>
                   <td class="cont" width="10%"><ww:if test="state==1">发送成功</ww:if><ww:else>发送失败</ww:else></td>
                   <td class="cont"><textarea style="font-size:12px; width:85%" rows="4"><ww:property value="content"/></textarea>
                   </td>
                   </tr>
                   </ww:iterator>
             </table>
