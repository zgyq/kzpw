     ...
     <div id="pay">
         ...
         <div class="pay">
           ...
           <a href="javascript:void(0)" onclick="changepaytable(this,'alipay')">
            <li class="f payon_left two">
            <span class="ico_zhifubao f">&nbsp;</span>支付宝支付</li>
            <li class="f payon_right cold">&nbsp;</li>
            </a>
            
            
           <a href="javascript:void(0)" onclick="changepaytable(this,'alipaywy')">
            <li class="f payout_left two">
            <span class="ico_wangyin f">&nbsp;</span>网上银行支付</li>
          ...
          <a href="javascript:void(0)" onclick="changepaytable(this,'bill')">
            <li class="f payout_left two">
            <span class="ico_kuaiqian f">&nbsp;</span>快钱支付</li>
            <li class="f payout_right cold">&nbsp;</li>
          </a>
         ...
         <div class="box c">
          ...
          <!--支付宝-->
              <div class="boxnei" id='alipay' style="display: block;">
                   <ul>
           ...
           <!--网上银行-->
            ...
            <!--虚拟账户-->
              <div class="boxnei" id='vmoney' style="display:none">
                   ...
                   <li>账户充值：如果您的余额不足订单支付，<a href="rebaterecord.action" target="_blank"  class="font-33baea">立即充值</a>。</li>
