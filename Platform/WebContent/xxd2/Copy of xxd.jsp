                            ...
                            <table border="0" cellspacing="0" cellpadding="0" align="left">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" >
                                            <input style="width: 40px" name="xl" class="input2" value="20K" ><br>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 90px; height: 30px">
                                                        <input style="text-align: right; width: 54px;" id="txt_PJ" class="input2" 
                                                            maxlength="7" size="7" value="<ww:if test="passenger.ptype==1"><ww:property value="segmentinfo.parvalue" /></ww:if><ww:else><ww:property value="passenger.price" /></ww:else>"
                                                            name="piaojia">
                                                    </td>
                                                    ...
                                                    <td style="width: 90px; height: 30px">
                                                        <input style="text-align: right; width: 71px;" id="txt_JJ" class="input2" 
                                                            maxlength="6" size="6" value="<ww:property value="passenger.airportfee" />"
                                                            name="jijian">
                                                    </td>
                                                    ...
                                                    <td style="width: 90px; height: 30px">
                                                        <input style="text-align: right; width: 72px;" id="txt_RY" class="input2" 
                                                            maxlength="6" size="6"  value="<ww:property value="passenger.fuelprice" />"
                                                            name="ranyou">
                                                    </td>
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr style="height:40px">
                                    ...
                                    <td width="220">
                                        <input style="width: 120px;" name="et_no" class="input2" value="<ww:property value="passenger.ticketnum" />">
                                    </td>
                                    <td width="160" >
                                        验证码
                                    ...
                                    <td>
                                        保险
                                        <input style="width: 40px" class="input2" value="20" name="bx">
                                    </td>
                                </tr>
                            </table>
                            <table border="0" cellspacing="0" cellpadding="0">
