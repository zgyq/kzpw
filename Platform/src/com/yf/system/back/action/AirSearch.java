...
public class AirSearch extends B2b2cbackAction {
	...
	public  void searchAV(FlightSearch flightSearch,int intType)
	{
		...
		sbHtml.append("<td align='center' width='50px'><b>机型</b></td><td align='center' width='80px'><b>机建/燃油</b></td><td align='center' width='50px'><b>票面价</b></td><td align='center' width='100px'><b>舱位</b></td>");
		sbHtml.append("<td align='center' width='70px'><b>退改签</b></td><td align='center'><b>返点</b></td><td align='center'><b>预订</b></td></tr>");
		...
		{	
			...
			sbHtml.append("<td align='center' >" + flightinfo.getStartAirportName() + "<br>" + flightinfo.getEndAirportName() + "");
			sbHtml.append("<input type='hidden' id='hidfromcitycode_"+orderid+"' value='"+flightinfo.getStartAirport()+"' />");
			sbHtml.append("<input type='hidden' id='hidtocitycode_"+orderid+"' value='"+flightinfo.getEndAirport()+"' />");
			sbHtml.append("<input type='hidden' id='hidfromdate_"+orderid+"' value='"+formatTimestamp2(flightinfo.getDepartTime())+"'/>");
			sbHtml.append("<input type='hidden' id='hidaircompany_"+orderid+"' value='"+flightinfo.getAirCompany()+"'' />");
			sbHtml.append("<input type='hidden' id='hidflightnumber_"+orderid+"' value='"+flightinfo.getAirline().substring(2, flightinfo.getAirline().length())+"'' />");
			sbHtml.append("<input type='hidden' id='hidcabincode_"+orderid+"' value='"+flightinfo.getLowCarbin().getCabin()+"'' />");
			sbHtml.append("</td>");
			//机型描述信息
...
//            }
            ...
            sbHtml.append("<td align='center'><span style='color:red;font-weight:bold;font-size:20px' id='span_lowrateinfo_"+orderid+"'></span></td>");
...
//                    }
                    ...
                    sbHtml.append("<td align='center'><span style='color:red;font-weight:bold;font-size:20px' id='span_rateinfo_"+orderid+"_"+cabinid+"'></span>");
                    sbHtml.append("<input type='hidden' id='hidfromcitycode_"+orderid+"_"+cabinid+"' value='"+flightinfo.getStartAirport()+"' />");
        			sbHtml.append("<input type='hidden' id='hidtocitycode_"+orderid+"_"+cabinid+"' value='"+flightinfo.getEndAirport()+"' />");
        			sbHtml.append("<input type='hidden' id='hidfromdate_"+orderid+"_"+cabinid+"' value='"+formatTimestamp2(flightinfo.getDepartTime())+"'/>");
        			sbHtml.append("<input type='hidden' id='hidaircompany_"+orderid+"_"+cabinid+"' value='"+flightinfo.getAirCompany()+"'' />");
        			sbHtml.append("<input type='hidden' id='hidflightnumber_"+orderid+"_"+cabinid+"' value='"+flightinfo.getAirline().substring(2, flightinfo.getAirline().length())+"'' />");
        			sbHtml.append("<input type='hidden' id='hidcabincode_"+orderid+"_"+cabinid+"' value='"+cabininfo.getCabin()+"'' /></td>");
                    //判断预订按钮（单程直接到下单页面，往返直接查询返程航班信息）
                    String strBookUrl = "";
                    if (ActionContext.getContext().getSession().get("travelTypeSession").equals("1"))//单程
                    {
...
//		ActionContext.getContext().getSession().put("travelFlag", 2); //返程
	...
	public void GetZrateByFlight() throws Exception 
	{
		...
		"@cangwei= N'"+s_cabincode+"',@hangbanhao= N'"+s_flightnumber+"',@ismulity=0,@agentid=0";
		...
		if(listzrate.size()>0)
		{
			...
			strReturn=listzratemap.get("zratevalue").toString();
		}
