...
function bookSpotTicket(id)
{
alert(id);
window.location.href="spotticket!toSpotTicketInfo.jspx?SpotMesID="+id;
...
<div>
	...
	<div id="hotel">
      <div id="left" class="f">
          ...
          <form action="spotline!SeachSpotline.jspx" method="post">
 ...
 <div id="right" class="r">
       <div>
         ...
         <div class="r">
           	...
           	<div class="mt7"><img src="images/spotline/ad_spot_01.jpg" width="222" height="90" /></div>   
           </div>
         <div class="c"></div>
       </div>
       <div class="mt7 box">
