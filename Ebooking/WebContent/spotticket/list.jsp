 ...
 <div id="list" class="r">
   ...
   <div id="hotelList"> 
    <div class="mt7" style="height:28px; line-height:26px;">
      ...
      <div class="r"><ww:property value="getPagination('\"spotticket!SeachSpot.jspx?pageinfo.pagenum=\"+pageno+\"\"')"/></div>
    ...
    <div class="mt7 " id="hotelsTable<ww:property value="id" />">     
       <div>
           ...
           <div class="f list_top list_bg">
               <div class="f"><a href="spotticket!toSpotTicketInfo.jspx?SpotMesID=<ww:property value="id" />&startDate=<ww:property value="startDate"/>&endDate=<ww:property value="endDate"/>" class="c09f"><ww:property value="name" /></a></div>
               <div class="r"><span class="ico_tell">&nbsp;</span><a href="spotticket!toSpotTicketInfo.jspx?SpotMesID=<ww:property value="id" />&startDate=<ww:property value="startDate"/>&endDate=<ww:property value="endDate"/>" class="c09f">景区详细介绍</a></div>
               <div class="c"></div>
           </div>
    ...
    <div class="box_ccc floatall box_botno mt7">
      <ul class="query">
      <li class="f">&nbsp;</li>
      <li class="r mr25"><ww:property value="getPagination('\"spotticket!SeachSpot.jspx?pageinfo.pagenum=\"+pageno+\"\"')"/></li>
      <div class="c"></div>
      </ul>
    </div> 
