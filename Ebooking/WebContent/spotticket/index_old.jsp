...
//alert(cityid);
  $.ajax({
      type:"GET",
       url:"spotticket!GetSpotByCity.jspx",
...
<div>
	...
	<div id="hotel" style="margin-top: 0px;">
      <div id="left" class="f">
          ...
          <form action="spotticket!SeachSpot.jspx" method="post">
          <div class="box_sea searchlist">
             <ul>
           <li class="searchall mt10">游玩城市：<input type="text" id="txthotelcity" class="text_search" name="cityname" value="<ww:property value="GetSpotCityNmaeByID(CityID)" />"  onclick="this.value='';GetCityList(this); " onkeyup="GetCityList(this); "  />
 ...
 <div id="right" class="r">
       <div>
         <div class="f ad_box" style="width: 730px;">
