...
<div class="topMain"><!--搜索框开始-->
<div id="soso_17u" class="search_box">
<div id="portal-block-245245043063" class="udiyblock"
	type="SearchSource"><!--左边的tab切换-->
<div class="search_main">
<div id="soso_top_title" class="search_left"><a
	class="hotel_at crt" id="top_hotel"><span class="left_sp"></span>酒店</a>
<a class="nor" id="top_airplane">
<div class="top_hr"></div>
<span class="left_sp"></span>机票</a> <a class="nor" id="top_scenic">
<div class="top_hr"></div>
<span class="left_sp"></span>景点门票</a> <a class="nor" id="top_selftrip">
<div class="top_hr"></div>
<span class="left_sp"></span>自助游</a> <a class="nor" id="top_abroad">
<div class="top_hr"></div>
<span class="left_sp"></span>出境游</a> <a class="nor" id="top_phone">
<div class="top_hr"></div>
<span class="left_sp"></span>手机版</a></div>
...
<div class="airplane_tab" id="airplane_tab"><a class="airpInter"
	...
	href="javascript:void(0);" title="国际机票">国际机票<span
...
<dl class="list" id="leaveCityDiv" style="z-index: 99999">
	...
	<dd class="list_con"><input type="text" maxlength="20"  style="width: 180px;"
		 name="OrgPort" class="input02"  id="arrcity" value="北京"  onclick="if(this.value='北京'){this.value='';}" onblur="if(this.value=='') {this.value='北京';};"
		nulltips="请输入出发城市名称"  />
		
		</dd>
		<div id='suggest_form' class="ac_results_air" style="margin-top: -260px;margin-left: -386px;z-index: 999999999"></div>
	    <input type="hidden" id="city_from_hide" value="PEK" name="s_depcitycode" />
...
<dl class="list" id="arriveCityDiv">
	...
	<dd class="list_con"><input type="text" maxlength="20"  style="width: 180px;"
		id="tocity" name="ArvPort" class="input02" onclick="if(this.value='上海虹桥'){this.value='';}" onblur="if(this.value=='') {this.value='上海虹桥';};"
...
<dl class="list" id="ileaveCityDiv">
	<dt class="list_tit">出发城市</dt>
	<dd class="list_con"><input type="text" maxlength="20" style="width: 180px;"
		name="iOrgPort" class="input02" holder="城市名" nulltips="请输入出发城市名称"
		value="城市名" /></dd>
...
<dl class="list" id="iarriveCityDiv">
	<dt class="list_tit">到达城市</dt>
	<dd class="list_con"><input type="text" name="iArvPort" style="width: 180px;"
		class="input02" holder="城市名" nulltips="请输入中转城市名称" value="城市名" /></dd>
</dl>
...
<div class="tray none">
 ...
 <form id="form3" name="form3" action="spotticket!SeachSpot.jspx" method="post">
	...
	<tbody>
		...
		<tr>
			<td class="scenicInput" colspan="2"><input type="text"
				value="景点名或城市名" name="SeachName" maxlength="20"
				id="txtScenicValue" class="input02" />
...
<table>
	<tbody>
		...
		<td class="selfInput" colspan="2"><!--<input type="text" value="请输入景点名或城市名" class="input02"/>-->
		<div class="selfRelDiv"><input type="text" value="天目湖御水温泉"
			id="zzy_search" maxlength="25" class="input02"
...
<ul class="sliderCon clearfix"
	...
	<div class="sliderRightDiv"><a class="sliderConA sliderConTop"
		href="#" target="_blank"> <span class="sliderConSp">臻享空铁</span> <span
		class="sliderConSp">天天惊喜</span> </a> <a class="sliderConA sliderConBottom"
		href="#" target="_blank"> <span class="sliderConSp">会员免费抽奖</span>
	<span class="sliderConSp">超值游学卡免费送</span> </a></div>
	</li>
	...
	<span class="sliderConSp">空铁超值酒店</span> <span class="sliderConSp">低价高品质享受</span>
	...
	<div class="sliderRightDiv"><a
		...
		target="_blank"> <span class="sliderConSp">空铁出行</span> <span
	...
	<div class="sliderRightDiv"><a
		...
		class="sliderConSp">空铁出游</span> </a> <a
...
<div id="portal-block-826619946112" class="udiyblock"
	type="CommonSource"><span class="iThinkSp scenicThinkSp">空铁推荐
...
<ul class="listBoxViewUl clearfix" id="senicListBoxViewUl">
	...
	<dl class="listViewDl">
		...
		<dd class="listViewInf listViewBotm">空铁价：<span class="dollar">¥</span><span
...
<ul class="ListBoxTabUl" id="ListBoxTabUlSelf">
	<li class="listBoxTabLi"><a title="北京" href="javascript:void(0);" onclick="selectspotline(1,52);"
	...
	<li class="listBoxTabLi"><a title="九江" href="javascript:void(0);" onclick="selectspotline(3,238);"
		cname="九江" id="index_spotline_3" pyname="qingdao" type="self"
		class="city cityMiddle "> <span class="citySp">九江</span></a></li>
...
<div class="ListBoxTabDiv abroadBoxTab clearfix"><span
	class="iThinkSp abroadThinkSp">空铁首发 限量</span> <span
...
<ul class="listBoxViewUl clearfix" id="abroadListBoxViewUl"
	...
	<a title="泰国游" href="#" nalt="泰国游" class="listAbroadImg" target="_blank"><img src="images/index/zizhu01.jpg" /> </a> 
	<a title="韩国游" href="#" nalt="韩国游" class="listAbroadImg" target="_blank"><img src="images/index/zizhu02.jpg" /> </a> 
	<a title="欧洲旅游" href="#" nalt="欧洲旅游" class="listAbroadImg" target="_blank"><img src="images/index/zizhu03.jpg" /></a> 
	<a title="马尔代夫" href="#" nalt="马尔代夫" class="listAbroadImg" target="_blank"><img src="images/index/zizhu04.jpg" /></a>
	</li>
...
<dl class="issueDl">
	...
	<dl class="issueDl">
		<dd class="issueDd"><span class="issueIcon"></span> <a
			style="color: #ff6600" href="#" title="野外旅游如何应付意外事故" target="_blank">野外旅游如何应付意外事故</a></dd>
