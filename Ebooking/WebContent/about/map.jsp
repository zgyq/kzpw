...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(116.458287,39.926);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"尚都国际中心A座26层2616",content:"我的备注",point:"116.458053|39.925481",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
		 ];
    //创建marker
    function addMarker(){
