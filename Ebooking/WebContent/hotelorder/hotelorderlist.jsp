...
<div id="member">
    ...
    <form action="login!toHotelOrder.jspx" name="form1" id="form1" method="post">
   <div class="right mt10 r">
       ...
       <div class="mt7 box">
        ...
        <div class="information">
         ...
         <table width="94%" border="1" cellspacing="0" cellpadding="0"  class="centerall" >
              <tr>
                <td  class="hadow hl24" align="right" width="20%">酒店名称：</td>
               ...
               <tr>
                <td class="hadow" align="right" width="20%">预订时间：</td>
                ...
                <td class="hadow" align="right" width="20%">入住人：</td>
            ...
            <table width="94%" border="1" cellspacing="0" cellpadding="0"  class="centerall" >
              <tr>
                ...
                <td class="hadow">酒店名称</td>
                <td class="hadow">房型</td>
                <td class="hadow">入住时间</td>
                <td class="hadow">离店时间</td>
                <td class="hadow">价格</td>
                <td class="hadow">支付状态</td>
                <td class="hadow">状态</td>
              </tr> 
              <ww:iterator value="ListHotelOrder" status="ind">
              <tr>
                <td><a href="login!toHotelOrderInfo.jspx?HotelOrderID=<ww:property value="id"/>" class="l06c"><ww:property value="orderid"/></a></td>
                ...
                <td>未支付</td>
                <td><font class="l06c" ><ww:if test="state==3">支付完成</ww:if>
   		<ww:elseif test="state==4">已入住</ww:elseif>
		<ww:elseif test="state==9">NS</ww:elseif>
      <ww:elseif test="state==6">已取消</ww:elseif>
      <ww:elseif test="state==2 && (paystate==0 || paystate==2)">待支付</ww:elseif>
      <ww:elseif test="state==5">预订完成</ww:elseif>
      <ww:else>待确认</ww:else></font></td>   
            ...
            <div align="right">
           <ww:property value="getPagination('\"login!toHotelOrder.jspx?pageinfo.pagenum=\"+pageno')"/>
   			</div>
        </div>
       </div> 
