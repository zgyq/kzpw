	  ...
	  // alert("?");
   		var strid="span[id*='low_zrateprice_']";
		   	...
		   	$("#book_"+i).hide()
		        $.ajax({
			         type:"POST",
			         url:"ticticket!GetNewvalue.jspx",
			         data:{z_price:$("#hid_lowprice_"+i).val(),z_zratevalue:$("#hid_zratevalue_"+i).val(),z_zrateid:$("#hid_zrateid_"+i).val()},
   		...
   		var strid="span[id*='ALLCabin_"+index+"_']";
		   	$(strid).each(function(i){
		        ...
		        $.ajax({
			         type:"POST",
			         url:"ticticket!GetNewvalue.jspx",
			         data:{z_price:$("#hid_lowprice_"+index+"_"+i).val(),z_zratevalue:$("#hid_zratevalue_"+index+"_"+i).val(),z_zrateid:$("#hid_zrateid_"+index+"_"+i).val()},
	 ...
	 <ww:iterator value="listFlightInfoAll" status="state">
		...
		<ul <ww:if test="#state.index%2==1">class="listrange box_botm"</ww:if>
		 ...
		 =<ww:property value="LowCarbin.SeatNum" />
			...
			<dt><ww:property value="getAirCompanyNameByCode(AirCompanyName)" /><ww:property
				value="Airline" /></dt>
			<dt>计划机型:<a id="a_flightdesc_<ww:property value="#state.index" />"
				href="javascript:void(0);" class="fontun06c"
			...
			<input type="hidden"
				...
				value='<ww:property value="LowCarbin.zrateid" />' />
				<input type="hidden"
		...
		<div style="display: none"
			...
			<dt style="display: none;"><a
				...
				value='<ww:property value="zrateid" />' />
				<input type="hidden"
