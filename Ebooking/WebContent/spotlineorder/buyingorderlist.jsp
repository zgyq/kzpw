...
<div id="member">
    ...
    <form action="login!tobuyingOrder.jspx" name="form1" id="form1" method="post">
       ...
       <div class="mt7 box">
        ...
        <div class="information">
         ...
         <table width="94%" border="1" cellspacing="0" cellpadding="0"  class="centerall" >
              <tr>
                <td  class="hadow hl24" align="right" width="20%">团购名称：</td>
               ...
               <tr>
                <td class="hadow" align="right" width="20%">创建日期：</td>
            ...
            <table width="94%" border="1" cellspacing="0" cellpadding="0"  class="centerall" >
              <tr>
                ...
                <td class="hadow">名称</td>
                <td class="hadow">有效期限</td>
                <td class="hadow">总份数</td>
              ...
              <tr>
                <td><a href="#" class="l06c"><ww:property value="orderno"/></a></td>
                <td> <ww:property value="name"/></td>
                <td><ww:property value="GetBuystimebyid(spotlineid)"/></td>
                <td><ww:property value="snum"/></td>
            ...
            <div align="right">
           <ww:property value="getPagination('\"login!tobuyingOrder.jspx?pageinfo.pagenum=\"+pageno')"/>
   			</div>
        </div>
       </div> 
