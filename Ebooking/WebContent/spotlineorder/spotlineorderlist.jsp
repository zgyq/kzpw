...
<div id="member">
    ...
    <form action="login!toSpotLineOrder.jspx" name="form1" id="form1" method="post">
       ...
       <div class="mt7 box">
        ...
        <div class="information">
         ...
         <table width="94%" border="1" cellspacing="0" cellpadding="0"  class="centerall" >
              <tr>
                <td  class="hadow hl24" align="right" width="20%">线路名称：</td>
                <td><input type="textg"  class="text_number" name="HotelName" value="<ww:property value="HotelName"/>"  /> </td>
                <td class="hadow" align="right" width="20%">城市：</td>
               ...
               <tr>
                <td class="hadow" align="right" width="20%">出发日期：</td>
            ...
            <table width="94%" border="1" cellspacing="0" cellpadding="0"  class="centerall" >
              <tr>
                ...
                <td class="hadow">出发/到达城市</td>
                <td class="hadow">线路名称</td>
                <td class="hadow">游玩时间</td>
                <td class="hadow">总人数</td>
                <td class="hadow">价格</td>
                <td class="hadow">支付状态</td>
                <td class="hadow">状态</td>
              </tr> 
              <ww:iterator value="ListSpotLineOrder" status="ind">
              <tr>
                <td><a href="login!toSpotLineOrderInfo.jspx?SoptLineOrderID=<ww:property value="id"/>" class="l06c"><ww:property value="orderno"/></a></td>
                <td><ww:property value="getSpotCityNameByStr(provineid)"/>/<ww:property value="getSpotCityNameByStr(cityid)"/></td>
                <td> <ww:property value="name"/></td>
                <td><ww:property value="stime"/></td>
                <td><ww:property value="snum"/>人</td>
                <td><font class="font18f60">¥<ww:property value="price"/></font></td> 
                <td><ww:if test="paystate==1">支付完成</ww:if><ww:else>未支付</ww:else></td>
                <td><font class="l06c" ><ww:if test="state==1">已确认</ww:if>
            ...
            <div align="right">
           <ww:property value="getPagination('\"login!toSpotLineOrder.jspx?pageinfo.pagenum=\"+pageno')"/>
   			</div>
        </div>
       </div> 
