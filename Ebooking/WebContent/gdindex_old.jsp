...
<title>捷翔旅行网官网:酒店预订,机票预订查询,旅游度假,商旅管理</title>
...
<link href="indexcss/index2.css" rel="stylesheet"/>
    ...
    TripIndex = {
        config : {
            port_init:'http://mk.trip.taobao.com/init.htm?callback={callback}',
            port_dest:'http://mk.trip.taobao.com/destination.htm?callback={callback}',
            port_order:'http://mk.trip.taobao.com/myOrder.htm?callback={callback}',
            port_flight:'http://mk.trip.taobao.com/flightInfo.htm?callback={callback}',
            ab_test:{
                location:Math.floor(Math.random()*2)  // 0: 图文并茂展示 1:纯文字展示
            }
...
<!-- header end-->
<!-- 头部开结束 -->
<div class="screen-1" id="yui_3_5_0_1_1382683231546_369">
    <div class="module" id="yui_3_5_0_1_1382683231546_757">
        <div switchinterval="6" activeindicatorstyle="selected" activeslicestyle="selected" id="J_Slider" data-spm="a1z13" class="slider">
        <div class="slider-bd" id="yui_3_5_0_1_1382683231546_756">
                            <div style="z-index: 6; opacity: 0;" inactiveeffect="[{degrade:{ie:7},to: {opacity: 0}, duration: 1.5}, {to: {zIndex: 6}, duration: 0}]" activeeffect="{degrade:{ie:7}, from: {zIndex: 7, opacity: 0},to: {opacity: 1}, duration: 1.5}" class="swing-slice" id="yui_3_5_0_3_1382683231546_7">
                                        <div style="background-image:url(http://gtms01.alicdn.com/tps/i1/T1TZzTFnJeXXbOUvrA-1920-295.jpg);" class="swing-slice-pannel"></div>
                   
                                    </div>
                             <div style="z-index: 6; opacity: 0;" inactiveeffect="[{degrade:{ie:7},to: {opacity: 0}, duration: 1.5}, {to: {zIndex: 6}, duration: 0}]" activeeffect="{degrade:{ie:7}, from: {zIndex: 7, opacity: 0},to: {opacity: 1}, duration: 1.5}" class="swing-slice" id="yui_3_5_0_3_1382683231546_10">
                                        <div style="background-image:url(http://img01.taobaocdn.com/tps/i1/T1Ev2JFklcXXbOUvrA-1920-295.jpg);" class="swing-slice-pannel"></div>
                    
                                    </div>
                             <div style="z-index: 7; opacity: 1;" inactiveeffect="[{degrade:{ie:7},to: {opacity: 0}, duration: 1.5}, {to: {zIndex: 6}, duration: 0}]" activeeffect="{degrade:{ie:7}, from: {zIndex: 7, opacity: 0},to: {opacity: 1}, duration: 1.5}" class="swing-slice selected" id="yui_3_5_0_3_1382683231546_14">
                                        <div style="background-image:url(http://gtms04.alicdn.com/tps/i4/T1OiTgFb0bXXbOUvrA-1920-295.jpg);" class="swing-slice-pannel"></div>
                  
                                    </div>
                             <div style="z-index: 6; opacity: 0;" inactiveeffect="[{degrade:{ie:7},to: {opacity: 0}, duration: 1.5}, {to: {zIndex: 6}, duration: 0}]" activeeffect="{degrade:{ie:7}, from: {zIndex: 7, opacity: 0},to: {opacity: 1}, duration: 1.5}" class="swing-slice" id="yui_3_5_0_3_1382683231546_18">
                                        <div style="background-image:url(http://gtms01.alicdn.com/tps/i1/T1eeN_XxJXXXaqWvrA-1920-295.png);" class="swing-slice-pannel"></div>
                  
                                    </div>
                             <div style="z-index: 6; opacity: 0;" inactiveeffect="[{degrade:{ie:7},to: {opacity: 0}, duration: 1.5}, {to: {zIndex: 6}, duration: 0}]" activeeffect="{degrade:{ie:7}, from: {zIndex: 7, opacity: 0},to: {opacity: 1}, duration: 1.5}" class="swing-slice" id="yui_3_5_0_3_1382683231546_22">
                                        <div style="background-image:url(http://gtms01.alicdn.com/tps/i1/T1K5HVFaBcXXXlDLTM-1925-295.jpg);" class="swing-slice-pannel"></div>
                   
                                    </div>
                     </div>
        <div class="slider-hd" id="yui_3_5_0_1_1382683231546_812">
                        <span class="swing-slice-indicator"></span>
                        <span class="swing-slice-indicator"></span>
                        <span class="swing-slice-indicator selected"></span>
                        <span class="swing-slice-indicator"></span>
                        <span class="swing-slice-indicator" id="yui_3_5_0_1_1382683231546_2242"></span>
                    </div>
    </div>
             </div>
...
<a href="#" title="常州嬉戏谷门票">常州嬉戏谷门票</a></div>
<div class="vac_item"><a
...
<a href="#" rel="nofollow" target="_blank"
	...
	href="#"
	rel="nofollow" target="_blank" class="tool_7">申请捷翔<span>信用卡</span></a>
</div>
<!-- 特色服务&工具箱结束 --> 
<!-- 攻略社区开始 -->
<!--
...
<a class="mobile"
	href="#"
	target="_blank"><img alt="" title="捷翔旅行V5.0,国庆大促,NO.1免单"
...
<dl class="partner">
	...
	<dd><a rel="nofollow" title="鸿鹄逸游" target="_blank"
		href="#" class="partner_hh">鸿鹄逸游</a> <a
		rel="nofollow" title="铁友网" target="_blank"
		href="#" class="partner_lp">驴评网</a> <a
		rel="nofollow" title="松果网" target="_blank"
		href="#" class="partner_sg">松果网</a> <a
		rel="nofollow" title="途家网" target="_blank"
		href="#" class="partner_tj">途家网</a> <a
		rel="nofollow" title="永安旅游" target="_blank"
		href="#" class="partner_ya">永安旅游</a> <a
		rel="nofollow" title="易游网" target="_blank"
		href="#" class="partner_yy">易游网</a></dd>
</dl>

<dl class="info">
	<dt class="h2_title"><a
		href="#" class="more"
		target="_blank">更多&gt;&gt;</a>捷翔热点</dt>
	<dd><a rel="nofollow" title="捷翔援建雅安希望小学 " target="_blank"
		href="#">捷翔援建雅安希望小学</a></dd>
	<dd><a rel="nofollow" title="捷翔旅行中秋版入选苹果精品推荐榜 " target="_blank"
		href="#">捷翔旅行中秋版入选苹果精品推荐榜</a></dd>
	<dd><a rel="nofollow" title="捷翔中秋版客户端力推自由行套餐" target="_blank"
		href="#">捷翔中秋版客户端力推自由行套餐</a></dd>
	<dd><a rel="nofollow" title="酒店无线订单比达40%超网站" target="_blank"
		href="#">酒店无线订单比达40%超网站</a></dd>
</dl>
<dl class="info">
	<dt class="h2_title"><a href="#"
...
<p><a title="全国酒店大全" target="_blank"
	...
	href="#">三亚酒店</a> <a title="上海酒店预订"
	target="_blank" href="#">上海酒店</a>
<a title="北京酒店预订" target="_blank"
	...
	href="#">澳门酒店</a> <a title="苏州酒店预订"
	target="_blank" href="#">苏州酒店</a>
<a title="西安酒店预订" target="_blank"
	href="#">西安酒店</a> <a title="济南酒店预订"
	target="_blank" href="#">济南酒店</a>
<a title="长沙酒店预订" target="_blank"
	...
	href="#">天津酒店</a> <a
	title="品牌酒店大全" target="_blank" href="#">酒店品牌</a>
<a title="如家快捷酒店" target="_blank"
	href="#">如家快捷</a> <a title="七天连锁酒店"
	target="_blank" href="#">7天连锁</a> <a
	title="锦江之星酒店" target="_blank"
	href="#">锦江之星</a> <a title="莫泰168酒店"
	target="_blank" href="#">莫泰168</a> <a
	title="格林豪泰酒店" target="_blank"
	href="#">格林豪泰</a> <a title="汉庭快捷酒店"
	target="_blank" href="#">汉庭酒店</a> <a
	title="速8连锁酒店" target="_blank"
	href="#">速8酒店</a> <a title="香格里拉酒店"
	target="_blank" href="#">香格里拉酒店</a> <a
	title="希尔顿酒店" target="_blank" href="#">希尔顿酒店</a>
<a title="喜来登酒店" target="_blank"
	href="#">喜来登酒店</a> <a title="万豪酒店预订"
	target="_blank" href="#">万豪酒店</a> <a
	title="凯悦酒店预订" target="_blank"
	href="#">凯悦酒店</a> <a title="泰国酒店预订"
	target="_blank" href="#">泰国酒店</a>
...
<a title="春秋航空官网机票查询" target="_blank"
	...
	href="#">东方航空</a> <a title="南方航空官网机票查询"
	target="_blank" href="#">南方航空</a> <a
	title="中国国航官网机票查询" target="_blank"
	href="#">中国国航</a> <a title="海南航空官网机票查询"
	target="_blank" href="#">海南航空</a> <a
	title="厦门航空官网机票查询" target="_blank"
	href="#">厦门航空</a> <a title="山东航空官网机票查询"
	target="_blank" href="#">山东航空</a> <a
	title="吉祥航空官网机票查询" target="_blank"
	href="#">吉祥航空</a> <a title="首都航空官网机票查询"
	target="_blank" href="#">首都航空</a> <a
	...
	href="#">航班动态</a> <a title="机场"
	target="_blank" href="#">机场</a>
<a title="特价机票" target="_blank"
	href="#">特价机票</a>
</p>

<p class="cityname_vca"><a
	href="#" target="_blank">湖北旅游</a>
<a href="#" target="_blank">夏威夷旅游</a>
<a href="#" target="_blank">海南旅游</a>
<a href="#" target="_blank">三亚旅游</a>
<a href="#" target="_blank">宜昌旅游</a>
<a href="#" target="_blank">无锡旅游</a>
<a href="#"
	target="_blank">重庆旅游</a> <a
	href="#" target="_blank">苏州旅游</a>
<a href="#" target="_blank">阳朔旅游</a>
<a href="#" target="_blank">敦煌旅游</a>
<a href="#" target="_blank">广西旅游</a>
<a href="#" target="_blank">青岛旅游</a>
<a href="#" target="_blank">上海旅游</a>
<a href="#" target="_blank">首尔旅游</a>
<a href="#" target="_blank">乌鲁木齐旅游</a>
<a href="#" target="_blank">北京旅游</a>
<a href="#" target="_blank">甘肃旅游</a>
<a href="#" target="_blank">青海旅游</a>
<a href="#" target="_blank">兰州旅游</a>
<a href="#" target="_blank">桂林旅游</a>
<a href="#" target="_blank">马尔代夫旅游</a>
</p>
</div>
<!--seo end-->
...
<p><a rel="nofollow" target="_blank"
	...
	target="_blank"
	href="#">友情链接</a> | <a
	rel="nofollow" href="http://www.19166.com/">Copyright&copy;</a>
1999-2023, <a href="http://www.19166.com/"> www.19166.com</a>. All rights. | <a rel="nofollow" target="_blank"
...
<script id="J_RightNowTmpl" type="text/tmpl">
       
    </script>
    <!--international template-->
    <script id="J_InternationalTmpl" type="text/tmpl">
        
    </script>
    <!--interal template-->
    <script id="J_InteralTmpl" type="text/tmpl">
       
    </script>
    <script id="J_MultiTempl" type="text/tmpl">
      
    </script>
    <script id="J_MultiNoteTmpl" type="text/tmpl">
       
    </script>
    <script id="J_MultiHotelTmpl" type="text/tmpl">
       
    </script>
    <script id="J_MultiTravelTmpl" type="text/tmpl">
        
    </script>
    <script id="J_MultiScenicTicketTmpl" type="text/tmpl">
      
    </script>
    <script id="J_MultiFlightTmpl" type="text/tmpl">
       
    </script>

    <!--group and travel-->
    <script id="J_AroundTmpl" type="text/tmpl">
    
    </script>

    <script id="J_AroundTravelTmpl" type="text/tmpl">
       
    </script>
    <script id="J_AroundGroupTmpl" type="text/tmpl">
       
    </script>


    <!--around travel template-->
    <script id="J_AroundTravelTmpl2" type="text/tmpl">
       
    </script>
    <script id="J_AroundGroupTmpl2" type="text/tmpl">
        
    </script>


    <script id="J_FlightTmpl" type="text/tmpl">
       
    </script>
    <script id="J_FlightItemTmpl" type="text/tmpl">
       
    </script>
    <script id="J_IFlightTmpl" type="text/tmpl">
      
    </script>
    <script id="J_IFlightItemTmpl" type="text/tmpl">
      
    </script>
<script src="indexcss/modules.js"></script>
<script src="indexcss/20131025.js" ></script>
