...
<div class="cui_hd_cont">
		...
		<div class="base_nav">
			<ul class="cui_nav">
				...
				<li class="sep"></li>
				<li id="cui_nav_sl">
					<a  href="http://www.19166.com/Platform" title="代理登陆" class="cui_nav_non"><span>代理登录</span></a>
				</li>
...
<a class="current"
	pinyin="JingXuan" id="spot_a_1" title="精选" href="javascript:void(0);" onclick="selectspotticket(1,321)">精选</a><a
	pinyin="ShangHai" id="spot_a_2" title="上海" href="javascript:void(0);" onclick="selectspotticket(2,321)">上海</a><a
	pinyin="JiangSu"  id="spot_a_3" title="江苏" href="javascript:void(0);" onclick="selectspotticket(3,321)">江苏</a><a
	pinyin="ZheJiang" id="spot_a_4" title="浙江" href="javascript:void(0);" onclick="selectspotticket(4,321)">浙江</a><a
	pinyin="AnHui"    id="spot_a_5" title="安徽" href="javascript:void(0);" onclick="selectspotticket(5,321)">安徽</a><a
	pinyin="BeiJing"  id="spot_a_6" title="北京" href="javascript:void(0);" onclick="selectspotticket(6,607)">北京</a><a
	pinyin="ShanDong" id="spot_a_7" title="山东" href="javascript:void(0);" onclick="selectspotticket(7,321)">山东</a>
...
<div class="citytabs" id="hotelCityTab">
	...
	<a  title="上海酒店" id="hotel_a_2" href="#" onclick="selecthotel(2,607);return false;">上海</a>
	<a  title="广州酒店" id="hotel_a_3" href="#" onclick="selecthotel(3,607);return false;">广州</a>
	<a  title="成都酒店" id="hotel_a_4" href="#" onclick="selecthotel(4,607);return false;">成都</a>
	<a  title="深圳酒店" id="hotel_a_5" href="#" onclick="selecthotel(5,607);return false;">深圳</a>
	<a  title="杭州酒店" id="hotel_a_6" href="#" onclick="selecthotel(6,607);return false;">杭州</a>
	<a  title="南京酒店" id="hotel_a_7" href="#" onclick="selecthotel(7,607);return false;">南京</a>
	<a  title="新加坡酒店" id="hotel_a_8" href="#" onclick="selecthotel(8,607);return false;">新加坡</a>
	<a  title="曼谷酒店" id="hotel_a_9" href="#" onclick="selecthotel(9,607);return false;">曼谷</a>
...
<div class="toolbox"><a
	...
	href="#" target="_blank"
	class="tool_2">火车查询</a> <a href="#" rel="nofollow"
...
<a href="#" rel="nofollow" target="_blank"
	...
	href="#"
	rel="nofollow" target="_blank" class="tool_7">申请捷祥<span>信用卡</span></a>
</div>
<!-- 特色服务&工具箱结束 --> <!-- 攻略社区开始 -->
...
<ul class="raiders_in" id="communityPics">
	...
	<dl class="raiders_info">
		...
		<dd class="raiders_intro">雍和宫是北京地区现存规模最大的藏传寺院</dd>
...
<a class="mobile"
	href="#"
	target="_blank"><img alt="" title="捷祥旅行V5.0,国庆大促,NO.1免单"
