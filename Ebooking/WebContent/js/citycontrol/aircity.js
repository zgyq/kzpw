...
commoncitys[6]=new Array('WUH','武汉','WUHAN','WH');

commoncitys[7]=new Array('XIY','西安','XIAN','XA');

commoncitys[8]=new Array('CKG','重庆','CHONGQING','CQ');

commoncitys[9]=new Array('TAO','青岛','QINGDAO','QD');
 
commoncitys[10]=new Array('CSX','长沙','CHANGSHA','CS');
...
commoncitys[14]=new Array('SYX','三亚','SANYA','SY');

commoncitys[15]=new Array('WNZ','温州','WENZHOU','WZ');
