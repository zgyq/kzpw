    ...
    <div class="msg mt7" style=" clear:both;">
          ...
          <li class="over information" style="margin-top:10px;">
             <table width="100%" border="0" cellspacing="0" cellpadding="0" class="over">
                  <tr>
                    <td width="90" class="hadow" align="right">名称：</td>
                    <td width="260"><ww:property value="spotlineorder.name" /></td>
                    <td width="90" class="hadow" align="right">&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
                  ...
                  <tr>
                    <td class="hadow" align="right">总份数：</td>
                    <td><ww:property value="spotlineorder.snum" /></td>
      ...
      <div class="order_bnt">
        <input type="button" class="mr25 booking_bntton fff" value="继续预订" onclick="GoWhy('buying.jspx');" />
