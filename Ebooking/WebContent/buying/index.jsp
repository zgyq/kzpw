...
//alert(cityid);
  $.ajax({
      type:"GET",
       url:"spotline!GetSpotByCity.jspx",
...
$("#cityname").html(cityname); 
  ...
  $.ajax({
      type:"GET",
       url:"spotline!GetSpotmesByCityid.jspx",
...
<div>
	...
	<div id="hotel" style="margin-top: 51px;">
      <div id="left" class="f">
          <div class="search"><font class="black">团购信息搜索</font></div>
          <form action="buying!Seachbuying.jspx" method="post">
          <div class="box_sea searchlist">
             <ul>
           <li class="searchall mt10">选择城市：<input type="text" id="txthotelcity" class="text_search" name="hotelcity" value="<ww:property value="GetSpotCityNmaeByID(CityID)" />"  onclick="this.value='';GetCityList(this); " onkeyup="GetCityList(this); "  />
          		 <div id="suggest" class="ac_results"></div>
             	   <input type="hidden" id="city_hotel_hide" name="CityID" value="<ww:property value="CityID" />"  />
           </li>
           
           <!--隐藏域 -->
          	  <li class="searchall">选择时间：<input type="text" class="text_search" id="txtcheckindate" value="<ww:property value="startDate" />" name="startDate" onfocus="WdatePicker({doubleCalendar:true,dateFmt:'yyyy-MM-dd',minDate:'%y-%M-%d',maxDate:'%y-#{%M+1}-%d', onpicked:function(){txtcheckoutdate.focus();}})"  /></li>
 ...
 <div id="right" class="r">
       <div>
         <div class="f ad_box">
          ...
          <ww:include page="../hotel/5tu.htm"></ww:include>
         ...
         <div class="r">
               ...
               <div class="box_tell" style=" border-top:none;">
                  ...
                  <ww:iterator value="listZX">
                   <li>
	                   	<a href="index!toInformationinfo.jspx?HelpcenterID=<ww:property value="typeid"/>&HelpcenterinfoID=<ww:property value="id"/>"> <ww:if test="name.length()>23">
           	...
           	<div class="mt7"><img src="images/ad_ticket_01.jpg" width="222" height="90" /></div>   
           </div>
         <div class="c"></div>
       </div>
       <div class="mt7 box">
           <div class="tit">
              <font class="black low2 f mr15">线路预订</font>
              <div class="r navcity">
                <ul>
                 <a href="#"><li class="f navcity_on"  id="city1" onclick="selectSpot(1,52);return false;">北京</li><li id="style1" class="navcity_on_right f">&nbsp;</li></a>
                 ...
                 <a href="#"><li class="f navcity_out" id="city3" onclick="selectSpot(3,76);return false;">广州</li><li id="style3" style="display: none" class="navcity_on_right f">&nbsp;</li></a>
                 ...
                 <a href="#"><li class="f navcity_out" id="city5" onclick="selectSpot(5,180);return false;">武汉</li><li id="style5" style="display: none" class="navcity_on_right f">&nbsp;</li></a>
                 <a href="#"><li class="f navcity_out" id="city6" onclick="selectSpot(6,220);return false;">南京</li><li id="style6" style="display: none" class="navcity_on_right f">&nbsp;</li></a>
                </ul>
              </div> 
              <div class="c"></div>
           </div>
