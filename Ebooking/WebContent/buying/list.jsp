...
<div>
	...
	<!--top over-->
	<form action="buying!Seachbuying.jspx" method="post" name="form1" id="form1">
	<div id="hotel" style="margin-top: 51px;">
      <div id="left" class="f">
          <div class="search"><font class="black">国内团购搜索</font></div>
         
           
          <div class="box_sea searchlist">
             <ul>
           <li class="searchall mt10">团购城市：<input type="text" id="txthotelcity" class="text_search" name="hotelcity" value="<ww:property value="GetSpotCityNmaeByID(CityID)" />"  onclick="this.value='';GetCityList(this); " onkeyup="GetCityList(this); "  />
          		 <div id="suggest" class="ac_results"></div>
             	   <input type="hidden" id="city_hotel_hide" name="CityID" value="<ww:property value="CityID" />"  />
           </li>
           
           <!--隐藏域 -->
          	  <li class="searchall">团购时间：<input type="text" class="text_search" id="txtcheckindate" value="<ww:property value="startDate" />" name="startDate" onfocus="WdatePicker({doubleCalendar:true,dateFmt:'yyyy-MM-dd',minDate:'%y-%M-%d',maxDate:'%y-#{%M+1}-%d', onpicked:function(){txtcheckoutdate.focus();}})"  /></li>
          ...
          <div class="mt7">
              <div class="tit" style="border:1px solid #e3d3d3; border-bottom:none;">
                  <font class="black f" style=" padding-left:10px;">推荐门票信息</font>
 ...
 <div id="list" class="r">
    ...
    <div>
       <span class="f ico_hotel">&nbsp;</span><font class="f biger000">查询团购（<ww:property value="GetSpotCityNmaeByID(CityID)" />）</font><!--
   ...
   <div id="hotelList"> 
    <div class="mt7" style="height:28px; line-height:26px;">
      <div class="f mr5 list_on " id="hotelTEXT" ><a href="#"  class="fff">团购信息</a></div>
    ...
    <ww:iterator value="ListBuying" status="t">
    ...
    <div class="mt7 " id="hotelsTable<ww:property value="id" />">     
       <div>
           ...
           <div class="f list_top list_bg">
               <div class="f"><a href="buying!tobuyingInfo.jspx?buyingid=<ww:property value="id" />&startDate=<ww:property value="startDate"/>&endDate=<ww:property value="endDate"/>" class="c09f"><ww:property value="name" /></a></div>
               <div class="r"><span class="ico_tell">&nbsp;</span><a href="buying!tobuyingInfo.jspx?buyingid=<ww:property value="id" />&startDate=<ww:property value="startDate"/>&endDate=<ww:property value="endDate"/>" class="c09f">详细介绍</a></div>
               <div class="c"></div>
           </div>
       ...
       <div>
          ...
          <div class="list_main f">
            <ul>
            <li>团购期限：<ww:property value="stime" />至<ww:property value="endtime" /></li>
            <li>起团数：<ww:property value="minnumber" /></li>
            <li>是否预约：提前<ww:property value="tiqiandays" />天</li>
            <li>简介信息：<ww:property value="SubString(ShowHTML(descinfo,'list'),100)" />....</li>
            </ul> 
          </div>
    ...
    <div class="box_ccc floatall box_botno mt7">
      <ul class="query">
      <li class="f">&nbsp;</li>
      <li class="r mr25"><ww:property value="getPagination('\"buying!Seachbuying.jspx?pageinfo.pagenum=\"+pageno+\"\"')"/></li>
      <div class="c"></div>
      </ul>
    </div> 
