   ...
   <div class="right mt10 r">
       ...
       <div class="mt7 box">
        ...
        <div class="information">
         ...
         <div>&nbsp;</div>
         <table width="94%" border="1" cellspacing="0" cellpadding="0"  class="centerall" style="display: none;">
              <tr>
            ...
            <div class="search" style="display: none;"> <input type="submit" value="订单查询" class="button_searchmeb"  onclick="checkCity()"  /></div>
            <!--listsearch over-->
            <table width="94%" border="1" cellspacing="0" cellpadding="0"  class="centerall" >
              <tr>
                <td class="hadow hl24">订单号</td>
                <td class="hadow">车次</td>
                <td class="hadow">乘车人</td>
                <td class="hadow">出发时间</td>
                <td class="hadow">行程</td>
                <td class="hadow">价格</td>
                <td class="hadow">订单状态</td>
              </tr>    
              <ww:iterator value="trainlist">
              <tr>
                 			<td><a href='train!orderdetail.action?id=<ww:property value="id"/>'>
							<span><ww:property value="ordernumber" /></span></a></td>
							
               				 <td style="color: red"><ww:property value="traincode" /></td>
                              <td style="color: red"><ww:property value="GetTrainPassName(id)" /></td>
                              <td style="color: red"><ww:property value="startdate" />&nbsp;<ww:property value="starttime" /></td>
                              <td style="color: red"><ww:property value="startcity" />—<ww:property value="endcity" /></td>
