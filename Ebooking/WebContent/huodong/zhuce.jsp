...
<!----------header over---------->
<div id="regsiter">
<form action="<%=request.getContextPath()%>/login!Regsit_hd.jspx" name="form1" method="post" id="form1" >
    <div class="mt7 box">
        <div class="tit">
        
               <font class="black low2 f mr15">注册信息</font>
        ...
        <div class="regsit">
            <ul>
             ...
             <li>
              ...
              <li>
                 <span>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名</span>：
                 <input type="text" id="membername" desc="姓名" class=" mlr15 text_regsit validate[required]" name="membername" value="<ww:property value="customeruser.membername"/>"  />
                 <font class="fontxing">*</font>&nbsp;<font class="c999">(请填写你身份证上的姓名。)</font>
             </li>
              <li>
                 <span>证件类型</span>：
                <select  class=" mlr15 text_regsit" name="cardtype">
                ...
                <option value="9">其他</option>
                 ...
                 <font class="fontxing">*</font>&nbsp;<font class="c999">(请选择登机用证件类型。)</font>
             </li>
              <li>
                 <span>证件号码</span>：
                 <input type="text" id="cardnunber" desc="证件号码" class=" mlr15 text_regsit validate[required]" name="cardnunber" value="<ww:property value="customeruser.cardnunber"/>"  />
                 <font class="fontxing">*</font>&nbsp;<font class="c999">(请填写证件对应的号码。)</font>
             </li>
             <li>
                 <span>验&nbsp;&nbsp;证&nbsp;码</span>：
            ...
            <span class="f"> 抢购条款：<input name="" onclick="checkRadio();" id="chbrules" type="checkbox" checked="checked" value="1"  />我已看过并同意<a target="_blank" href="index!toService.jspx" class="fontun06c">《${compname}服务协议》</a><br/>
             <input type="submit" class="button_login mt10" id="submitreg" value="我要抽奖"  /><font class="f00"><ww:property value="fieldErrors.validate"/></font></span>
